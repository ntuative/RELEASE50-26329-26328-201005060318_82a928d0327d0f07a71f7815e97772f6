package com.sulake.habbo.avatar.figuredata
{
   ...
   public class FigureDataView
   {
      ...
      public function FigureDataView(param1:IHabboWindowManager, param2:IAssetLibrary)
      {
         ...
         if(_loc4_)
         {
            var_1060 = _loc4_.content as BitmapData;
         }
         if(_window != null)
         {
            var_371 = _window.findChildByName("bitmap") as IBitmapWrapperWindow;
         }
      }
      ...
      public function udpate(param1:BitmapData) : void
      {
         if(var_371 && var_1060)
         {
            var_371.bitmap = new BitmapData(var_371.width,var_371.height,true,16777215);
            var_371.bitmap.copyPixels(var_1060,var_1060.rect,new Point(0,0 - 0 - 8));
            var_371.bitmap.copyPixels(param1,param1.rect,new Point(4,0),null,null,true);
         }
      }
   }
}
