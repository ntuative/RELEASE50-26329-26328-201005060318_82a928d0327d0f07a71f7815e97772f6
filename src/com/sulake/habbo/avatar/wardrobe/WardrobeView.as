package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeView implements ISideContentView
   {
      ...
      private var var_693:IItemListWindow;
      ...
      public function WardrobeView(param1:WardrobeModel)
      {
         ...
         var_693 = _window.findChildByName("hc_slots") as IItemListWindow;
         var_1025 = _window.findChildByName("vip_slots") as IItemListWindow;
      ...
      public function update() : void
      {
         ...
         if(var_693)
         {
            var_693.removeListItems();
         }
         if(var_1025)
         {
            var_1025.removeListItems();
         }
         ...
         while(_loc3_ < _loc1_.length)
         {
            ...
            if(_loc3_ < 5)
            {
               if(var_693)
               {
                  var_693.addListItem(_loc2_.view);
                  _loc2_.view.visible = true;
               }
            }
            else if(var_1025)
            {
               var_1025.addListItem(_loc2_.view);
               _loc2_.view.visible = true;
            }
            _loc3_++;
         }
