package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class Outfit implements IOutfit
   {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IAvatarImage = var_28.avatarRenderManager.createAvatarImage(figure,AvatarScaleType.SMALL,var_603);
         if(_loc1_)
         {
            _loc1_.setDirection(AvatarSetType.const_40,int(FigureData.const_743));
