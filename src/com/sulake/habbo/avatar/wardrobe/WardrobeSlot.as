package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeSlot implements IOutfit
   {
      ...
      {
         var _loc1_:XmlAsset = var_28.assets.getAssetByName("wardrobe_slot") as XmlAsset;
         if(!_loc1_)
         {
            return;
         }
         _view = var_28.windowManager.buildFromXML(_loc1_.content as XML) as IWindowContainer;
      ...
      public function updateView() : void
      {
         ...
         if(var_312 && var_1275)
         {
            _loc5_ = var_28.avatarRenderManager.createAvatarImage(figure,AvatarScaleType.SMALL,var_603);
            if(_loc5_)
            {
               _loc5_.setDirection(AvatarSetType.const_40,parseInt(FigureData.const_743));
         ...
         {
            _loc6_ = var_28.assets.getAssetByName("wardrobe_empty_slot") as BitmapDataAsset;
            if(_loc6_)
            {
         ...
         if(_loc4_)
         {
            _loc4_.visible = var_1275 && var_312 != null;
         }
      }
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            case "set_button":
               var_312 = var_28.figureData.getFigureString();
               var_603 = var_28.gender;
               var_28.handler.saveWardrobeOutfit(var_1525,this);
               updateView();
               break;
            case "get_button":
               if(var_312)
               {
                  var_28.loadAvatarInEditor(var_312,var_603,var_28.clubMemberLevel);
               }
         }
      }
   }
