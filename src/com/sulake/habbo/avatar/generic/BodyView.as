         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case const_497:
                  ...
                  break;
               case const_498:
                  _model.controller.gender = FigureData.const_92;
                  param1.stopPropagation();
            }
         }
