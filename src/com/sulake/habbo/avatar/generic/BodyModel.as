package com.sulake.habbo.avatar.generic
{
   ...
   public class BodyModel extends CategoryBaseModel implements IAvatarEditorCategoryModel
   {
      ...
      override protected function updateSelectionsFromFigure(param1:String) : void
      {
         ...
         var _loc2_:int = var_28.figureData.getPartSetId(FigureData.FACE);
         var _loc3_:Array = var_28.figureData.getColourIds(FigureData.FACE);
         ...
         {
            _loc6_ = var_28.figureData.getFigureStringWithFace(_loc5_.id);
            _loc7_ = var_28.avatarRenderManager.createAvatarImage(_loc6_,AvatarScaleType.const_56);
