package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1615:IWindowContainer;
      
      public static var var_1386:IWindowContainer;
      
      public static var var_2281:int = 6710886;
       
      
      private var var_1609:Boolean = true;
      
      private var var_377:Timer;
      
      private var var_1610:ITabSelectorWindow;
      
      private var _window:IWindowContainer;
      
      private var var_545:IFrameWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog)
      {
         ...
         if(var_1615 == null)
         {
            ...
            var_1615 = var_28.windowManager.buildFromXML(_loc5_.content as XML) as IWindowContainer;
         }
         var_377 = new Timer(1000);
         var_377.addEventListener(TimerEvent.TIMER,onUpdate);
      }
      ...
      private function createWindow() : void
      {
         ...
         var_1610 = _window.findChildByName("mainTabs") as ITabSelectorWindow;
         attachImages();
         update();
      }
      ...
      public function update() : void
      {
         ...
         if(var_28.sessionData.hasUserRight("fuse_use_wardrobe") && (var_1611 == AvatarEditorSideCategory.WARDROBE || var_2277))
         {
            _loc4_ = "null";
         }
      ...
      public function dispose() : void
      {
         ...
         {
            var_377.stop();
            var_377.removeEventListener(TimerEvent.TIMER,onUpdate);
            var_377 = null;
         }
      }
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!var_545)
         {
            ...
            var_545 = _windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            var_545.procedure = stripClubDialogEventProc;
            var_545.center();
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_575:
               break;
            case AvatarEditorSideCategory.const_362:
               _loc3_ = var_28.getSideContentWindowContainer(AvatarEditorSideCategory.const_362);
               break;
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         var_273 = param1;
         var_1610.setSelected(var_1610.getSelectableByName(param1));
         _window.invalidate();
      }
      
      private function toggleWardrobe() : void
      {
         if(var_1611 == AvatarEditorSideCategory.WARDROBE)
         {
            var_2277 = false;
            setSideContent(AvatarEditorSideCategory.const_575);
         }
         else
         {
