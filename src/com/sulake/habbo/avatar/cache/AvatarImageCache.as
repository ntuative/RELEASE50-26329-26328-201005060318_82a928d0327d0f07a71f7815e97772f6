package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1429:int = 60000;
      ...
      private var var_865:IAvatarImage;
      ...
      public function getAnimationDataInFrame(param1:String, param2:int) : AnimationLayerData
      {
         ...
         return var_54.getBodyPartData(_loc4_.definition.state + "." + _loc4_.actionParameter,param2,param1);
      }
      ...
      public function getBodyPartCache(param1:String) : AvatarImageBodyPartCache
      {
         ...
         var _loc2_:AvatarImageBodyPartCache = var_132.getValue(param1) as AvatarImageBodyPartCache;
         if(_loc2_ == null)
         {
            _loc2_ = new AvatarImageBodyPartCache();
            var_132.add(param1,_loc2_);
         }
         return _loc2_;
      }
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         {
            _loc17_ = var_54.getAnimation(_loc5_.definition.state + "." + _loc5_.actionParameter);
            if(_loc17_ != null)
            {
               ...
               if(_loc18_ != null)
               {
                  ...
                  if(_loc18_.type == AnimationLayerData.const_521)
                  {
                     if(_loc18_.action != null)
                     {
                  ...
                  else if(_loc18_.type == AnimationLayerData.const_364)
                  {
                     _loc4_ = _loc8_;
                  }
                  _loc7_ = true;
         ...
         if(_loc16_ == null)
         {
            ...
            _loc10_ = var_54.getParts(param1,(var_865 as AvatarImage).getFigure(),_loc6_,var_1307,_loc4_,_loc13_,_loc14_);
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         var _loc5_:AvatarCanvas = var_54.getCanvas(var_202,var_1307);
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         while(_loc23_ >= 0)
         {
            ...
            if(AvatarDirectionAngle.const_1186[param1])
            {
            ...
            _loc9_ = var_202 + "_" + _loc15_.assetPartDefinition + "_" + _loc10_ + "_" + _loc11_ + "_" + _loc18_ + "_" + _loc12_;
            _loc14_ = _assets.getAssetByName(_loc9_) as BitmapDataAsset;
            if(_loc14_ == null)
            {
               _loc9_ = var_202 + "_std_" + _loc10_ + "_" + _loc11_ + "_" + _loc18_ + "_0";
               _loc14_ = _assets.getAssetByName(_loc9_) as BitmapDataAsset;
            }
            if(!_loc14_ || !_loc14_.content)
            {
               Logger.log("renderBodyPart could not find required asset: " + _loc9_);
            }
            else
            {
               if(_loc7_.paletteMapId > -1)
               {
                  _loc31_ = var_54.renderManager.paletteManager.getPalette(_loc7_.paletteMapId);
               ...
               if(_loc8_ == null)
               {
                  Logger.log("renderBodyPart could not find required bitmap: " + _loc9_);
                  return null;
               }
               if((_loc29_ == AvatarAction.const_819 || _loc29_ == AvatarAction.const_686) && (_loc6_ == AvatarBodyPartType.const_298 || _loc6_ == AvatarBodyPartType.const_1315 || _loc6_ == AvatarBodyPartType.const_1384) && _loc7_.color != null)
               {
         ...
         if(_loc17_)
         {
            if(var_202 == AvatarScaleType.const_56)
            {
               _loc25_.x += 67;
            }
            else
      ...
      public function setAction(param1:IActiveActionData) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:Array = var_54.getActiveBodyPartIds(param1);
      ...
      public function disposeInactiveActions(param1:int = 60000) : void
      {
         ...
         if(var_132 != null)
         {
            _loc2_ = var_132.getKeys();
            for each(_loc3_ in _loc2_)
            {
               _loc4_ = var_132.getValue(_loc3_) as AvatarImageBodyPartCache;
               if(_loc4_ != null)
               {
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc3_:Array = var_54.getBodyPartsUnordered(param1);
