package com.sulake.habbo.avatar.pets
{
   public class PetData implements IPetData
   {
      ...
      public function method_14(param1:int) : Breed
      {
         var _loc2_:* = null;
         for each(var _loc5_ in var_1200)
         {
            _loc2_ = _loc5_;
            _loc5_;
            if(_loc2_.id == param1)
