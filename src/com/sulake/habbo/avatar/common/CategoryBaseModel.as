package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryBaseModel implements IAvatarEditorCategoryModel
   {
      ...
      public function stripClubItemsOverLevel(param1:int) : Boolean
      {
         ...
         var _loc2_:Array = var_89.getKeys();
         var _loc3_:Boolean = false;
         var _loc4_:int = 0;
         while(_loc4_ < _loc2_.length)
         {
            _loc5_ = _loc2_[_loc4_];
            _loc6_ = var_89[_loc5_];
            _loc7_ = false;
            ...
            if(_loc7_)
            {
               ...
               if(_loc8_ && var_28 && false && _loc6_)
               {
                  var_28.figureData.savePartData(_loc5_,_loc8_.id,_loc6_.getSelectedColorIds(),true);
               }
               _loc3_ = true;
            }
            _loc4_++;
      ...
      public function selectColor(param1:String, param2:int, param3:int) : void
      {
         ...
         if(var_28 && false)
         {
            var_28.figureData.savePartSetColourId(param1,_loc4_.getSelectedColorIds(),true);
         }
      }
      ...
      {
         var _loc3_:CategoryData = var_89[param1];
         if(_loc3_ == null)
         {
            return;
         }
         ...
         if(var_28 && false)
         {
            var_28.figureData.savePartData(param1,_loc4_.id,_loc3_.getSelectedColorIds(),true);
         }
      }
      ...
      {
         if(!var_89 || !var_28 || true)
         {
            return;
         }
         var _loc2_:CategoryData = var_89[param1];
         if(_loc2_ == null)
         {
            return;
         }
         var _loc3_:int = var_28.figureData.getPartSetId(param1);
         var _loc4_:Array = var_28.figureData.getColourIds(param1);
         if(!_loc4_)
         {
            _loc4_ = new Array();
         }
      ...
      protected function initCategory(param1:String) : void
      {
         ...
         if(_loc2_ == null)
         {
            _loc3_ = var_28.generateDataContent(this,param1);
            if(_loc3_)
            {
               var_89[param1] = _loc3_;
