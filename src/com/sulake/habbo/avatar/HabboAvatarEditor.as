package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private var var_900:AvatarEditorHandler;
      ...
      private const const_1097:int = 2;
      ...
      public function method_4(param1:String) : ISetType
      {
         if(var_725 == null)
         {
            return null;
         }
         return var_725.getSetType(param1);
      }
      ...
      private function init() : void
      {
         ...
         if(!var_165)
         {
            ...
            var_515["null"] = new FigureData(this);
            var_515["null"] = new FigureData(this);
            _loc1_ = var_515["null"];
            _loc2_ = var_515["null"];
            _loc1_.loadAvatarData("hr-681-35.hd-209-7.ch-878-87.lg-281-70.sh-906-77.ea-1401-77.ha-1010-70.he-1601-62.fa-1204-62.ca-1809-62.wa-2007-62",FigureData.const_85);
            _loc2_.loadAvatarData("hr-681-41.hd-620-9.ch-879-90.lg-700-85.sh-735-68",FigureData.const_92);
            var_89 = new Map();
            var_441 = new Map();
            var_89.add(AvatarEditorFigureCategory.const_1025,new BodyModel(this));
            var_89.add(AvatarEditorFigureCategory.const_49,new HeadModel(this));
            var_89.add(AvatarEditorFigureCategory.const_298,new TorsoModel(this));
            var_89.add(AvatarEditorFigureCategory.const_1264,new LegsModel(this));
            var_89.add(AvatarEditorFigureCategory.const_1363,new HotLooksModel(this));
            var_441.add(AvatarEditorSideCategory.WARDROBE,new WardrobeModel(this));
            var_441.add(AvatarEditorSideCategory.const_362,new ClubPromoModel(this));
            var_165 = true;
         }
      }
      ...
      public function getDefaultColour(param1:String) : int
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:ISetType = method_4(param1);
         if(_loc2_ != null)
         {
            _loc3_ = getPalette(_loc2_.paletteID);
            for each(_loc4_ in _loc3_.colors)
            {
               if(_loc4_.isSelectable && var_1070 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         _loc5_ = 0;
         while(_loc5_ < const_1097)
         {
            _loc4_.push(new Array());
            _loc5_++;
         }
         var _loc9_:Boolean = false;
         _loc8_ = method_4(param2);
         if(!_loc8_)
         {
            return null;
         }
         ...
         if(_loc8_ != null)
         {
            ...
            _loc13_ = isClubTryoutAllowed() && var_1560;
            for each(_loc14_ in _loc10_.colors)
            {
               if(_loc14_.isSelectable && (_loc13_ || var_1070 >= _loc14_.clubLevel))
               {
                  _loc16_ = 0;
                  while(_loc16_ < const_1097)
                  {
                     _loc17_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1615.clone() as IWindowContainer,param1,_loc14_);
            ...
            for each(_loc6_ in _loc8_.partSets)
            {
               ...
               if(_loc6_.isSelectable && _loc21_ && (_loc13_ || var_1070 >= _loc6_.clubLevel))
               {
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return var_441.getValue(AvatarEditorSideCategory.WARDROBE);
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_900 = new AvatarEditorHandler(this,_communication);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return var_725.getPalette(param1);
      }
      ...
      {
         var _loc2_:IAvatarEditorCategoryModel = var_89.getValue(param1) as IAvatarEditorCategoryModel;
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:ISideContentModel = var_441.getValue(param1) as ISideContentModel;
         if(_loc2_ != null)
         {
            return _loc2_.getWindowContainer();
         }
      ...
      public function openEditor(param1:IWindowContainer = null) : Boolean
      {
         ...
         else
         {
            if(_windowContext == null)
            {
               _windowContext = _windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_62,HabboWindowStyle.const_42,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
         ...
         _view.show();
         toggleAvatarEditorPage(AvatarEditorFigureCategory.const_1025);
         return true;
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         var_725 = var_575.getFigureData(AvatarType.const_80);
      }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_575 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,onAvatarRendererReady);
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         var_1070 = param3;
         var _loc4_:FigureData = var_515[param2];
         if(_loc4_ == null)
         {
            return;
         }
