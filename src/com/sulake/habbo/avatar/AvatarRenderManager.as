package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private var var_1050:PaletteManager;
      
      private var var_710:PetDataManager;
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            case AvatarType.const_80:
               _loc3_ = var_233.getValue(AvatarType.const_80) as AvatarStructure;
               break;
            case AvatarType.PET:
               _loc3_ = var_233.getValue(AvatarType.PET) as AvatarStructure;
               break;
            default:
      ...
      {
         var _loc2_:* = null;
         _loc2_ = var_233.getValue(AvatarType.const_80) as AvatarStructure;
         if(_loc2_ != null)
         {
            _loc2_.initConfiguration(_habboConfiguration);
         }
         _loc2_ = var_233.getValue(AvatarType.PET) as AvatarStructure;
         if(_loc2_ != null)
         {
            _loc2_.initConfiguration(_habboConfiguration);
         }
      ...
      private function init() : void
      {
         ...
         var_710 = new PetDataManager(_loc1_,_loc3_);
         var_1050 = new PaletteManager(_loc1_,_loc3_);
         var _loc4_:XML = _assets.getAssetByName("HabboAvatarPetFigure").content as XML;
         var_710.populateFigureData(_loc4_);
         ...
         var_233.add(AvatarType.const_80,_loc5_);
         _loc5_ = new AvatarStructure(this,assets,_loc1_,AvatarType.PET);
         _loc5_.addEventListener(AvatarStructure.AVATAR_STRUCTURE_INIT,onStructureInit);
         var_233.add(AvatarType.PET,_loc5_);
      }
      
      public function get petDataManager() : IPetDataManager
      {
         return var_710 as IPetDataManager;
      }
      
      public function set mode(param1:String) : void
      {
         var_735 = param1;
         if(var_735 == RenderMode.const_1228)
         {
            init();
         }
         if(var_735 == RenderMode.const_1213)
         {
            init();
      ...
      {
         var _loc5_:String = var_710.createAvatarFigureString(param1,param2,param3);
         var _loc6_:AvatarStructure = var_233.getValue(AvatarType.PET) as AvatarStructure;
         if(_loc6_ == null)
         {
            return null;
         }
      ...
      {
         var _loc2_:AvatarStructure = var_233.getValue(param1) as AvatarStructure;
         if(_loc2_ != null)
         {
      ...
      {
         var _loc4_:AvatarStructure = var_233.getValue(AvatarType.const_80) as AvatarStructure;
         if(_loc4_ == null)
         {
            return null;
         }
