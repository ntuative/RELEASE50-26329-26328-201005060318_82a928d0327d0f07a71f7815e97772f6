package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_420:PartSetsData;
      
      private var var_1948:PartOffsetData;
      
      private var var_847:AvatarActionManager;
      
      private var var_171:IAssetLibrary;
      
      private var var_1034:IAssetLibrary;
      
      private var var_1949:AvatarRenderManager;
      
      private var var_306:FigureData;
      ...
      private var var_1495:AvatarStructureDownloadSet;
      
      private var var_1243:Array;
      
      private var var_698:AnimationManager;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_171 = param2;
         var_1034 = param3;
         var_306 = new FigureData();
         var_420 = new PartSetsData();
         _animationData = new AnimationData();
         var_1495 = new AvatarStructureDownloadSet();
         var_698 = new AnimationManager();
         var_699 = param4;
         var_1948 = PartOffsetData.getInstance(param3);
         init();
      }
      ...
      {
         return var_847.getActionDefinitionWithState(param1);
      }
      ...
      private function init() : void
      {
         ...
         switch(var_699)
         {
            case AvatarType.const_80:
               _loc1_ = var_171.getAssetByName("HabboAvatarPartSets").content as XML;
               if(!var_420.parse(_loc1_))
               {
                  return;
               }
               _loc2_ = var_171.getAssetByName("HabboAvatarAnimation").content as XML;
               if(!_animationData.parse(_loc2_))
               {
                  return;
               }
               _loc3_ = var_171.getAssetByName("HabboAvatarFigure").content as XML;
               if(!var_306.parse(_loc3_))
               {
                  return;
               }
               break;
            case AvatarType.PET:
               _loc1_ = var_171.getAssetByName("HabboAvatarPetPartSets").content as XML;
               if(!var_420.parse(_loc1_))
               {
                  return;
               }
               _loc2_ = var_171.getAssetByName("HabboAvatarPetAnimation").content as XML;
               if(!_animationData.parse(_loc2_))
               {
                  return;
               }
               _loc3_ = var_171.getAssetByName("HabboAvatarPetFigure").content as XML;
               if(!var_306.parse(_loc3_))
               {
                  return;
               }
      ...
      {
         return var_847.getCanvasOffsets(param1,param2,param3);
      }
      
      public function injectFigureData(param1:XML) : void
      {
         var_306.appendXML(param1);
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return var_847.getActionDefinition(param1);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = var_698.getAnimation(_loc6_);
            if(_loc7_ != null)
            {
               ...
               if(_loc7_.hasAddData())
               {
                  for each(_loc9_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc12_ = var_420.addPartDefinition(_loc11_);
         ...
         {
            _loc2_ = var_420.getActiveParts(param1.definition);
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1167[param3];
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         var _loc8_:ActionDefinition = var_847.getDefaultActionType();
         var _loc9_:Array = var_420.getActiveParts(param3.definition);
         var _loc11_:Array = new Array();
         if(param3.definition.isAnimation)
         {
            _loc19_ = param3.definition.state + "." + param3.actionParameter;
            _loc10_ = var_698.getAnimation(_loc19_);
            if(_loc10_ != null)
            {
         ...
         for each(_loc16_ in _loc15_)
         {
            ...
            _loc25_ = var_306.getSetType(_loc16_);
            if(_loc25_ != null)
            {
               _loc26_ = var_306.getPalette(_loc25_.paletteID);
               if(_loc26_)
               {
                  ...
                  if(_loc27_ != null)
                  {
                     ...
                     for each(_loc28_ in _loc27_.parts)
                     {
                        if(_loc14_.indexOf(_loc28_.type) > -1)
                        {
                           ...
                           _loc13_ = var_420.getPartDefinition(_loc28_.type);
         ...
         for each(_loc12_ in _loc14_)
         {
            ...
            if(!_loc37_)
            {
               ...
               if(_loc9_.indexOf(_loc12_) > -1)
               {
                  ...
                  {
                     _loc13_ = var_420.getPartDefinition(_loc12_);
                     _loc42_ = false;
                     _loc43_ = 1;
      ...
      private function initGeometry() : void
      {
         ...
         {
            case AvatarType.const_80:
               if(var_171.hasAsset("HabboAvatarGeometry"))
               {
                  _loc1_ = var_171.getAssetByName("HabboAvatarGeometry").content as XML;
               ...
               break;
            case AvatarType.PET:
               if(var_171.hasAsset("HabboAvatarPetGeometry"))
               {
                  _loc1_ = var_171.getAssetByName("HabboAvatarPetGeometry").content as XML;
                  _geometry = new AvatarModelGeometry(_loc1_);
               }
               else
               {
      ...
      {
         Logger.log("[AvatarStructure] Structure " + var_699 + " ready to go!");
         if(var_699 == AvatarType.const_80)
         {
            var_420.getPartDefinition("ri").appendToFigure = true;
            var_420.getPartDefinition("li").appendToFigure = true;
         }
         registerAnimations();
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         {
            case AvatarType.const_80:
               if(var_171.hasAsset(_loc5_))
               {
                  var_171.removeAsset(var_171.getAssetByName(_loc5_));
               }
               var_1495.add(new AvatarStructureDownload(var_171,_loc5_,var_306));
               break;
            case AvatarType.PET:
         }
         var_1495.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,onStructureReady);
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return var_698.getAnimation(param1);
      }
      ...
      {
         var_847 = new AvatarActionManager(var_171,var_699);
      }
      ...
      public function getMandatorySetTypeIds() : Array
      {
         ...
         var_1243 = var_306.getMandatorySetTypeIds();
         return var_1243;
      }
      
      public function getDefaultPartSet(param1:String, param2:String) : IFigurePartSet
      {
         return var_306.getDefaultPartSet(param1,param2);
      }
      ...
      private function registerAnimations() : void
      {
         var _loc2_:* = null;
         var _loc1_:int = 1;
         while(var_1034.hasAsset("dance" + _loc1_))
         {
            _loc2_ = var_1034.getAssetByName("dance" + _loc1_).content as XML;
            var_698.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
         while(var_1034.hasAsset("fx" + _loc1_))
         {
            _loc2_ = var_1034.getAssetByName("fx" + _loc1_).content as XML;
            var_698.registerAnimation(this,_loc2_);
            _loc1_++;
         }
      }
      ...
      public function getPartColor(param1:AvatarFigureContainer, param2:String, param3:int = 0) : IPartColor
      {
         ...
         var _loc5_:ISetType = var_306.getSetType(param2);
         if(_loc5_ == null)
         {
            return null;
         }
         var _loc6_:IPalette = var_306.getPalette(_loc5_.paletteID);
         if(!_loc6_)
         {
            return null;
         }
      ...
      {
         return var_847.sortActions(param1);
      }
   }
}
