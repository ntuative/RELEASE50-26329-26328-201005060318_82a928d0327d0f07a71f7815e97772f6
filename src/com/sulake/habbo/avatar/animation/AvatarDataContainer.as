package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      {
         super();
         var_1440 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         var_1801 = parseInt(_loc2_,16);
         var_1799 = parseInt(_loc3_,16);
         _rgb = parseInt(_loc2_,16);
         var_1473 = _rgb >> 16 & 255;
         var_1472 = _rgb >> 8 & 255;
         _b = _rgb >> 0 & 255;
         var_1565 = var_1473 / 255 * 1;
         var_1564 = var_1472 / 255 * 1;
         var_1566 = _b / 255 * 1;
         if(var_1440 == 37)
         {
         ...
         _colorTransform = new ColorTransform(var_1565,var_1564,var_1566,_alphaMultiplier);
         var_998 = generatePaletteMapForGrayscale(var_1799,var_1801);
      }
      
      public function get reds() : Array
      {
         return var_998.getValue("reds") as Array;
      }
      ...
      {
         return var_998.getValue("blues") as Array;
      }
      
      public function get greens() : Array
      {
         return var_998.getValue("greens") as Array;
      }
      ...
      {
         return var_998.getValue("alphas") as Array;
      }
