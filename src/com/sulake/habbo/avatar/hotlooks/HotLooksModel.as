package com.sulake.habbo.avatar.hotlooks
{
   ...
   public class HotLooksModel extends CategoryBaseModel implements IAvatarEditorCategoryModel
   {
      ...
      public static const const_1562:String = "hot_looks";
      ...
      public function HotLooksModel(param1:HabboAvatarEditor)
      {
         ...
         var_446["null"] = new Array();
         var_446["null"] = new Array();
         var_446["undefined.index"] = 0;
         var_446["undefined.index"] = 0;
         requestHotLooks();
      }
      ...
      {
         var _loc1_:String = var_28.configuration.getKey("avatareditor.promohabbos");
         var _loc2_:URLRequest = new URLRequest(_loc1_);
         var _loc3_:AssetLoaderStruct = var_28.assets.loadAssetFromFile("hotLooksConfiguration",_loc2_,"text/xml");
         _loc3_.addEventListener(AssetLoaderEvent.const_37,onHotLooksConfiguration);
      }
      
      public function selectHotLook(param1:int) : void
      {
         var _loc2_:Array = var_446["null"];
         ...
         if(_loc3_ != null)
         {
            ...
            var_28.loadAvatarInEditor(_loc3_.figure,_loc3_.gender,var_28.clubMemberLevel);
         }
      }
      ...
      private function onHotLooksConfiguration(param1:Event = null) : void
      {
         ...
         var _loc3_:XmlAsset = var_28.assets.getAssetByName("hotLooksConfiguration") as XmlAsset;
         if(_loc3_ != null)
         {
            _loc4_ = _loc3_.content as XML;
            for each(_loc5_ in _loc4_.habbo)
            {
               _loc6_ = new Outfit(var_28,_loc5_.@figure,_loc5_.@gender);
               (var_446[_loc6_.gender] as Array).push(_loc6_);
            }
         }
         else
         {
