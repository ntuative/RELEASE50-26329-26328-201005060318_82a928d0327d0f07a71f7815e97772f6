package com.sulake.habbo.avatar.structure
{
   ...
   public class PartSetsData implements IStructureData
   {
      ...
      private var var_178:Dictionary;
      ...
      {
         super();
         var_178 = new Dictionary();
         var_778 = new Dictionary();
      }
      ...
      {
         var _loc2_:ActivePartSet = var_778[param1.activePartSet];
         if(_loc2_ != null)
         {
            return _loc2_.parts;
         }
      ...
      public function addPartDefinition(param1:XML) : PartDefinition
      {
         ...
         if(true)
         {
            var_178[_loc2_] = new PartDefinition(param1);
         }
         return var_178[_loc2_];
      }
      ...
      public function parse(param1:XML) : Boolean
      {
         ...
         {
            var_178[String(_loc2_["set-type"])] = new PartDefinition(_loc2_);
         }
         for each(_loc3_ in param1.activePartSet)
         {
            var_778[String(_loc3_.@id)] = new ActivePartSet(_loc3_);
         }
         return true;
      }
      ...
      {
         return var_778[param1.activePartSet] as ActivePartSet;
      }
      
      public function getPartDefinition(param1:String) : PartDefinition
      {
         return var_178[param1] as PartDefinition;
      }
   }
}
