package com.sulake.habbo.avatar.geometry
{
   ...
   public class AvatarSet
   {
      ...
      private var var_1018:Dictionary;
      ...
      public function AvatarSet(param1:XML)
      {
         ...
         var_1878 = _loc2_ == null ? false : Boolean(Boolean(parseInt(_loc2_)));
         var_1018 = new Dictionary();
         var_1474 = new Array();
         for each(_loc3_ in param1.avatarset)
         {
            _loc5_ = new AvatarSet(_loc3_);
            var_1018[String(_loc3_.@id)] = _loc5_;
         }
         for each(_loc4_ in param1.bodypart)
         {
            var_1474.push(String(_loc4_.@id));
         }
      }
      ...
      {
         var _loc2_:* = null;
         var _loc1_:Array = var_1474.concat();
