package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_493:Point = null;
      
      private var var_696:Map = null;
      
      private var var_492:Vector3d;
      
      private var _connection:IConnection = null;
      
      private var var_494:Map = null;
      
      public function ChatWidgetHandler()
      {
         var_492 = new Vector3d();
         super();
         var_494 = new Map();
         var_696 = new Map();
      }
      ...
      {
         return [RoomSessionChatEvent.const_139];
      }
      ...
      public function dispose() : void
      {
         ...
         if(var_494 != null)
         {
            ...
            {
               _loc2_ = var_494.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionChatEvent.const_139:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           _loc13_ = var_494.getValue(_loc15_) as BitmapData;
                           _loc12_ = uint(var_696.getValue(_loc15_));
                           if(_loc13_ == null)
                           {
                              if(false)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_294:
                                       _loc16_ = _container.avatarRenderManager.createPetImageFromFigure(_loc15_,AvatarScaleType.SMALL);
                                       if(_loc16_ != null)
                                       {
                                          _loc13_ = _loc16_.getCroppedImage(AvatarSetType.const_40).clone();
                                    ...
                                    default:
                                       ...
                                       if(_loc16_ != null)
                                       {
                                          _loc13_ = _loc16_.getCroppedImage(AvatarSetType.const_49).clone();
                                 ...
                                 if(_loc13_ != null)
                                 {
                                    var_494.add(_loc15_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
                                    var_696.add(_loc15_,_loc12_);
                                 }
                                 if(_loc16_ != null)
                                 {
                                    _loc16_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_605,RoomWidgetChatSelectAvatarMessage.const_563];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_605:
               if(_container != null && false)
               {
                  ...
                  if(_loc3_ != null)
                  {
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_139,_container.roomSession,0,"Version 26329-26328-201005060241");
                     ...
                     {
                        case RoomWidgetChatMessage.const_134:
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_563:
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_493 == null)
            {
               ...
               var_492.y = 0;
               var_492.z = 0;
               var_493 = _loc4_.getScreenPoint(var_492);
            ...
            var_492.y = 0;
            var_492.z = 0;
            _loc8_ = _loc4_.getScreenPoint(var_492);
            if(_loc8_ != null)
            {
               if(_loc8_.x != var_493.x || _loc8_.y != var_493.y)
               {
                  _loc9_ = PointMath.sub(_loc8_,PointMath.mul(var_493,_loc5_));
      ...
      {
         return RoomWidgetEnum.const_332;
      }
