package com.sulake.habbo.ui
{
   ...
   public class DoorbellWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return RoomWidgetEnum.const_106;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionDoorbellEvent.const_106:
               _loc2_ = param1 as RoomSessionDoorbellEvent;
               if(_loc2_ == null)
               {
                  return;
               }
               _container.events.dispatchEvent(new RoomWidgetDoorbellEvent(RoomWidgetDoorbellEvent.const_667,_loc2_.userName));
               break;
            case RoomSessionDoorbellEvent.const_116:
               ...
               break;
            case RoomSessionDoorbellEvent.const_57:
               _loc2_ = param1 as RoomSessionDoorbellEvent;
               if(_loc2_ == null)
               {
                  return;
               }
               _container.events.dispatchEvent(new RoomWidgetDoorbellEvent(RoomWidgetDoorbellEvent.const_57,_loc2_.userName));
               break;
         }
      }
      ...
      {
         return [RoomWidgetLetUserInMessage.const_721];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetLetUserInMessage.const_721:
      ...
      {
         return [RoomSessionDoorbellEvent.const_106,RoomSessionDoorbellEvent.const_116,RoomSessionDoorbellEvent.const_57];
      }
