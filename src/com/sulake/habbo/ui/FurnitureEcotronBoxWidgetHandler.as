package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         var _loc3_:RoomWidgetEcotronBoxDataUpdateEvent = new RoomWidgetEcotronBoxDataUpdateEvent(RoomWidgetEcotronBoxDataUpdateEvent.const_86,0,_name,false,param2);
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_582,RoomWidgetEcotronBoxOpenMessage.const_551,RoomWidgetEcotronBoxOpenedMessage.const_1225];
      }
            ...
            switch(param1.type)
            {
               case RoomSessionPresentEvent.const_259:
                  ...
                  if(_loc2_ != null)
                  {
                     ...
                     if(_loc3_ != null)
                     {
                        _loc5_ = new RoomWidgetEcotronBoxDataUpdateEvent(RoomWidgetEcotronBoxDataUpdateEvent.const_86,0,_name,false,_loc3_.data);
      ...
      {
         return RoomWidgetEnum.const_489;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_582:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_551:
