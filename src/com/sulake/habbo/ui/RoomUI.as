package com.sulake.habbo.ui
{
   ...
   public class RoomUI extends Component implements IRoomUI, IUpdateReceiver
   {
      ...
      private var var_792:IRoomWidgetFactory;
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_108:
               if(param1.session != null)
               {
                  ...
                  var_195.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_156,HabboToolbarIconEnum.ZOOM));
                  var_195.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_156,HabboToolbarIconEnum.MEMENU));
                  var_195.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_156,HabboToolbarIconEnum.INVENTORY));
               }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         {
            var_253.events.addEventListener(AdEvent.const_359,adEventHandler);
            var_253.events.addEventListener(AdEvent.const_433,adEventHandler);
            var_253.events.addEventListener(AdEvent.const_400,adEventHandler);
         }
      }
      ...
      private function onRoomWidgetFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_792 = param2 as IRoomWidgetFactory;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_792 != null)
         {
            var_792.release(new IIDHabboRoomWidget());
            var_792 = null;
         }
         if(var_11 != null)
         {
         ...
         if(var_662 != null)
         {
            var_662.release(new IIDHabboModeration());
            var_662 = null;
         }
         if(_navigator != null)
         {
      ...
      public function disposeDesktop(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc3_ = _loc2_.getWidgetState(RoomWidgetEnum.const_253);
            if(_loc3_ != RoomDesktop.const_486)
            {
               var_981 = _loc3_;
            }
            _loc2_.dispose();
      ...
      private function onHabboModerationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_662 = param2 as IHabboModeration;
         Logger.log("XXXX GOT HABBO MODERATION: " + var_662);
      }
      ...
      private function roomEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_570:
               ...
               _loc3_.createWidget(RoomWidgetEnum.const_253);
               if(var_981 != RoomDesktop.const_486)
               {
                  _loc3_.initializeWidget(RoomWidgetEnum.const_253,var_981);
               }
               if(var_253 != null)
               {
                  var_253.showRoomAd();
               ...
               break;
            case RoomEngineEvent.const_709:
               disposeDesktop(_loc2_);
               break;
            case RoomEngineRoomColorEvent.const_677:
      ...
      private function roomSessionDialogEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(event.type)
         {
            ...
            case RoomSessionErrorMessageEvent.const_222:
               ...
               break;
            case RoomSessionErrorMessageEvent.const_726:
            ...
            case RoomSessionErrorMessageEvent.const_725:
               ...
               break;
            case RoomSessionErrorMessageEvent.const_613:
      ...
      private function initializeRoomEngineEvents() : void
      {
         if(_roomEngine != null && false)
         {
            ...
            _roomEngine.events.addEventListener(RoomEngineEvent.const_709,roomEventHandler);
            _roomEngine.events.addEventListener(RoomEngineDimmerStateEvent.const_65,roomEventHandler);
            _roomEngine.events.addEventListener(RoomEngineRoomColorEvent.const_677,roomEventHandler);
            _roomEngine.events.addEventListener(RoomEngineObjectEvent.const_730,roomObjectEventHandler);
            ...
            _roomEngine.events.addEventListener(RoomEngineObjectEvent.const_717,roomObjectEventHandler);
            _roomEngine.events.addEventListener(RoomEngineObjectEvent.const_211,roomObjectEventHandler);
      ...
      private function registerSessionEvents() : void
      {
         if(var_18)
         {
            ...
            var_18.events.addEventListener(RoomSessionDoorbellEvent.const_116,roomSessionEventHandler);
            var_18.events.addEventListener(RoomSessionDoorbellEvent.const_57,roomSessionEventHandler);
            var_18.events.addEventListener(RoomSessionPresentEvent.const_259,roomSessionEventHandler);
            ...
            var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_726,roomSessionDialogEventHandler);
            var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_960,roomSessionDialogEventHandler);
            var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_882,roomSessionDialogEventHandler);
            ...
            var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_613,roomSessionDialogEventHandler);
            ...
            var_18.events.addEventListener(RoomSessionQueueEvent.const_412,roomSessionEventHandler);
            var_18.events.addEventListener(RoomSessionVoteEvent.const_114,roomSessionEventHandler);
            ...
            var_18.events.addEventListener(RoomSessionPollEvent.const_125,roomSessionEventHandler);
            var_18.events.addEventListener(RoomSessionDimmerPresetsEvent.const_447,roomSessionEventHandler);
      ...
      private function onAvatarEditorReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1148 = param2 as IHabboAvatarEditor;
      }
   }
}
