   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(UserTagsReceivedEvent.const_148,onUserTags);
               _container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_109,onBadgeImage);
            }
            if(false)
            {
               _container.roomSessionManager.events.removeEventListener(RoomSessionUserFigureUpdateEvent.const_141,onFigureUpdate);
               _container.roomSessionManager.events.removeEventListener(RoomSessionPetInfoUpdateEvent.const_145,onPetInfo);
         ...
         if(false)
         {
            _container.sessionDataManager.events.addEventListener(UserTagsReceivedEvent.const_148,onUserTags);
            _container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_109,onBadgeImage);
         }
         if(false)
         {
            _container.roomSessionManager.events.addEventListener(RoomSessionUserFigureUpdateEvent.const_141,onFigureUpdate);
            _container.roomSessionManager.events.addEventListener(RoomSessionPetInfoUpdateEvent.const_145,onPetInfo);
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_32:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_581);
               _loc6_.id = param1.id;
               ...
               {
                  _loc22_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_305);
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_990);
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_832);
            ...
            case RoomObjectCategoryEnum.const_38:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_294)
               {
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_917)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc16_ != null)
               {
                  _loc13_.carryItem = _loc16_.getModel().getNumber(RoomObjectVariableEnum.const_738);
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_223)
               {
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_219)
               {
                  ...
                  if(_loc16_ != null)
                  {
                     _loc30_ = _loc16_.getModel().getString(RoomObjectVariableEnum.const_693);
                  ...
                  _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1201;
                  if(!_loc25_)
                  {
                  ...
                  if(!_loc26_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_867;
                  }
                  if(!_loc27_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_968;
                  }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1191);
               }
               else
               {
               ...
               if(_loc19_ != null)
               {
                  _loc19_.setDirection(AvatarSetType.const_40,4);
                  _loc13_.image = _loc19_.getImage(AvatarSetType.const_40,true);
                  _loc19_.dispose();
               }
      ...
      private function onFigureUpdate(param1:RoomSessionUserFigureUpdateEvent) : void
      {
         ...
         if(false)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               _loc4_ = _loc5_.getImage(AvatarSetType.const_40,true);
               _loc5_.dispose();
            }
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc5_:IAvatarImage = var_573.getValue(_loc2_.petId) as IAvatarImage;
         if(_loc5_ == null)
         {
            _loc5_ = _container.avatarRenderManager.createPetImageFromFigure(_loc4_,AvatarScaleType.const_56);
            var_573.add(_loc2_.petId,_loc5_);
         }
         ...
         if(_container != null && false)
         {
            ...
            _loc9_ = new RoomWidgetPetInfoUpdateEvent(_loc6_,_loc7_,_loc3_.name,_loc2_.petId,_loc5_.getCroppedImage(AvatarSetType.const_40),_loc8_,_loc2_.ownerId,_loc2_.ownerName,_loc3_.id);
            ...
            if(_loc13_ != null)
            {
               _loc14_ = _container.roomEngine.getRoomObject(_loc11_,_loc12_,_loc13_.id,RoomObjectCategoryEnum.const_38);
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_693);
      ...
      {
         return [RoomSessionUserBadgesEvent.const_120];
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_344);
         _loc1_.push(RoomWidgetUserActionMessage.const_734);
         _loc1_.push(RoomWidgetUserActionMessage.const_722);
         _loc1_.push(RoomWidgetUserActionMessage.const_670);
         _loc1_.push(RoomWidgetUserActionMessage.const_512);
         _loc1_.push(RoomWidgetUserActionMessage.const_614);
         _loc1_.push(RoomWidgetUserActionMessage.const_459);
         _loc1_.push(RoomWidgetUserActionMessage.const_540);
         _loc1_.push(RoomWidgetUserActionMessage.const_565);
         _loc1_.push(RoomWidgetUserActionMessage.const_528);
         _loc1_.push(RoomWidgetUserActionMessage.const_704);
         _loc1_.push(RoomWidgetUserActionMessage.const_633);
         _loc1_.push(RoomWidgetFurniActionMessage.const_277);
         _loc1_.push(RoomWidgetFurniActionMessage.const_706);
         _loc1_.push(RoomWidgetFurniActionMessage.const_524);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_589);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_689);
         _loc1_.push(RoomWidgetUserActionMessage.const_467);
         _loc1_.push(RoomWidgetUserActionMessage.const_621);
         _loc1_.push(RoomWidgetUserActionMessage.const_741);
         _loc1_.push(RoomWidgetUserActionMessage.const_1291);
         _loc1_.push(RoomWidgetPetCommandMessage.const_622);
         _loc1_.push(RoomWidgetPetCommandMessage.const_641);
         _loc1_.push(RoomWidgetUserActionMessage.const_592);
         _loc1_.push(RoomWidgetUserActionMessage.const_428);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserBadgesEvent.const_120:
      ...
      public function dispose() : void
      {
         ...
         if(var_573 != null)
         {
            _loc1_ = var_573.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_573.getValue(_loc2_);
               if(_loc3_)
               {
                  _loc3_.dispose();
               }
      ...
      {
         return RoomWidgetEnum.const_389;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_467)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_344:
            ...
            case RoomWidgetUserActionMessage.const_592:
               ...
               break;
            case RoomWidgetUserActionMessage.const_670:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_884,_loc3_.name);
               _container.events.dispatchEvent(_loc8_);
               break;
            case RoomWidgetUserActionMessage.const_512:
            ...
            case RoomWidgetUserActionMessage.const_614:
               ...
               break;
            case RoomWidgetUserActionMessage.const_459:
            ...
            case RoomWidgetUserActionMessage.const_540:
               ...
               break;
            case RoomWidgetUserActionMessage.const_565:
            ...
            case RoomWidgetUserActionMessage.const_528:
               ...
               break;
            case RoomWidgetUserActionMessage.const_704:
            ...
            case RoomWidgetUserActionMessage.const_633:
               ...
               break;
            case RoomWidgetUserActionMessage.const_741:
               _container.roomSession.pickUpPet(_loc2_);
               break;
            case RoomWidgetFurniActionMessage.const_706:
            ...
            case RoomWidgetRoomTagSearchMessage.const_589:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_689:
               ...
               break;
            case RoomWidgetUserActionMessage.const_467:
