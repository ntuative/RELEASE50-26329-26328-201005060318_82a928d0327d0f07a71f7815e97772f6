package com.sulake.habbo.ui
{
   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return RoomWidgetEnum.const_440;
      }
      ...
      private function setMeMenuToolbarIcon(param1:Boolean) : void
      {
         ...
         if(false)
         {
            ...
            if(_loc6_ != null)
            {
               _loc6_.setDirection(AvatarSetType.const_49,3);
               _loc2_ = _loc6_.getCroppedImage(AvatarSetType.const_49);
            }
         }
         ...
         if(_loc3_ != null)
         {
            ...
            Logger.log("MeMenuWidgetHandler: set toolbar icon: " + var_195 + " " + _loc7_);
            if(var_195 != null && _loc7_ != null)
            {
               _loc9_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_876,HabboToolbarIconEnum.MEMENU);
               _loc9_.bitmapData = _loc7_;
               var_195.events.dispatchEvent(_loc9_);
            }
         }
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_708,onFigureUpdate);
            }
            if(false)
            {
            ...
            if(false)
            {
               _container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_451,onHelpTutorialEvent);
         ...
         if(_container != null && false)
         {
            _container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_708,onFigureUpdate);
         ...
         if(var_11 != null)
         {
            (var_11 as Component).events.addEventListener(HabboInventoryEffectsEvent.const_974,onAvatarEffectsChanged);
            (var_11 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_1023,onHabboClubSubscriptionChanged);
         }
         ...
         if(false)
         {
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_451,onHelpTutorialEvent);
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HabboHelpTutorialEvent.const_451:
               _container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_482));
         }
      }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetDanceMessage.const_588);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_513);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_669);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_550);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_737);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_510);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_511);
         _loc1_.push(RoomWidgetStopEffectMessage.const_573);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1398);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_941);
         _loc1_.push(RoomWidgetToolbarMessage.const_650);
         _loc1_.push(RoomWidgetToolbarMessage.const_634);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_688);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1266);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_964);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_629);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_655);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_574);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1177);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_515);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_578);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_514);
         return _loc1_;
      }
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_739));
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_655:
            ...
            case RoomWidgetWaveMessage.const_559:
               ...
               break;
            case RoomWidgetDanceMessage.const_588:
               if(_container != null && false)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_513:
               if(var_11 != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_669:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_550:
               if(var_11 != null)
               {
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_511:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(_catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_813)
               {
                  _catalog.openCatalogPage(CatalogPageName.const_233,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_510:
               ...
               if(var_11 != null)
               {
                  ...
                  switch(_loc3_.inventoryType)
                  {
                     case RoomWidgetOpenInventoryMessage.const_978:
                        ...
                        break;
                     case RoomWidgetOpenInventoryMessage.const_827:
                     ...
                     case RoomWidgetOpenInventoryMessage.const_1258:
                        ...
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1284:
                        break;
                     default:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_737:
            ...
            case RoomWidgetSetToolbarIconMessage.const_865:
               ...
               {
                  case RoomWidgetSetToolbarIconMessage.const_1274:
                     break;
                  default:
            ...
            case RoomWidgetShowOwnRoomsMessage.const_629:
               ...
               break;
            case RoomWidgetToolbarMessage.const_650:
               ...
               if(var_195)
               {
                  var_195.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_51,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(var_11 != null)
                  {
                     _loc12_ = false;
                     if(_container != null && false)
               ...
               break;
            case RoomWidgetToolbarMessage.const_634:
            ...
            case RoomWidgetAvatarEditorMessage.const_688:
               ...
               if(_container)
               {
                  ...
                  {
                     _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_380));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_574:
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_307,_container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_515:
               _container.soundManager.volume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_307,_container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_578:
               _container.soundManager.previewVolume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_307,_container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_514:
               if(false && _container.habboHelp.events)
               {
                  _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_466));
               }
               break;
            default:
