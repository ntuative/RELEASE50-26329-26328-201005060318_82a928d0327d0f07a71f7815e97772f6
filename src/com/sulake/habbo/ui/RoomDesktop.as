package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      public static const const_486:int = -1;
       
      
      private var var_1148:IHabboAvatarEditor = null;
      
      private var var_167:DesktopLayoutManager;
      ...
      private var var_1193:Boolean = true;
      
      private var _widgets:Map;
      
      private var var_793:IHabboHelp = null;
      ...
      private var var_792:IRoomWidgetFactory = null;
      ...
      private var var_575:IAvatarRenderManager = null;
      
      private var _assets:IAssetLibrary = null;
      
      private var var_680:Array;
      
      private var var_662:IHabboModeration;
      
      private var var_168:IToolTipWindow;
      ...
      public function RoomDesktop(param1:IRoomSession, param2:IAssetLibrary, param3:IConnection)
      {
         ...
         _widgets = new Map();
         var_196 = new Map();
         var_167 = new DesktopLayoutManager();
      }
      ...
      public function set roomEngine(param1:IRoomEngine) : void
      {
         ...
         {
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_323,onRoomContentLoaded);
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_439,onRoomContentLoaded);
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_642,onRoomContentLoaded);
         }
      }
      ...
      public function init() : void
      {
         ...
         {
            var_680 = _roomEngine.loadRoomResources(var_38.roomResources);
            if(false)
            {
               var_1192 = false;
         ...
         if(var_253 != null && true)
         {
            var_1193 = !var_253.showInterstitial();
         }
         checkInterrupts();
      }
      ...
      private function onRoomViewResized(param1:WindowEvent) : void
      {
         ...
         _roomEngine.modifyRoomCanvas(var_38.roomId,var_38.roomCategory,var_264[0],_loc2_.width,_loc2_.height);
      ...
      public function dispose() : void
      {
         ...
         if(var_196 != null)
         {
            ...
            {
               _loc5_ = var_196.getWithIndex(_loc1_) as IRoomWidgetHandler;
               if(_loc5_ != null)
               {
                  _loc5_.dispose();
               }
         ...
         if(_friendList && false)
         {
            ...
            _friendList.events.removeEventListener(FriendRequestEvent.const_244,processEvent);
         }
         _friendList = null;
         var_167.dispose();
         var_167 = null;
         if(_roomEngine != null && false)
         {
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_323,onRoomContentLoaded);
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_439,onRoomContentLoaded);
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_642,onRoomContentLoaded);
         }
         _roomEngine = null;
         var_18 = null;
         var_792 = null;
      ...
      private function updateHandlers() : void
      {
         ...
         while(_loc1_ < var_196.length)
         {
            _loc2_ = var_196.getWithIndex(_loc1_) as IRoomWidgetHandler;
            if(_loc2_ != null)
            {
               _loc2_.update();
            }
      ...
      {
         var_167.setLayout(param1,_windowManager);
         if(var_195 != null)
         {
            var_167.toolbarSize = var_195.size;
            var_167.toolbarOrientation = var_195.orientation;
         }
      }
      ...
      public function canvasMouseHandler(param1:Event) : void
      {
         ...
         if(_loc3_ == MouseEvent.MOUSE_MOVE && var_168 != null)
         {
            _loc8_ = new Point(_loc2_.stageX,_loc2_.stageY);
            _loc8_.offset(0,15);
            var_168.setGlobalPosition(_loc8_);
         }
      }
      ...
      public function createWidget(param1:String) : void
      {
         ...
         _loc2_ = var_792.createWidget(param1);
         if(_loc2_ == null)
         {
            return;
         }
         ...
         var_167.addWidgetWindow(_loc2_.mainWindow);
         ...
         if(_loc3_ != null)
         {
            ...
            if(!var_196.add(param1,_loc3_))
            {
               _loc3_.dispose();
            }
         }
         param1 = "null";
         var _loc4_:RoomWidgetRoomViewUpdateEvent = new RoomWidgetRoomViewUpdateEvent(param1,var_167.roomViewRect);
      ...
      private function onToolbarRepositionEvent(param1:HabboToolbarEvent) : void
      {
         if(var_167 != null)
         {
            var_167.toolbarOrientation = param1.orientation;
         }
      }
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_730:
            ...
            case RoomEngineObjectEvent.const_256:
               ...
               break;
            case RoomEngineObjectEvent.const_717:
               switch(_loc3_)
               {
                  case RoomObjectCategoryEnum.const_34:
                  case RoomObjectCategoryEnum.const_32:
            ...
            case RoomEngineObjectEvent.const_110:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_577,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               processWidgetMessage(_loc5_);
               break;
            ...
            case RoomEngineObjectEvent.const_123:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_639,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               processWidgetMessage(_loc5_);
               break;
            case RoomEngineObjectEvent.const_119:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_582,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               processWidgetMessage(_loc5_);
               break;
            ...
            case RoomEngineObjectEvent.const_113:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_950,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               processWidgetMessage(_loc5_);
               break;
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         while(_loc2_ >= 0)
         {
            _loc3_ = var_196.getWithIndex(_loc2_) as IRoomWidgetHandler;
            if(_loc3_ != null)
            {
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         var _loc20_:* = null;
         var _loc2_:Rectangle = var_167.roomViewRect;
         ...
         if(_loc7_ != null)
         {
            _loc12_ = _roomEngine.getRoomNumberValue(var_38.roomId,var_38.roomCategory,RoomVariableEnum.const_555);
            _loc13_ = _roomEngine.getRoomNumberValue(var_38.roomId,var_38.roomCategory,RoomVariableEnum.const_536);
            _loc14_ = _roomEngine.getRoomNumberValue(var_38.roomId,var_38.roomCategory,RoomVariableEnum.const_663);
            _loc15_ = _roomEngine.getRoomNumberValue(var_38.roomId,var_38.roomCategory,RoomVariableEnum.const_625);
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_468:
               ...
               var_168 = _windowManager.createWindow("room_ad_tooltip",_loc3_,WindowType.const_291,WindowStyle.const_335,WindowParam.const_89) as IToolTipWindow;
               var_168.setParamFlag(WindowParam.const_50,false);
      ...
      {
         if(var_680 == null || false)
         {
            return;
         }
         var _loc2_:int = var_680.indexOf(param1.contentType);
         if(_loc2_ != -1)
         {
            var_680.splice(_loc2_,1);
         }
         if(false)
         {
            var_1192 = true;
      ...
      {
         if(var_18 != null && var_38 != null && var_1193 && var_1192)
         {
            var_18.startSession(var_38);
            processEvent(new RoomWidgetLoadingBarUpdateEvent(RoomWidgetLoadingBarUpdateEvent.const_279));
         }
      }
      ...
      public function set friendList(param1:IHabboFriendList) : void
      {
         ...
         if(_friendList)
         {
            ...
            _friendList.events.addEventListener(FriendRequestEvent.const_244,processEvent);
         }
      }
      ...
      {
         var _loc3_:IWindowContainer = var_167.getRoomView() as IWindowContainer;
         if(_loc3_ == null)
         {
            return;
         }
