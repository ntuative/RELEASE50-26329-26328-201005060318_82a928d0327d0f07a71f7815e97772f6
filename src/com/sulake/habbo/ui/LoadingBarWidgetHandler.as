package com.sulake.habbo.ui
{
   ...
   public class LoadingBarWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return RoomWidgetEnum.const_368;
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(AdEvent.const_433);
         _loc1_.push(AdEvent.const_359);
         _loc1_.push(RoomWidgetLoadingBarUpdateEvent.const_94);
         _loc1_.push(RoomWidgetLoadingBarUpdateEvent.const_279);
         return _loc1_;
      }
