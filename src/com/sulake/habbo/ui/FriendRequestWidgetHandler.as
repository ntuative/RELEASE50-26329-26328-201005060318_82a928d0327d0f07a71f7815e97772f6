package com.sulake.habbo.ui
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetFriendRequestMessage.const_714);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_643);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionFriendRequestEvent.const_126:
               ...
               break;
            case FriendRequestEvent.const_57:
            case FriendRequestEvent.const_244:
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_548:
               ...
               if(_loc4_)
               {
                  _loc5_ = _container.roomEngine.getRoomObjectBoundingRectangle(_loc3_.roomId,_loc3_.roomCategory,_loc4_.id,RoomObjectCategoryEnum.const_38,_container.getFirstCanvasId());
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_714:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_643:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomSessionFriendRequestEvent.const_126);
         _loc1_.push(FriendRequestEvent.const_57);
         _loc1_.push(FriendRequestEvent.const_244);
         return _loc1_;
      }
