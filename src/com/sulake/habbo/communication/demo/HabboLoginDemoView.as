package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_571:String = "InitConnection";
      ...
      private var var_234:HabboCommunicationDemo;
      ...
      {
         var_234.windowManager.removeWindow("habbo_login_window");
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         var_234.shockwaveClientUrl = var_114.shockwaveClientUrl;
         var_234.ssoTicket = var_114.ticket;
         var_114.removeEventListener(SSOTicket.const_286,onParsedTicketSuccess);
         var_114.removeEventListener(SSOTicket.const_254,onParsedTicketFailure);
         var_114 = null;
         dispatchEvent(new Event(const_571));
      }
      ...
      private function windowEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(const_1421,"/");
      ...
      {
         var _loc1_:XmlAsset = (var_234 as Component).assets.getAssetByName("login_window") as XmlAsset;
         if(_loc1_ == null)
         {
            Logger.log("Could  not find embedded Window XML for Login Window, login_window");
            return;
         }
         _window = var_234.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_487,HabboWindowStyle.const_43,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         var _loc2_:XML = _loc1_.content as XML;
         var _loc3_:IWindowContainer = var_234.windowManager.buildFromXML(_loc2_) as IWindowContainer;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(const_1421,"/");
         if(_loc5_ != null)
         {
      ...
      private function listEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_234.sendTryLogin(name,password,param2.id);
      }
      ...
      private function initSSOTicket() : void
      {
         ...
         if(false)
         {
            _loc1_ = var_234.habboConfiguration.getKey("url.prefix",_loc1_);
            _loc1_ = _loc1_.replace("http://","");
            _loc1_ = _loc1_.replace("https://","");
         }
         var _loc2_:IHabboWebLogin = var_234.habboCommunication.habboWebLogin(name,password);
         var_114 = new SSOTicket(var_234.assets,_loc2_,_loc1_);
         var_114.addEventListener(SSOTicket.const_286,onParsedTicketSuccess);
         var_114.addEventListener(SSOTicket.const_254,onParsedTicketFailure);
      }
      ...
      public function populateUserList(param1:Map) : void
      {
         ...
         var _loc3_:XmlAsset = var_234.assets.getAssetByName("login_user_list_item") as XmlAsset;
         var _loc4_:IWindow = var_234.windowManager.buildFromXML(_loc3_.content as XML);
