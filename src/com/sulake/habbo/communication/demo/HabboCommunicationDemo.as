package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_1515:ILogger;
      
      private var var_1264:String;
      
      private var var_1983:String;
      
      private const const_1421:String = "fuselogin";
      
      private var var_302:ICoreCommunicationManager;
      
      private var var_424:IKeyExchange;
      ...
      private function onDisconnectReason(param1:IMessageEvent) : void
      {
         ...
         if(var_1044)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_184);
         }
         switch(_loc2_)
         {
            case DisconnectReasonEvent.const_1342:
            case DisconnectReasonEvent.const_1273:
               _loc3_ = _habboConfiguration.getKey("logout.banned.url");
               break;
            case DisconnectReasonEvent.const_1207:
               _loc3_ = _habboConfiguration.getKey("logout.concurrent.url");
               break;
            case DisconnectReasonEvent.const_1152:
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_1984)
         {
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_706 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(var_706);
            _loc2_.send(_loc4_);
      ...
      {
         var_1044 = true;
         dispatchLoginStepEvent(HabboCommunicationEvent.const_238);
         param1.send(new VersionCheckMessageComposer(401,var_1264,var_1983));
         var _loc2_:String = "";
         var _loc3_:SharedObject = SharedObject.getLocal(const_1421,"/");
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var_424.generateSharedKey(_loc4_,10);
         var _loc5_:String = var_424.getSharedKey(16).toUpperCase();
      ...
      private function onUniqueMachineId(param1:UniqueMachineIDEvent) : void
      {
         ...
         var _loc2_:SharedObject = SharedObject.getLocal(const_1421,"/");
      ...
      {
         var_706 = _habboConfiguration.getKey("sso.ticket",null);
         var_1264 = _habboConfiguration.getKey("flash.client.url","");
         var_1983 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_173 == null)
         {
         ...
         if(var_706 != null)
         {
            var_58.mode = HabboConnectionType.const_378;
            var_58.initConnection(HabboConnectionType.const_266);
         }
      }
      
      private function receiveLoggerInterface(param1:IID, param2:IUnknown) : void
      {
         var_1515 = param2 as ILogger;
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_608);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         switch(var_58.mode)
         {
            case HabboConnectionType.const_378:
               _loc6_ = "";
               ...
               var_1045 = _loc4_;
               var_173.loadBannerImage(_loc7_ + "?token=" + var_1045,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1029:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1378:
               var_597 = generateRandomHexString(30);
               var_424 = new DiffieHellman(new BigInteger(_habboConfiguration.getKey("connection.development.prime"),16),new BigInteger(_habboConfiguration.getKey("connection.development.generator"),16));
               var_424.init(var_597);
               _loc8_ = var_424.getPublicKey(10);
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,var_1045);
         ...
         var_424 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = generateRandomHexString(30);
            var_424.init(_loc14_);
            _loc15_ = var_424.getPublicKey(10);
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               var_58.mode = HabboConnectionType.const_1029;
            }
         }
         var_58.initConnection(HabboConnectionType.const_266);
      }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         dispatchLoginStepEvent(HabboCommunicationEvent.const_216);
      }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            Component(_habboConfiguration).events.addEventListener(HabboConfigurationEvent.const_172,onConfigurationLoaded);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         var_18.events.addEventListener(RoomSessionEvent.const_108,onRoomSessionEnded);
      }
