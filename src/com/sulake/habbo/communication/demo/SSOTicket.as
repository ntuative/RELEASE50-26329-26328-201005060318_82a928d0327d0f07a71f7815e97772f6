package com.sulake.habbo.communication.demo
{
   ...
   public class SSOTicket extends EventDispatcher
   {
      ...
      public static const const_254:String = "failure";
      
      public static const const_286:String = "success";
      ...
      public function SSOTicket(param1:IAssetLibrary, param2:IHabboWebLogin, param3:String)
      {
         ...
         _assets = param1;
         var_1157 = param2;
         var_1156 = "http://" + param3 + "/client";
         var_1157.init();
         var_1157.addEventListener(HabboWeb.const_221,requestClientURL);
      }
      ...
      {
         var _loc2_:String = var_1156;
         if(_assets.hasAsset(_loc2_))
         {
            Logger.log("[CoreLocalizationManager] reload localization for url: " + var_1156);
         }
         var _loc3_:URLRequest = new URLRequest(var_1156);
         if(_assets.hasAsset(_loc2_))
         {
      ...
      private function clientURLComplete(param1:Event = null) : void
      {
         ...
         else
         {
            try
            {
               var_1424 = /\"sso.ticket\" : \"(.*?)\"/.exec(data)[1];
               var_1727 = /\"flash.client.url\" : \"(.*?)\"/.exec(data)[1];
               if(false)
               {
               ...
               {
                  dispatchEvent(new Event(const_254));
               }
            }
            catch(e:Error)
            {
