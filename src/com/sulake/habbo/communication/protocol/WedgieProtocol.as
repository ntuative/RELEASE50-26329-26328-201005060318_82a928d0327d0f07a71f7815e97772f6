package com.sulake.habbo.communication.protocol
{
   ...
   public class WedgieProtocol implements IProtocol
   {
      ...
      public static const const_1369:uint = 1;
      
      public static const const_1316:uint = 2;
       
      
      private var var_927:IProtocolDecoder;
      
      private var var_1089:IProtocolEncoder;
      
      public function WedgieProtocol()
      {
         super();
         var_1089 = new WedgieEncoder();
         var_927 = new WedgieDecoder();
      }
      ...
      public function getMessages(param1:ByteArray, param2:Array) : uint
      {
         ...
         while(param1.bytesAvailable)
         {
            ...
            if(_loc5_ == const_1369)
            {
               _loc4_.position = 0;
               _loc6_ = var_927.getID(_loc4_);
