package com.sulake.habbo.communication
{
   ...
   public class HabboCommunicationManager extends Component implements IHabboCommunicationManager, IConnectionStateListener
   {
      ...
      private var var_1071:IMessageConfiguration;
      
      private const const_1643:int = 5;
      ...
      {
         var_1071 = new HabboMessages();
         var_260 = [];
         var_1166 = new Timer(100,1);
      ...
      {
         if(var_343 < 0 || var_343 >= var_260.length)
         {
            return 0;
         }
         return var_260[var_343];
      }
      ...
      private function onSecurityError(param1:SecurityErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("Communication Security Error","SecurityError on connect: " + param1.text + ". Port was " + var_260[var_343]);
         tryNextPort();
      }
      
      private function onConnect(param1:Event) : void
      {
         ErrorReportStorage.addDebugData("Connection","Connected with " + var_803 + " attempts");
      }
      ...
      {
         ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1187,String(new Date().getTime()));
         ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1261,param1 + " " + param2);
         if(false)
         {
            var_81 += ",R:" + param1;
         }
      ...
      private function nextPort() : void
      {
         ...
         ++var_343;
         if(var_343 >= var_260.length)
         {
            ++var_803;
            ErrorReportStorage.addDebugData("ConnectionRetry","Connection attempt " + var_803);
            if(var_803 > const_1643)
            {
               if(var_1757)
               {
                  return;
               ...
               var_1757 = true;
               Core.error("Connection failed to host " + var_34 + " ports " + var_260,true,Core.const_568);
               return;
            }
            var_343 = 0;
         }
         _connection.timeout = var_803 * 5000;
         _connection.init(var_34,var_260[var_343]);
      }
      ...
      {
         var_302.addConnectionMessageEvent(HabboConnectionType.const_266,param1);
      }
      
      public function connectionInit(param1:String, param2:int) : void
      {
         ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1293,param1);
         ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1256,String(param2));
      }
      ...
      private function onIOError(param1:IOErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("Communication IO Error","IOError " + param1.type + " on connect: " + param1.text + ". Port was " + var_260[var_343]);
         tryNextPort();
      }
      ...
      private function onCoreCommunicationManagerInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            var_302.registerProtocolType(HabboProtocolType.const_830,WedgieProtocol);
            _connection = var_302.createConnection(HabboConnectionType.const_266,ConnectionType.const_928);
            _loc3_ = var_302.getProtocolInstanceOfType(HabboProtocolType.const_830);
            _connection.registerMessageClasses(var_1071);
      ...
      {
         var_1166.addEventListener(TimerEvent.TIMER,onTryNextPort);
         var_1166.start();
      }
      ...
      {
         return !!var_302 ? var_302.queueConnection(HabboConnectionType.const_266,param1) : null;
      }
   }
}
