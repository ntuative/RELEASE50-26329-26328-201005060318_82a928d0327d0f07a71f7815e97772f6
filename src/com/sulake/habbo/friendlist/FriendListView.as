package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1427:String = "noconvinfo";
      
      private static const const_1428:String = "messageinput";
      ...
      private var var_1305:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         super();
         _friendList = param1;
         var_1305 = new FriendListTabsView(_friendList);
      }
      ...
      private function prepare() : void
      {
         ...
         var_886 = IWindowContainer(var_14.content.findChildByName("main_content"));
         var_278 = IWindowContainer(var_14.content.findChildByName("footer"));
         var_1305.prepare(var_886);
         var_14.procedure = onWindow;
         var_14.content.setParamFlag(HabboWindowParam.const_843,false);
         var_14.content.setParamFlag(HabboWindowParam.const_1380,true);
         var_14.header.setParamFlag(HabboWindowParam.const_668,false);
         var_14.header.setParamFlag(HabboWindowParam.const_1002,true);
         var_14.content.setParamFlag(HabboWindowParam.const_668,false);
         var_14.content.setParamFlag(HabboWindowParam.const_1002,true);
      ...
      private function refreshWindowSize() : void
      {
         ...
         var_278.y = Util.getLowestPoint(var_14.content);
         ...
         var_14.scaler.setParamFlag(HabboWindowParam.const_1021,this._friendList.tabs.findSelectedTab() != null);
         var_14.scaler.setParamFlag(HabboWindowParam.const_668,false);
         var_14.scaler.setParamFlag(HabboWindowParam.const_843,false);
         var_14.scaler.x = 0 - var_14.scaler.width;
         var_14.scaler.y = 0 - var_14.scaler.height;
         var_1552 = var_14.height;
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = var_1552 == -1 ? 0 : int(0 - var_1552);
