package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_1011:int = 0;
      
      public static const const_474:int = -1;
      
      public static const const_336:int = 100;
      ...
      {
         return Math.ceil(this.var_222.length / const_336);
      }
      ...
      {
         if(this.var_817 >= this.getPageCount())
         {
            this.var_817 = Math.max(0,this.getPageCount() - 1);
         }
      }
      ...
      {
         checkPageIndex();
         return Math.min((this.var_817 + 1) * const_336,this.var_222.length);
      }
