package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      public static const const_168:String = "face";
      ...
      private var var_1604:OpenedToWebPopup;
      
      private var var_936:IAvatarRenderManager;
      
      private var var_195:IHabboToolbar;
      
      private var var_394:FriendListTabs;
      ...
      private var var_1605:AvatarSearchResults;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_633:ISessionDataManager;
      
      private var var_373:FriendRequests;
      
      private var var_2202:int;
      
      var var_89:FriendCategories;
      
      private var var_2227:FriendListLookAndFeel;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_935:IHabboNotifications;
      
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         var_2227 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_89 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1605 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_373.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_373.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_394.findTab(FriendListTab.const_93).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      {
         var_633 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_373 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            var_89.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_89.addCategory(new FriendCategory(FriendCategory.const_1011,getText("friendlist.friends")));
         var_89.addCategory(new FriendCategory(FriendCategory.const_474,getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in getSortedFriends(_loc2_.friends))
         {
            var_89.addFriend(new Friend(_loc4_));
         }
         var_394 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!var_542)
         {
            var_542 = new Timer(120000);
            var_542.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_542.start();
         }
         getBuddyRequests();
         registerListeners();
         var_195.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_117,HabboToolbarIconEnum.FRIENDLIST));
      ...
      override public function dispose() : void
      {
         ...
         {
            var_542.stop();
            var_542.removeEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_542 = null;
         }
         if(_windowManager)
         {
         ...
         if(var_936)
         {
            var_936.release(new IIDAvatarRenderManager());
            var_936 = null;
         }
         if(var_935)
         {
            var_935.release(new IIDHabboNotifications());
            var_935 = null;
         }
         if(var_195)
         {
         ...
         if(var_633)
         {
            var_633.release(new IIDSessionDataManager());
            var_633 = null;
         }
         super.dispose();
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = _windowManager.createWindow(param1,"",HabboWindowType.BITMAP_WRAPPER,HabboWindowStyle.const_43,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var_89.onFriendListUpdate(param1);
      ...
      public function openFriendList() : void
      {
         ...
         var _loc1_:FriendListTab = tabs.findTab(FriendListTab.const_90);
      ...
      {
         var _loc1_:String = var_153.getKey("client.minimail.embed.enabled");
         return _loc1_ == "true";
      }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            _view.openFriendList();
            _loc1_ = var_394.findSelectedTab();
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_322));
            }
            else
            {
               switch(_loc1_.id)
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1605.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc1_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_166,HabboToolbarIconEnum.FRIENDLIST);
         _loc1_.iconState = String(var_373.getCountOfOpenRequests() > 0 ? "2" : "0");
         var_195.events.dispatchEvent(_loc1_);
      }
      ...
      public function getFriend(param1:int) : IFriend
      {
         ...
         return var_89.findFriend(param1);
      }
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         var _loc2_:int = 0;
         if(var_633.hasUserRight("fuse_super_extended_buddylist"))
         {
            _loc2_ = 0;
         }
         else if(var_633.hasUserRight("fuse_extended_buddylist"))
         {
            _loc2_ = 0;
         }
         if(_loc2_ > var_373.limit)
         {
            var_373.limit = _loc2_;
         }
      }
      
      public function declineFriendRequest(param1:int) : void
      {
         var _loc2_:FriendListTab = var_394.findTab(FriendListTab.const_93);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc2_:IAvatarImage = var_936.createAvatarImage(param1,AvatarScaleType.SMALL);
         if(!_loc2_)
         {
            return null;
         }
         var _loc3_:BitmapData = _loc2_.getCroppedImage(AvatarSetType.const_49);
         _loc2_.dispose();
         return _loc3_;
      }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_373.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_394.findTab(FriendListTab.const_93);
      ...
      public function getFriendCount(param1:Boolean, param2:Boolean) : int
      {
         ...
         return this.var_89.getFriendCount(param1,param2);
      }
      ...
      {
         return var_153.getKey(param1,param1,param2);
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1604 == null)
         {
            var_1604 = new OpenedToWebPopup(this);
         }
         var_1604.show(x,y);
      }
