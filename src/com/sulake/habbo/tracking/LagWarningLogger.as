package com.sulake.habbo.tracking
{
   ...
   public class LagWarningLogger
   {
      ...
      {
         var _loc2_:* = null;
         if(!var_1268 || var_1423 <= 0)
         {
            return;
         }
         var _loc1_:int = getTimer();
         if(var_1422 == 0 || _loc1_ - var_1422 > var_1423)
         {
            if(_connection != null)
            {
      ...
      {
         var_1268 = Boolean(int(param1.getKey("lagWarningLog.enabled","0")));
         var_1423 = int(param1.getKey("lagWarningLog.interval.minutes","10")) * 1000 * 60;
      }
