package com.sulake.habbo.tracking
{
   ...
   public class LatencyTracker
   {
      ...
      {
         var_1576 = getTimer();
         var_529.add(var_1337,var_1576);
         _connection.send(new LatencyPingRequestMessageComposer(var_1337));
         ++var_1337;
      }
      ...
      {
         if(var_153 == null || _communication == null || _connection == null)
         {
            return;
         }
         var_1575 = int(var_153.getKey("latencytest.interval"));
         var_1577 = int(var_153.getKey("latencytest.report.index"));
         var_2174 = int(var_153.getKey("latencytest.report.delta"));
      ...
      private function onPingResponse(param1:IMessageEvent) : void
      {
         ...
         var _loc10_:int = 0;
         var _loc11_:* = null;
         if(var_529 == null || var_158 == null)
         {
            return;
         }
         var _loc2_:LatencyPingResponseMessageParser = (param1 as LatencyPingResponseMessageEvent).getParser();
         var _loc3_:int = var_529.getValue(_loc2_.requestId);
         var_529.remove(_loc2_.requestId);
         ...
         if(var_158.length == var_1577 && var_1577 > 0)
         {
            ...
            if(Math.abs(_loc9_ - var_1578) > var_2174 || var_1578 == 0)
            {
               var_1578 = _loc9_;
