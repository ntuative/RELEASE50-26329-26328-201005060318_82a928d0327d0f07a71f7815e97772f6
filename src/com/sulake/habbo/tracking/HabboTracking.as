package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_774:uint = 11;
       
      
      private var var_231:LatencyTracker = null;
      
      private var var_230:PerformanceTracker = null;
      
      private var var_253:IAdManager;
      
      private var _roomEngine:IRoomEngine = null;
      
      private var var_152:IHabboHelp;
      
      private var _coreComponent:CoreComponent;
      
      private var var_1037:int = -1;
      
      private var var_851:LagWarningLogger = null;
      
      private var var_850:IHabboWindowManager;
      ...
      private var var_172:IHabboFriendList;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_230 = new PerformanceTracker();
         var_231 = new LatencyTracker();
         var_851 = new LagWarningLogger();
         var_1248 = new Array(const_774);
         var _loc4_:int = 0;
         while(_loc4_ < const_774)
         {
            var_1248[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1162,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1220,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1370,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_599,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_910,String(0));
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               trackLoginStep(HabboLoginTrackingStep.const_1393);
               break;
            case HabboCommunicationEvent.const_608:
               trackLoginStep(HabboLoginTrackingStep.const_1252,String(_communication.port));
               break;
            ...
            case HabboCommunicationEvent.const_216:
               ...
               trackLoginStep(HabboLoginTrackingStep.const_216);
               if(var_231 != null)
               {
                  var_231.init();
               }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(var_231 != null)
            {
               var_231.communication = _communication;
               var_231.connection = param1;
            }
            if(var_851 != null)
            {
               var_851.connection = param1;
            }
         }
      }
      ...
      {
         var_153 = IHabboConfigurationManager(param2);
         if(var_153)
         {
            Component(var_153).events.addEventListener(HabboConfigurationEvent.const_172,onConfigurationLoaded);
            if(var_231 != null)
            {
               var_231.configuration = var_153;
            }
            if(var_230 != null)
            {
               var_230.configuration = var_153;
            }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_253.events.addEventListener(AdEvent.const_400,onRoomAdLoad);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!var_1957)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1245);
            var_1957 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_910,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_599,String(true));
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_608,onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_216,onConnectionEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_645,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_64,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_397,onHotelViewEvent);
      }
      ...
      private function onLagWarningEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case AvatarWalkWarpingWarningEvent.const_411:
               var_851.warpingDetected();
         }
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(var_850)
            {
               var_850.release(new IIDHabboWindowManager());
               var_850 = null;
            }
            if(var_253)
            {
            ...
            if(var_172)
            {
               if(true)
               {
                  Component(var_172).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,onFriendlistTrackingEvent);
                  Component(var_172).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,onFriendlistTrackingEvent);
                  Component(var_172).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,onFriendlistTrackingEvent);
                  Component(var_172).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,onFriendlistTrackingEvent);
                  Component(var_172).events.removeEventListener(HabboFriendListTrackingEvent.const_322,onFriendlistTrackingEvent);
               }
               var_172.release(new IIDHabboFriendList());
               var_172 = null;
            }
            if(var_152)
            {
               if(true)
               {
                  var_152.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
                  var_152.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
               }
               var_152.release(new IIDHabboHelp());
               var_152 = null;
            }
            if(_roomEngine)
            {
               if(true)
               {
                  Component(_roomEngine).events.removeEventListener(AvatarWalkWarpingWarningEvent.const_411,onLagWarningEvent);
               }
      ...
      private function onConfigurationLoaded(param1:Event) : void
      {
         ...
         if(var_153)
         {
            if(var_851 != null)
            {
               var_851.configure(var_153);
            }
            Component(var_153).events.removeEventListener(HabboConfigurationEvent.const_172,onConfigurationLoaded);
         }
      }
      ...
      private function onLocalizationLoaded(param1:Event) : void
      {
         ...
         trackLoginStep(HabboLoginTrackingStep.const_96);
         if(_localization)
         {
            Component(_localization).events.removeEventListener(LocalizationEvent.const_96,onLocalizationLoaded);
         }
      }
      
      private function onHelpReady(param1:IID, param2:IUnknown) : void
      {
         var_152 = param2 as IHabboHelp;
         var_152.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
         var_152.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
      }
      ...
      {
         trackLoginStep(HabboLoginTrackingStep.const_997);
         if(_coreComponent != null)
         {
            _coreComponent.events.removeEventListener(HabboLoginTrackingStep.const_997,onCoreRunning);
         }
      }
      ...
      {
         var_850 = IHabboWindowManager(param2);
         if(var_850)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            ++var_1499;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + var_1499);
         }
         if(var_1037 > -1 && _loc2_ - var_1037 > 15000)
         {
            ++var_1500;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + var_1500);
         }
         var_1037 = _loc2_;
         if(var_230 != null)
         {
      ...
      {
         if(var_153 != null && Boolean(var_153.getKey("processlog.enabled") == false))
         {
            return;
         }
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(_roomEngine).events.addEventListener(AvatarWalkWarpingWarningEvent.const_411,onLagWarningEvent);
      ...
      {
         var_172 = param2 as IHabboFriendList;
         Component(var_172).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,onFriendlistTrackingEvent);
         Component(var_172).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,onFriendlistTrackingEvent);
         Component(var_172).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,onFriendlistTrackingEvent);
         Component(var_172).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,onFriendlistTrackingEvent);
         Component(var_172).events.addEventListener(HabboFriendListTrackingEvent.const_322,onFriendlistTrackingEvent);
      }
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         if(param1.critical && !_crashed)
         {
            ...
            if(var_153)
            {
               if(var_153.keyExists("client.fatal.error.url"))
               {
                  _loc2_ = var_153.getKey("client.fatal.error.url");
                  ...
                  if(var_230 != null)
                  {
                     _loc4_["null"] = var_230.flashVersion;
                     _loc4_["null"] = var_230.averageUpdateInterval;
                  }
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(_localization)
         {
            Component(_localization).events.addEventListener(LocalizationEvent.const_96,onLocalizationLoaded);
         }
      }
      
      private function onHotelViewEvent(param1:Event) : void
      {
         if(param1.type == HabboHotelViewEvent.const_645)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1302);
         }
         else if(param1.type == HabboHotelViewEvent.const_397)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1223);
         }
         else if(param1.type == HabboHotelViewEvent.const_64)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1235);
         }
      }
   }
}
