package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private function onWindowManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_302.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(onAuthenticationOK));
      }
      
      private function onSetToolbarIconEvent(param1:HabboToolbarSetIconEvent) : void
      {
         var _loc2_:* = null;
         if(_view != null && var_33)
         {
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_117,onSetToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_876,onSetToolbarIconBitmapEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_156,onRemoveToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_166,onSetToolbarIconStateEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_51,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_408,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_590,onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_1028,onHideWindowEvent);
         var_33 = true;
         events.dispatchEvent(new HabboToolbarEvent(HabboToolbarEvent.const_91));
      }
      ...
      private function onAnimateWindowEvent(param1:HabboToolbarShowMenuEvent) : void
      {
         if(var_33 && _view != null)
         {
            if(param1.type == HabboToolbarShowMenuEvent.const_51)
            {
