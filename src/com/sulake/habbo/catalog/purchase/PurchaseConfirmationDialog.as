package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1439:uint = 4.294967295E9;
      
      private const const_1440:uint = 4.293848814E9;
      
      private var var_788:int;
      
      private const const_1636:uint = 4.291613146E9;
      ...
      private const const_1637:int = 10;
      ...
      private var var_78:IPurchasableOffer;
      ...
      private function checkboxHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_537:
               showSelectors(false);
               break;
            case WindowEvent.const_679:
               showSelectors(true);
         }
      }
      ...
      private function suggestionsEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               _loc5_ = var_218.findChildByName("suggestion_list") as IItemListWindow;
               if(_loc5_ == null)
               {
                  return;
               }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == var_787;
               }
            }
            _loc4_++;
         }
      ...
      private function updatePreview() : void
      {
         ...
         _loc3_ = _loc2_.getFurnitureImage(var_787,new Vector3d(180),64,this,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         return param1 % 2 == 0 ? uint(const_1440) : uint(const_1439);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               _catalog.purchaseProduct(var_451,var_78,var_973);
               dispose();
               break;
            case "cancel_button":
      ...
      {
         if(var_218 == null || true)
         {
            return;
         }
         var _loc1_:IItemListWindow = var_218.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(var_250) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(var_787);
         var _loc8_:int = !!_loc6_ ? 0 : int(var_561[_boxIndex]);
         var _loc9_:int = !!_loc6_ ? 0 : int(var_560[var_188]);
         _catalog.purchaseProductAsGift(var_451,var_78,var_973,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_135:
               _loc3_ = param1.window as ITextFieldWindow;
               if(_loc3_ == null)
               {
                  return;
               }
               if(var_1672 == _loc3_.text)
               {
                  return;
               }
               ...
               for each(_loc7_ in var_222)
               {
                  ...
                  if(_loc5_.length >= const_1637)
                  {
                     break;
                  }
               }
               updateSuggestions(_loc5_);
               var_1672 = _loc3_.text;
               break;
            case WindowMouseEvent.const_53:
               showSuggestions(false);
               if(var_1140)
               ...
               break;
            case WindowKeyboardEvent.const_531:
               _loc6_ = param1 as WindowKeyboardEvent;
               switch(_loc6_.keyCode)
               {
                  case Keyboard.UP:
                     highlightSuggestion(var_250 - 1);
                     break;
                  case Keyboard.DOWN:
                     highlightSuggestion(var_250 + 1);
                     break;
         ...
         if(_loc2_ != null)
         {
            ...
            switch(_loc9_)
            {
               ...
               case ProductTypeEnum.const_84:
                  ...
                  break;
               case ProductTypeEnum.const_228:
                  _loc6_ = _catalog.getPixelEffectIcon(_loc7_);
                  break;
               case ProductTypeEnum.const_320:
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            var_1413 = _loc1_.stuffTypes;
            var_561 = _loc1_.boxTypes;
            var_560 = _loc1_.ribbonTypes;
            var_787 = var_1413[0];
            _boxIndex = var_561[0];
            var_188 = var_560[0];
            initColorGrid();
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         var _loc2_:IItemListWindow = var_218.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
         _loc3_ = _loc2_.getListItemAt(var_250) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = getColor(var_250);
         }
         var_250 = param1;
         if(var_250 < 0)
         {
            var_250 = _loc2_.numListItems - 1;
         }
         if(var_250 >= _loc2_.numListItems)
         {
            var_250 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(var_250) as IWindowContainer;
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(var_218 == null)
         {
            var_218 = _window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(var_465 == null)
         {
            var_465 = createWindow("suggestion_list_item") as IWindowContainer;
            var_465.procedure = suggestionsEventHandler;
         }
         if(var_218 == null || var_465 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = var_218.findChildByName("suggestion_list") as IItemListWindow;
         ...
         {
            _loc5_ = var_465.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
