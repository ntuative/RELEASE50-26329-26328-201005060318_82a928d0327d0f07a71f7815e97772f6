package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketplaceChart
   {
      ...
      {
         return var_1069 + var_1069 / -var_2375 * 0;
      }
      
      private function getY(param1:int) : Number
      {
         return var_893 - var_893 / var_439 * 0;
      }
      ...
      public function draw(param1:int, param2:int) : BitmapData
      {
         ...
         _loc5_ = Math.pow(10,int(var_439).toString().length - 1);
         var_439 = Math.ceil(var_439 / _loc5_) * _loc5_;
         ...
         _loc6_.text = var_439.toString();
         _loc3_.draw(_loc6_);
         var_1069 = param1 - _loc6_.textWidth - 2;
         var_893 = param2 - _loc6_.textHeight;
         ...
         _loc9_.graphics.lineTo(0,var_893);
         _loc10_ = 0;
         while(_loc10_ <= 5)
         {
            _loc4_ = (var_893 - 1) / 5 * _loc10_;
            _loc9_.graphics.moveTo(0,_loc4_);
            _loc9_.graphics.lineTo(var_1069 - 1,_loc4_);
            _loc10_++;
         }
         _loc9_.graphics.lineStyle(2,255);
         _loc9_.graphics.moveTo(getX(0),getY(0));
         _loc10_ = 1;
         while(_loc10_ < var_83.length)
         {
            _loc9_.graphics.lineTo(getX(_loc10_),getY(_loc10_));
            _loc10_++;
         }
         _loc3_.draw(_loc9_,new Matrix(1,0,0,1,param1 - var_1069,(param2 - var_893) / 2));
         return _loc3_;
      }
      
      public function get available() : Boolean
      {
         return var_83 && _y && false;
      }
   }
}
