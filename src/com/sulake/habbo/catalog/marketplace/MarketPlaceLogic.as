package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      public const const_1670:int = 3;
      
      public const const_1527:int = 2;
      ...
      private var var_1789:MarketplaceItemStats;
      ...
      private var var_192:MarketplaceConfirmationDialog;
      ...
      public function buyOffer(param1:int) : void
      {
         ...
         showConfirmation(const_1615,_loc2_);
      }
      ...
      {
         if(param1.furniCategoryId != var_1787 || param1.furniTypeId != var_1784)
         {
            return;
         }
         var_1789 = param1;
      ...
      public function onCancelResult(param1:IMessageEvent) : void
      {
         ...
         if(parser.result == 1)
         {
            item = var_191.remove(parser.offerId);
            if(item != null)
            {
               item.dispose();
            }
      ...
      public function onBuyResult(param1:IMessageEvent) : void
      {
         ...
         else if(parser.result == 3)
         {
            ...
            showConfirmation(const_1527,updateItem);
            _visualization.listUpdatedNotify();
         }
      ...
      public function redeemSoldOffers() : void
      {
         var _loc2_:int = 0;
         var _loc3_:* = null;
         var _loc1_:Array = var_191.getKeys();
         for each(_loc2_ in _loc1_)
         {
            _loc3_ = var_191.getValue(_loc2_);
            if(_loc3_.status == MarketPlaceOfferState.const_390)
            {
               var_191.remove(_loc2_);
               _loc3_.dispose();
            }
         }
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         var_1786 = _loc3_.creditsWaiting;
         var_191 = new Map();
         for each(_loc4_ in _loc3_.offers)
         {
            ...
            var_191.add(_loc4_.offerId,_loc6_);
         }
      ...
      private function showConfirmation(param1:int, param2:MarketPlaceOfferData) : void
      {
         if(!var_192)
         {
            var_192 = new MarketplaceConfirmationDialog(this,_catalog,_roomEngine);
         }
         var_192.showConfirmation(param1,param2);
      }
      ...
      {
         requestOffers(var_1785,var_1791,var_1790,var_1788);
      }
