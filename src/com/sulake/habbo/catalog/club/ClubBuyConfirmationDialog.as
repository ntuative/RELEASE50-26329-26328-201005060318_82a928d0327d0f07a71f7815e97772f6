package com.sulake.habbo.catalog.club
{
   ...
   public class ClubBuyConfirmationDialog
   {
      ...
      private var var_28:ClubBuyController;
      ...
      {
         if(!param1 || !param2 || !var_28 || !var_78)
         {
            return;
         }
         ...
         {
            case "select_button":
               var_28.confirmSelection(var_78,var_451);
               break;
            case "header_button_close":
            case "cancel_button":
               var_28.closeConfirmation();
         }
      }
      ...
      public function showConfirmation() : void
      {
         ...
         var _loc2_:ICoreLocalizationManager = var_28.localization;
         var _loc4_:* = "";
         var _loc5_:int = var_28.getClubType();
         ...
         var _loc7_:IPurse = var_28.getPurse();
