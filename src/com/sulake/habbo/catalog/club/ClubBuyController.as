package com.sulake.habbo.catalog.club
{
   ...
   public class ClubBuyController
   {
      ...
      private var var_192:ClubBuyConfirmationDialog;
      ...
      {
         closeConfirmation();
         var_192 = new ClubBuyConfirmationDialog(this,param1,param2);
      }
      ...
      public function getClubType() : int
      {
         ...
         {
            _loc1_ = !!_catalog.getPurse().isVIP ? 0 : int(HabboClubLevelEnum.const_59);
         }
         return _loc1_;
      }
      ...
      public function onOffers(param1:HabboClubOffersMessageEvent) : void
      {
         ...
         var_572.sort(orderByPrecedence);
         for each(_loc6_ in var_572)
         {
