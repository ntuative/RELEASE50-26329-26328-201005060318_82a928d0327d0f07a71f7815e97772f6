package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc3_:Array = var_618[var_1076] as Array;
      ...
      {
         var _loc2_:Offer = var_618[var_1076][var_2146];
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_367 || _loc1_.pricingModel == Offer.const_431)
            {
               _loc3_ = _loc1_.productContainer.firstProduct;
               if(_loc3_ != null)
               {
                  _loc4_ = _loc3_.productClassId;
                  if(_loc3_.productType == ProductTypeEnum.const_84 || _loc3_.productType == ProductTypeEnum.const_81)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        _loc5_ = _loc3_.furnitureData.name;
                        if(var_1075.indexOf(_loc5_) == -1)
                        {
                           var_1075.push(_loc5_);
                           var_618.push(new Array());
                        }
                        _loc6_ = var_1075.indexOf(_loc5_);
                        (var_618[_loc6_] as Array).push(_loc1_);
                     }
                  }
               }
            }
      ...
      override protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         for each(_loc2_ in var_618)
         {
            if(var_2146 < _loc2_.length)
            {
               _loc3_ = _loc2_[var_2146] as Offer;
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         var_1076 = var_951.getGridItemIndex(param1.view);
