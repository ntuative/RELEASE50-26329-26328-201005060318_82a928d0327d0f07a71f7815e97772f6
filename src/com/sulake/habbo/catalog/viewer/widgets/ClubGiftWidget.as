package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ClubGiftWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private const const_154:int = 31;
      ...
      private function updateList() : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         if(!var_28 || !window || !page)
         {
            return;
         }
         for each(_loc1_ in var_572)
         {
            _loc1_.dispose();
         }
         var_572.reset();
         _loc2_ = var_28.getOffers();
         if(!_loc2_)
         {
            return;
         }
         var _loc3_:Map = var_28.getGiftData();
         if(!_loc3_)
         {
            return;
         }
         ...
         for each(_loc6_ in _loc2_)
         {
            ...
            if(_loc5_)
            {
               ...
               var_572.add(_loc1_.offerId,_loc1_);
            }
         }
      }
      ...
      private function showPreview(param1:Offer, param2:Rectangle) : void
      {
         ...
         if(!var_204)
         {
            var_204 = createWindow("club_gift_preview") as IWindowContainer;
         }
         if(!var_204)
         {
            return;
         }
         var _loc5_:IBitmapWrapperWindow = var_204.findChildByName("image") as IBitmapWrapperWindow;
         if(!_loc5_)
         {
            return;
         }
         ...
         var_204.setGlobalPosition(_loc6_.subtract(new Point(0,0)));
         var_204.visible = true;
         var_204.activate();
      }
      ...
      private function createWindow(param1:String) : IWindow
      {
         ...
         return var_28.windowManager.buildFromXML(_loc3_);
      }
      ...
      private function updateInfo() : void
      {
         ...
         if(false)
         {
            ...
            var_28.localization.registerParameter(_loc2_,"amount",var_28.giftsAvailable.toString());
         }
         else if(false)
         {
            _loc2_ = "catalog.club_gift.days_until_next";
            var_28.localization.registerParameter(_loc2_,"days",var_28.daysUntilNextGift.toString());
         }
         else if(false)
         {
         ...
         _loc1_.text = var_28.localization.getKey(_loc2_);
         if(true)
         {
            return;
         }
         ...
         if(_loc5_)
         {
            _loc2_ = var_28.purse.pastClubDays > const_154 ? "catalog.club_gift.past_club.long" : "catalog.club_gift.past_club";
            _loc3_ = var_28.purse.pastClubDays % const_154;
            _loc4_ = var_28.purse.pastClubDays / const_154;
            var_28.localization.registerParameter(_loc2_,"days",_loc3_.toString());
            var_28.localization.registerParameter(_loc2_,"months",_loc4_.toString());
            _loc5_.text = var_28.localization.getKey(_loc2_);
         }
         var _loc6_:ITextWindow = window.findChildByName("past_vip_days") as ITextWindow;
         if(_loc6_)
         {
            _loc2_ = var_28.purse.pastVipDays > const_154 ? "catalog.club_gift.past_vip.long" : "catalog.club_gift.past_vip";
            _loc3_ = var_28.purse.pastVipDays % const_154;
            _loc4_ = var_28.purse.pastVipDays / const_154;
            var_28.localization.registerParameter(_loc2_,"days",_loc3_.toString());
            var_28.localization.registerParameter(_loc2_,"months",_loc4_.toString());
            _loc6_.text = var_28.localization.getKey(_loc2_);
         }
      }
      ...
      {
         if(!param1 || !param2 || !var_572 || !var_28)
         {
            return;
         }
         ...
         var _loc3_:Offer = var_572.getValue(param2.id) as Offer;
         if(!_loc3_)
         {
            return;
         }
         var_28.selectGift(_loc3_);
      }
      ...
      private function createListItem(param1:Offer, param2:ClubGiftData) : IWindow
      {
         ...
         {
            _loc11_ = param2.monthsRequired * const_154;
            if(param2.isVip)
            {
               _loc12_ = _loc11_ - var_28.purse.pastVipDays;
               _loc6_ = "catalog.club_gift.vip_missing";
            }
            else
            {
               _loc12_ = _loc11_ - var_28.purse.pastClubDays;
               _loc6_ = "catalog.club_gift.club_missing";
            }
            if(_loc12_ >= const_154)
            {
               _loc6_ += ".long";
            }
            if(_loc12_ <= 0)
            ...
            {
               _loc13_ = _loc12_ % const_154;
               _loc14_ = _loc12_ / const_154;
               var_28.localization.registerParameter(_loc6_,"days",_loc13_.toString());
               var_28.localization.registerParameter(_loc6_,"months",_loc14_.toString());
            }
         }
         setText(_loc3_.findChildByName("months_required"),var_28.localization.getKey(_loc6_));
