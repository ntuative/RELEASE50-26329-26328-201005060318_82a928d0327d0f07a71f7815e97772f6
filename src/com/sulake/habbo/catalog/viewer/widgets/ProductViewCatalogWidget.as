package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1332:IScrollbarWindow;
      
      protected var var_1288:XML;
      
      private var var_1331:BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(var_619 != null)
         {
            var_619.visible = false;
            var_619.destroyGridItems();
         }
         if(var_1332 != null)
         {
         ...
         if(_loc3_ != null)
         {
            var_1290.text = "${" + _loc3_.name + "}";
            var_1289.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1290.text = "${" + _loc2_.localizationId + "}";
            var_1289.text = "${" + _loc2_.localizationId + "}";
         }
         if(ProductImageConfiguration.hasProductImage(_loc2_.localizationId))
         {
            setPreviewFromAsset(ProductImageConfiguration.const_39[_loc2_.localizationId]);
         }
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_414:
                  _loc4_ = var_1331.clone();
                  if(var_619 != null)
                  {
                     var_619.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_619,var_1332,var_1288);
                  }
                  break;
               ...
               case Offer.const_431:
                  ...
                  switch(_loc6_.productType)
                  {
                     ...
                     case ProductTypeEnum.const_228:
                        ...
                        _loc4_ = new BitmapData(var_87.width,var_87.height,false,_loc10_);
                        _loc11_ = null;
                        _loc12_ = page.viewer.catalog as HabboCatalog;
                        if(_loc12_.avatarRenderManager != null)
                        {
                           _loc14_ = _loc12_.sessionDataManager.figure;
                           _loc13_ = _loc12_.avatarRenderManager.createAvatarImage(_loc14_,AvatarScaleType.const_56);
                           if(_loc13_ != null)
                           {
                              _loc13_.setDirection(AvatarSetType.const_49,3);
                              _loc13_.initActionAppends();
                              _loc13_.appendAction(AvatarAction.const_313,AvatarAction.const_638);
                              _loc13_.appendAction(AvatarAction.const_594,_loc6_.productClassId);
                              _loc13_.endActionAppends();
                              _loc13_.updateAnimationByFrames(1);
                              _loc13_.updateAnimationByFrames(1);
                              _loc11_ = _loc13_.getImage(AvatarSetType.const_40,true);
      ...
      {
         var_1290 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1289 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_87 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1571 = new Point(var_87.x,var_87.y);
         var_619 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1332 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_619 == null)
         {
            Logger.log("[ProductViewCatalogWidget] Bundle Grid not initialized!");
         }
         var _loc1_:XmlAsset = page.viewer.catalog.assets.getAssetByName("gridItem") as XmlAsset;
         var_1288 = _loc1_.content as XML;
         var _loc2_:BitmapDataAsset = page.viewer.catalog.assets.getAssetByName("ctlg_dyndeal_background") as BitmapDataAsset;
         var_1331 = _loc2_.content as BitmapData;
      ...
      private function addEffectSprites(param1:BitmapData, param2:IAvatarImage, param3:Point, param4:Point, param5:Boolean = true) : void
      {
         ...
         {
            _loc7_ = _window.getChildIndex(var_87);
      ...
      private function retrievePreviewAsset(param1:String) : void
      {
         ...
         _loc5_.addEventListener(AssetLoaderEvent.const_37,onPreviewImageReady);
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(var_87 != null && true)
         {
            ...
            if(true)
            {
               var_87.bitmap = new BitmapData(var_87.width,var_87.height,true,16777215);
            }
            var_87.bitmap.fillRect(var_87.bitmap.rect,16777215);
            _loc4_ = new Point((0 - param1.width) / 2,(0 - param1.height) / 2);
            var_87.bitmap.copyPixels(param1,param1.rect,_loc4_,null,null,true);
            var_87.invalidate();
            var_87.x = var_1571.x;
            var_87.y = var_1571.y;
            if(param3 != null)
