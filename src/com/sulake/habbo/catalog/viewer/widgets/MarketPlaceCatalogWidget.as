package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private var var_800:MarketPlaceOfferData;
      
      private const const_1416:int = 1;
      
      private const const_1641:int = 40;
      
      private var var_472:IWindowContainer;
      
      private const const_1415:int = 2;
      ...
      private const const_1642:int = 10;
      ...
      private function updateList() : void
      {
         ...
         if(!var_472)
         {
            ...
            var_472 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!var_472)
         {
            return;
         ...
         updateStatusDisplay(const_1415,_loc2_.length);
         if(!var_392)
         {
            var_392 = new Timer(25);
            var_392.addEventListener(TimerEvent.TIMER,onPopulationTimer);
         }
         var_799 = 0;
         populateList();
         var_392.start();
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         if(!marketPlace || !param2 || !_itemList || !var_572)
         {
            return;
         }
         var _loc3_:* = [];
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !_itemList || !var_472 || true)
         {
            return;
         }
         var _loc2_:IWindowContainer = var_472.clone() as IWindowContainer;
      ...
      {
         var _loc5_:* = null;
         updateStatusDisplay(const_1416);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
         ...
         if(_loc6_ && _loc6_.selection >= 0 && _loc6_.selection < var_393.length)
         {
            _loc4_ = 0;
         }
      ...
      override public function dispose() : void
      {
         ...
         if(var_392)
         {
            var_392.removeEventListener(TimerEvent.TIMER,onPopulationTimer);
            var_392 = null;
         }
      }
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(var_799 >= var_572.length)
            {
               return true;
            }
            addListItem(var_572.getWithIndex(var_799));
            ++var_799;
            _loc1_++;
         }
         return false;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  marketPlace.buyOffer(var_800.offerId);
            }
            return;
         }
      ...
      private function onWidgetEvent(param1:WindowEvent, param2:IWindow = null) : void
      {
         ...
         else if(param1.type == WindowEvent.const_135)
         {
      ...
      private function selectSearchCategory(param1:String) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.populate(getSortKeys(var_393));
            _loc7_.selection = 0;
         }
      }
