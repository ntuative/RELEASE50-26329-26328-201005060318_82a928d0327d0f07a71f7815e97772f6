package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1384:String = "default";
      
      private var var_1164:Array;
      
      private var var_258:BitmapData = null;
      
      private var var_219:int = 0;
      
      private var var_668:int = 0;
      
      private var var_1382:String = "1.1";
      ...
      private var var_257:BitmapData = null;
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(var_258 != null && var_257 != null)
         {
            setRoomImage(var_258,var_257);
         }
      }
      ...
      private function updateConfiguration() : void
      {
         ...
         for each(_loc1_ in var_153.floors.pattern)
         {
            if(_loc1_.@id == _loc5_)
            {
               _loc11_ = _loc1_.children()[var_256];
               if(_loc11_ != null)
               {
         ...
         for each(_loc1_ in var_153.landscapes.pattern)
         {
            if(_loc1_.@id == _loc7_)
            {
               _loc13_ = _loc1_.children()[var_259];
               if(_loc13_ != null)
               {
                  var_1382 = _loc13_.@id;
               }
         ...
         switch(param1)
         {
            case const_188:
               ...
               for each(_loc8_ in var_153.walls.pattern)
               {
                  if(_loc8_.@id == _loc5_)
                  {
                     var_669 = _loc8_.children().length();
                  }
               }
            ...
            case const_189:
               ...
               for each(_loc9_ in var_153.floors.pattern)
               {
                  if(_loc9_.@id == _loc6_)
                  {
                     var_667 = _loc9_.children().length();
                  }
               }
            ...
            case const_190:
               ...
               for each(_loc10_ in var_153.landscapes.pattern)
               {
                  if(_loc10_.@id == _loc7_)
                  {
                     var_668 = _loc10_.children().length();
                  }
               }
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_buy_wall":
               ...
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page,var_1384);
               }
               break;
            ...
            case "ctlg_buy_landscape":
               _loc3_ = var_1163[var_299];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page,var_1382);
               }
               break;
            default:
      ...
      private function retrieveSpacesPreview() : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:ImageResult = page.viewer.roomEngine.getRoomImage(_floorType,var_1384,var_1382,64,this,"window_romantic_wide");
