package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TextInputCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_961:ITextFieldWindow;
      ...
      {
         super.init();
         var_961 = _window.findChildByName("input_text") as ITextFieldWindow;
         if(var_961 != null)
         {
            var_961.addEventListener(WindowKeyboardEvent.const_531,onKey);
         }
      }
      ...
      private function onKey(param1:WindowKeyboardEvent) : void
      {
         ...
         events.dispatchEvent(new TextInputEvent(var_961.text));
      }
   }
}
