package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class LocalizationCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function onClickLink(param1:WindowMouseEvent) : void
      {
         ...
         switch(page.layoutCode)
         {
            ...
            case "info_pixels":
               ...
               {
                  case "ctlg_text_5":
                     page.viewer.catalog.openInventoryCategory(InventoryCategory.const_311);
                     break;
                  case "ctlg_text_7":
            ...
            case "club1":
               ...
               {
                  case "ctlg_text_5":
                     page.viewer.catalog.openCatalogPage(CatalogPageName.const_233,true);
               }
               break;
            case "club_buy":
               switch(_loc4_)
      ...
      private function retrieveCatalogImage(param1:String) : void
      {
         ...
         _loc8_.addEventListener(AssetLoaderEvent.const_37,onCatalogImageReady);
      }
      ...
      private function initLinks() : void
      {
         ...
         if(false)
         {
            for each(_loc1_ in page.links)
            {
               ...
               if(_loc2_ != null)
               {
                  _loc2_.setParamFlag(WindowParam.const_50);
