package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerPrizesCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private var var_1288:XML;
      
      private var _itemList:IItemListWindow;
      
      private var var_883:PrizeViewer;
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < var_718.length)
         {
            createLevelItem(var_718[_loc2_]);
            _loc2_++;
         }
      }
      ...
      override public function init() : void
      {
         var _loc1_:* = null;
         super.init();
         var_883 = new PrizeViewer();
         var_718 = recycler.getPrizeTable();
         if(var_718 == null)
         {
            return;
         }
         ...
         populateItemGrid();
         if(false && var_718[0].prizes.length > 0)
         {
            select(var_718[0].prizes[0] as IGridItem);
         }
      }
      ...
      {
         var _loc3_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1288) as IWindowContainer;
      ...
      public function select(param1:IGridItem) : void
      {
         ...
         var_883.viewProduct(page.viewer.roomEngine,_loc3_,_loc2_.productItemType,_loc2_.productItemTypeId,_loc2_.title,_loc4_);
      }
