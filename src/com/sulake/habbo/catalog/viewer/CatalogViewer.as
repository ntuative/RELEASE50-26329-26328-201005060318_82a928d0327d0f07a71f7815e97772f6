package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogViewer implements ICatalogViewer
   {
      ...
      private var var_1531:HabboCatalog;
      ...
      public function showCatalogPage(param1:int, param2:String, param3:IPageLocalization, param4:Array) : void
      {
         ...
         if(var_451 != null)
         {
            if(var_451.pageId == param1)
            {
               return;
            }
            _container.removeChild(var_451.window);
            var_451.dispose();
         }
         var _loc5_:ICatalogPage = new CatalogPage(this,param1,param2,param3,param4,var_1531);
         var_451 = _loc5_;
      ...
      {
         return var_451.dispatchWidgetEvent(param1);
      }
