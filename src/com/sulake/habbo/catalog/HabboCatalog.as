package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog
   {
      ...
      private var var_396:ClubBuyController;
      ...
      private var var_112:IMarketPlace;
      
      private var _localization:ICoreLocalizationManager;
      
      private var var_192:PurchaseConfirmationDialog;
      ...
      private var var_397:ICatalogNavigator;
      ...
      private var var_1793:GiftWrappingConfiguration;
      ...
      private var var_995:ClubGiftController;
      ...
      public function returnInventoryFurniFromRecycler(param1:int) : Boolean
      {
         ...
         return var_11.returnInventoryFurniFromRecycler(param1);
      }
      
      public function getProductData(param1:String) : IProductData
      {
         return var_344.getProductData(param1);
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         var_98.credits = _loc3_.balance;
         updatePurse();
         if(!var_1792 && var_474 != null)
         {
            var_474.playSound(HabboSoundTypesEnum.const_815);
         }
         var_1792 = false;
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = var_344.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_84)
         {
            _loc3_ = var_344.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      private function createClubBuyController() : void
      {
         if(var_396 == null)
         {
            var_396 = new ClubBuyController(this);
         }
      }
      ...
      private function onIsOfferGiftable(param1:IsOfferGiftableMessageEvent) : void
      {
         ...
         {
            this.var_192.onIsOfferGiftable(param1.getParser());
         }
      }
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_98:
               var_1177 = param1.session.isPrivateRoom;
               if(var_84 != null)
               {
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         var_1793 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(var_195 != null && _loc2_)
         {
            var_195.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_51,HabboToolbarIconEnum.CATALOGUE,_mainContainer));
         }
         if(false)
         {
      ...
      private function createMainWindow() : void
      {
         ...
         _loc3_.setParamFlag(WindowParam.const_207,false);
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         var_995.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      public function openInventoryCategory(param1:String) : void
      {
         ...
         var_11.toggleInventoryPage(param1);
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         var_397 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         var_98.clubDays = Math.max(0,_loc2_.daysToPeriodEnd);
         var_98.clubPeriods = Math.max(0,_loc2_.periodsSubscribedAhead);
         var_98.isVIP = _loc2_.isVIP;
         var_98.pastClubDays = _loc2_.pastClubDays;
         var_98.pastVipDays = _loc2_.pastVipDays;
         updatePurse();
      ...
      private function createClubGiftController() : void
      {
         if(var_995 == null)
         {
            var_995 = new ClubGiftController(this);
         }
      }
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:ICatalogPage, param3:String = "") : void
      {
         ...
         else if(param1 is Offer)
         {
            if(var_192 == null)
            {
               var_192 = new PurchaseConfirmationDialog(_localization);
            }
            _loc7_ = [];
            if(_friendList != null)
            {
            ...
            var_192.showOffer(this,param1,param2,param3,_loc7_);
         ...
         {
            var_396.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         var_112.averagePricePeriod = _loc2_.averagePricePeriod;
      }
      ...
      private function createMarketPlace() : void
      {
         if(var_112 == null)
         {
            var_112 = new MarketPlaceLogic(this,_windowManager,_roomEngine);
         }
      }
      ...
      public function method_12(param1:Array) : void
      {
      ...
      {
         var _loc2_:BitmapDataAsset = (var_11 as Component).assets.getAssetByName("fx_icon_" + param1 + "_png") as BitmapDataAsset;
         if(_loc2_ != null)
         {
            return (_loc2_.content as BitmapData).clone();
         }
      ...
      {
         var_195.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_117,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      public function requestInventoryFurniToRecycler() : int
      {
         ...
         return var_11.requestSelectedFurniToRecycler();
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         var_397.buildCatalogIndex(_loc2_);
         if(var_996 != "")
         {
            var_397.openPage(var_996);
            var_996 = "";
         }
         else
         {
            var_397.openFrontPage();
         }
      }
      ...
      {
         if(param1 == null || var_304 == null)
         {
            return;
         }
         var _loc2_:ApproveNameMessageParser = param1.getParser();
         var_304.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result));
      }
      ...
      private function updatePurse() : void
      {
         ...
         _localization.registerParameter("catalog.purse.creditbalance","balance",String(var_98.credits));
         _localization.registerParameter("catalog.purse.pixelbalance","balance",String(var_98.pixels));
         var _loc1_:int = 0;
         if(true)
         {
         ...
         else
         {
            ...
            _localization.registerParameter(_loc2_,"days",String(var_98.clubDays));
            _localization.registerParameter(_loc2_,"months",String(var_98.clubPeriods));
         }
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return var_304.getCurrentLayoutCode();
      }
      ...
      private function onPixelsBalance(param1:IMessageEvent) : void
      {
         ...
         var_98.pixels = _loc2_.amount;
         updatePurse();
         if(!var_1794 && var_474 != null)
         {
            var_474.playSound(HabboSoundTypesEnum.const_921);
         }
         var_1794 = false;
      }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         var_304.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers);
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         var_304.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function createCatalogViewer() : void
      {
         ...
         var_304 = new CatalogViewer(this,_loc1_,_roomEngine);
         var_304.habboCatalog = this;
      }
