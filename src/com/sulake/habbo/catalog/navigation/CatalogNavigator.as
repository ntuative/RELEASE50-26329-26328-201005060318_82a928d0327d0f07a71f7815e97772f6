package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2373:String = "magic.pixels";
      
      private var var_2372:String = "catalog.page.club";
      
      private var var_2389:String = "magic.credits";
      ...
      public function CatalogNavigator(param1:IHabboCatalog, param2:IWindowContainer)
      {
         ...
         _container = param2;
         var_272 = [];
         var_50 = _container.findChildByName("navigationList") as IItemListWindow;
         ...
         _loc3_.addEventListener(WindowMouseEvent.const_33,onNavigatorEvent);
         ...
         _loc4_.addEventListener(WindowMouseEvent.const_33,onNavigatorEvent);
         ...
         _loc5_.addEventListener(WindowMouseEvent.const_33,onNavigatorEvent);
         _scrollBar = _container.findChildByName("navigationListScrollbar") as IScrollbarWindow;
         if(_scrollBar != null)
         {
            _scrollBar.visible = false;
            _scrollBar.addEventListener(WindowEvent.const_603,activateScrollbar);
            _scrollBar.addEventListener(WindowEvent.const_268,activateScrollbar);
            _scrollBar.addEventListener(WindowEvent.WINDOW_EVENT_DISABLE,method_8);
            _scrollBar.addEventListener(WindowEvent.const_199,method_8);
         }
      }
      ...
      {
         _catalog.openCatalogPage(var_2372,true);
      }
      ...
      public function activateNode(param1:ICatalogNode) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:int = 0;
         var _loc2_:* = var_272.indexOf(param1) > -1;
         var _loc3_:Boolean = param1.isOpen;
         var _loc4_:* = [];
         for each(_loc5_ in var_272)
         {
            _loc5_.deActivate();
         ...
         {
            _loc6_.close();
            _loc7_ = var_272.indexOf(_loc6_);
            var_272.splice(_loc7_,1);
         }
         param1.activate();
         if(_loc2_ && _loc3_)
         {
      ...
      public function buildCatalogIndex(param1:NodeData) : void
      {
         ...
         for each(_loc2_ in _index.children)
         {
            ...
            {
               (_loc2_ as CatalogNodeRenderable).addToList(var_50);
            }
         }
      }
