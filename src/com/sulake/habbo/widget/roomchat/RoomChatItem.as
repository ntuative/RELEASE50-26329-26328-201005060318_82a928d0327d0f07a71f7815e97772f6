package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_507:int = 6;
      
      private static const const_356:int = 10;
      
      private static const const_1128:Number = 18;
      
      private static const const_1443:Number = 10;
      
      private static const const_1444:Number = 8;
      ...
      private var var_212:BitmapData;
      ...
      {
         _widget.onItemMouseOut(var_1105,var_1104,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_1105,var_768,var_1104,_roomId,_roomCategory,param1);
      }
      ...
      {
         var_1367 = param1.chatType;
         var_1105 = param1.userId;
         var_768 = param1.userName;
         var_1104 = param1.userCategory;
         _message = param1.text;
         var_1365 = param1.userX;
         var_212 = param1.userImage;
         var_1106 = param1.userColor;
      ...
      public function renderView() : void
      {
         ...
         switch(var_1367)
         {
            ...
            case RoomWidgetChatUpdateEvent.const_104:
               _loc1_ = "bubble_shout";
               break;
            case RoomWidgetChatUpdateEvent.const_240:
         ...
         if(var_212 != null)
         {
            ...
            _loc16_ = Math.max(_loc16_,var_212.height);
         }
         ...
         if(var_212 != null && !_loc2_)
         {
            ...
            if(_loc28_ != null)
            {
               _loc28_.width = var_212.width;
               _loc28_.height = var_212.height;
               _loc28_.bitmap = new BitmapData(var_212.width,var_212.height,true,0);
               _loc28_.bitmap.copyPixels(var_212,var_212.rect,new Point(0,0));
               _loc28_.x = _loc26_;
               _loc28_.y = _loc27_;
               var_453 = Math.max(0,(0 - _loc5_.height) / 2);
               _width += var_212.width;
            }
         }
         if(_loc18_ != null)
         {
            ...
            if(var_1106 != 0)
            {
               _loc30_ = uint(var_1106 >> 16 & 255);
               _loc31_ = uint(var_1106 >> 8 & 255);
               _loc32_ = uint(var_1106 >> 0 & 255);
            }
         ...
         if(_loc20_ != null)
         {
            if(var_1367 == RoomWidgetChatUpdateEvent.const_240)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_768);
            }
            else if(var_1367 == RoomWidgetChatUpdateEvent.const_278)
            {
               _loc20_.text = _localizations.registerParameter("widget.chatbubble.petrespect","petname",var_768);
            }
            else
            {
            ...
            _loc20_.x = _width;
            _loc20_.y += var_453;
            _loc20_.width = _loc20_.textWidth + const_507;
            _width += _loc20_.textWidth + const_507;
         }
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_356 + _loc20_.textWidth + const_507;
            _loc37_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_1105,var_1104,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_1105,var_1104,_roomId,_roomCategory,param1);
      }
