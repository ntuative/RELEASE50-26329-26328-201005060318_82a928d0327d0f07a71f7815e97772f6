package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      private var var_317:Boolean = false;
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         var_155.state = RoomChatHistoryPulldown.const_203;
         ...
         var_43 = param2.createWindow("chatscroller","",HabboWindowType.const_947,HabboWindowStyle.const_43,0 | 0,new Rectangle(param3.rectangle.right - SCROLLBAR_WIDTH,param3.y,SCROLLBAR_WIDTH,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      {
         return !!var_317 ? Number(SCROLLBAR_WIDTH) : Number(0);
      }
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(var_238 > 0 && param2)
         {
            if(var_1301)
            {
               if(Math.abs(param1 - var_238) <= const_840)
               {
                  return;
               }
               var_1301 = false;
      ...
      public function showHistoryViewer() : void
      {
         if(!var_317 && !var_1178)
         {
            ...
            var_155.state = RoomChatHistoryPulldown.const_338;
            if(_widget != null)
            {
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         var_155.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_203);
      }
