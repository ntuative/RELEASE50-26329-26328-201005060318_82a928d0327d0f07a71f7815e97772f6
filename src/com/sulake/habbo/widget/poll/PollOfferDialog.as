package com.sulake.habbo.widget.poll
{
   ...
   public class PollOfferDialog implements IPollDialog
   {
      ...
      public static const const_271:String = "POLL_OFFER_STATE_UNKNOWN";
      
      public static const const_509:String = "POLL_OFFER_STATE_CANCEL";
      
      public static const const_1197:String = "POLL_OFFER_STATE_OK";
      ...
      private var var_33:String = "POLL_OFFER_STATE_UNKNOWN";
            ...
            if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
            {
               switch(param2.name)
               {
                  case "poll_offer_button_ok":
                     var_33 = const_1197;
                     _widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_711,_id));
                     break;
                  case "poll_offer_button_cancel":
                     var_33 = const_509;
                     _widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_444,_id));
