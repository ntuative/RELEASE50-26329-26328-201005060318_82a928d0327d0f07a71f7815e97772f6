package com.sulake.habbo.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = var_721[var_1067] as Dictionary;
      ...
      private function showCancelConfirm() : void
      {
         ...
         if(!var_318)
         {
            ...
            var_318 = _widget.windowManager.buildFromXML(_loc1_.content as XML,2);
            var_318.center();
            var_318.procedure = cancelConfirmEventProc;
         }
      }
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++var_1067;
         if(var_1067 < var_721.length)
         {
            _loc1_ = var_721[var_1067] as Dictionary;
            if(!_loc1_)
            {
            ...
            if(_window)
            {
               ...
               if(_loc2_)
               {
                  ...
                  _loc6_ = _loc6_.replace("%count%",var_721.length);
                  _loc2_.text = _loc6_;
               }
