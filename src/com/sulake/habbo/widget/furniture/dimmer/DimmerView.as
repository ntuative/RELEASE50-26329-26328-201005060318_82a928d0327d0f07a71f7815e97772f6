package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_1144:XML;
      
      private var var_387:int;
      
      private var var_467:DimmerViewColorGrid;
      
      private var _window:IWindowContainer;
      
      private var var_1678:int;
      
      private var var_339:DimmerViewAlphaSlider;
      ...
      private function selectTab(param1:int) : void
      {
         ...
         var _loc2_:IWindow = var_220.getTabItemAt(param1);
         if(_loc2_ != null)
         {
            var_220.selector.setSelected(_loc2_ as ISelectableWindow);
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         _window = _widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_62,HabboWindowStyle.const_42,0 | 0,new Rectangle(const_1044,const_1043,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               var_467 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,_widget.windowManager,_widget.assets);
            }
         }
         _loc1_ = _window.findChildByName("brightness_container");
         if(_loc1_ != null)
         {
            var_339 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,_widget.assets);
         }
         var_220 = ITabContextWindow(_window.findChildByName("tab_context"));
         selectTab(_widget.selectedPresetIndex);
         var _loc2_:int = 0;
         while(_loc2_ < var_220.numTabItems)
         {
            _loc6_ = var_220.getTabItemAt(_loc2_);
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(var_467 != null)
         {
            var_467.setSelectedColorIndex(param1);
         }
         _widget.previewCurrentSetting();
      }
      ...
      private function getSelectedTabIndex() : int
      {
         ...
         var _loc1_:ISelectableWindow = var_220.selector.getSelected();
         return var_220.selector.getSelectableIndex(_loc1_);
      }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(var_339 != null)
         {
            var_339.min = _widget.minLights[param1 - 1];
         }
      }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         selectTab(param1);
         var_978 = _loc2_.light;
         if(var_339 != null)
         {
            var_339.setValue(var_978);
         }
         var_387 = colors.indexOf(_loc2_.color);
         if(var_467 != null)
         {
            var_467.setSelectedColorIndex(var_387);
         }
