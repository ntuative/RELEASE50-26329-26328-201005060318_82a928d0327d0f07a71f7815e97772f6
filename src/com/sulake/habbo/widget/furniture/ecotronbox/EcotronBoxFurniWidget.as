package com.sulake.habbo.widget.furniture.ecotronbox
{
   ...
   public class EcotronBoxFurniWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetEcotronBoxDataUpdateEvent.const_66,onObjectUpdate);
         param1.addEventListener(RoomWidgetEcotronBoxDataUpdateEvent.const_86,onObjectUpdate);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_133,onRoomObjectRemoved);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_66,onPresentUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetEcotronBoxDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetEcotronBoxDataUpdateEvent.const_66:
               ...
               showInterface();
               break;
            case RoomWidgetEcotronBoxDataUpdateEvent.const_86:
               if(!var_227)
               {
                  return;
               }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetEcotronBoxDataUpdateEvent.const_66,onObjectUpdate);
         param1.removeEventListener(RoomWidgetEcotronBoxDataUpdateEvent.const_86,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_66,onPresentUpdate);
      ...
      private function sendOpen() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetEcotronBoxOpenMessage(RoomWidgetEcotronBoxOpenMessage.const_551,var_151);
      ...
      private function showInterface() : void
      {
         ...
         _window = windowManager.createWindow("ecotronboxcardui_container","",HabboWindowType.const_62,HabboWindowStyle.const_42,0 | 0,new Rectangle(const_1044,const_1043,2,2),null,0) as IWindowContainer;
         ...
         if(_loc6_ != null && var_197 != null)
         {
            _loc6_.caption = var_197;
         }
