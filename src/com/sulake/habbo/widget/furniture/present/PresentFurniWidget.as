package com.sulake.habbo.widget.furniture.present
{
   ...
   public class PresentFurniWidget extends RoomWidgetBase
   {
      ...
      private static const const_1044:Number = 100;
      
      private static const const_1043:Number = 100;
       
      
      private var var_227:Boolean = false;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_66,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_86,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_445,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_379,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_396,onObjectUpdate);
         ...
         param1.addEventListener(RoomWidgetEcotronBoxDataUpdateEvent.const_66,onEcotronUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_66,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_86,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_445,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_379,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_396,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_434,onObjectUpdate);
         param1.removeEventListener(RoomWidgetEcotronBoxDataUpdateEvent.const_66,onEcotronUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetPresentDataUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetPresentDataUpdateEvent.const_66:
               hideInterface();
               var_227 = false;
               var_151 = param1.objectId;
               var_197 = param1.text;
               var_28 = param1.controller;
               showInterface();
               break;
            case RoomWidgetPresentDataUpdateEvent.const_379:
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_396:
               if(!var_227)
               {
                  return;
               }
            ...
            case RoomWidgetPresentDataUpdateEvent.const_434:
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_445:
               if(!var_227)
               {
                  return;
               }
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_86:
               if(!var_227)
               {
                  return;
               }
      ...
      private function sendOpen() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetPresentOpenMessage(RoomWidgetPresentOpenMessage.const_674,var_151);
      ...
      private function showInterface() : void
      {
         ...
         _window = windowManager.createWindow("presentcardui_container","",HabboWindowType.const_62,HabboWindowStyle.const_42,0 | 0,new Rectangle(const_1044,const_1043,2,2),null,0) as IWindowContainer;
         ...
         if(_loc4_ != null && var_197 != null)
         {
            _loc4_.caption = var_197;
         }
