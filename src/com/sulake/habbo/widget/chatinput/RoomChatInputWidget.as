package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputWidget extends RoomWidgetBase implements IUpdateReceiver
   {
      ...
      private static const const_1420:int = 150;
      
      private static const const_1076:int = 3000;
      ...
      private var var_849:Timer = null;
      ...
      public function sendChat(param1:String, param2:int, param3:String = "") : void
      {
         ...
         checkForFlooding();
         var _loc4_:RoomWidgetChatMessage = new RoomWidgetChatMessage(RoomWidgetChatMessage.const_605,param1,param2,param3);
      ...
      private function onReleaseTimerTick(param1:TimerEvent) : void
      {
         ...
         {
            var_701 = var_701 - 1;
            _visualization.showFloodBlocking(var_701);
         }
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_232,onRoomObjectDeselected);
         ...
         param1.addEventListener(RoomWidgetChatInputDisplayEvent.const_651,onSettings);
      ...
      private function onChatInputUpdate(param1:RoomWidgetChatInputContentUpdateEvent) : void
      {
         ...
         switch(param1.messageType)
         {
            case RoomWidgetChatInputContentUpdateEvent.const_884:
               ...
               break;
            case RoomWidgetChatInputContentUpdateEvent.const_1308:
         }
      }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_232,onRoomObjectDeselected);
         ...
         param1.removeEventListener(RoomWidgetChatInputDisplayEvent.const_651,onSettings);
      ...
      private function checkForFlooding() : Boolean
      {
         ...
         if(var_421 > const_1075)
         {
            if(_loc1_ < var_1247 + const_1076)
            {
               var_848 = true;
               var_701 = const_1077 / 1000;
               Logger.log("Enabling flood blocking");
               var_849 = new Timer(1000,var_701);
               var_849.addEventListener(TimerEvent.TIMER,onReleaseTimerTick);
               var_849.addEventListener(TimerEvent.TIMER_COMPLETE,onReleaseTimerComplete);
               var_849.start();
               if(_visualization != null)
               {
                  _visualization.showFloodBlocking(var_701);
      ...
      private function refreshWindowPosition() : void
      {
         ...
         var _loc1_:RoomWidgetChatInputWidgetMessage = new RoomWidgetChatInputWidgetMessage(RoomWidgetChatInputWidgetMessage.const_637,_visualization.window);
         if(messageListener != null)
         {
