package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_507:int = 16;
      
      private static const const_1126:int = 20;
      
      private static const const_356:int = 10;
      
      private static const const_1127:int = 40;
      ...
      private var var_405:Number = 600;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_1103 = _localization.getKey("widgets.chatinput.mode.whisper",":tell");
         var_2247 = _localization.getKey("widgets.chatinput.mode.shout",":shout");
         var_2246 = _localization.getKey("widgets.chatinput.mode.speak",":speak");
         var_767 = new Timer(1000,1);
         var_767.addEventListener(TimerEvent.TIMER_COMPLETE,onTypingTimerComplete);
         var_941 = new Timer(5000,1);
         var_941.addEventListener(TimerEvent.TIMER_COMPLETE,onIdleTimerComplete);
         createWindow();
         refreshView();
      }
      ...
      private function createWindow() : void
      {
         ...
         _window = _windowManager.createWindow("chatinput_widget_window","",HabboWindowType.const_62,HabboWindowStyle.const_43,0 | 0,new Rectangle(300,400,400,30),null) as IWindowContainer;
         ...
         _loc4_.addEventListener(WindowKeyboardEvent.const_146,windowKeyEventProcessor);
         ...
         _window.addEventListener(WindowEvent.const_454,onWindowMoved);
         var_1364 = true;
         var_144 = "";
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         var_2245 = _loc2_.width + const_507 + _loc6_.width + const_1126;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1127,_loc8_.width) + const_507);
            _loc8_.x = _loc12_;
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == var_1103 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  var_144 = "";
               }
      ...
      public function setMaxWidth(param1:Number) : void
      {
         ...
         {
            _loc3_ = Math.min(int(_loc2_.textWidth),var_405);
         }
         else
         {
            _loc3_ = Math.min(_loc3_,var_405);
         }
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(var_543);
