package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private var var_940:IWindow;
      
      private var var_938:IWindow;
      
      private var var_405:Number;
      
      private var var_939:ITextWindow;
      ...
      {
         super();
         var_184 = new Timer(1000);
         var_184.addEventListener(TimerEvent.TIMER,onUpdate);
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            var_938 = _window.findChildByName("effect_hilite");
            var_938.visible = false;
         }
         var_939 = _window.findChildByName("time_left") as ITextWindow;
         setTimeLeft();
         var_940 = _window.findChildByName("loader_bar");
         if(var_940 != null)
         {
            var_405 = var_940.width;
            var_184.start();
            onUpdate();
         }
         if(false)
      ...
      public function dispose() : void
      {
         ...
         {
            var_184.stop();
            var_184.removeEventListener(TimerEvent.TIMER,onUpdate);
            var_184 = null;
         }
         _container = null;
         if(_window != null)
      ...
      private function setTimeLeft() : void
      {
         ...
         if(var_939 != null)
         {
            var_939.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = "null";
            if(false)
            {
               _loc2_ = 0;
            ...
            {
               var_939.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
