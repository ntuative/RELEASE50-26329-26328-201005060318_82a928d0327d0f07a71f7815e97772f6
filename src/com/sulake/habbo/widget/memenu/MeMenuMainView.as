   ...
   public class MeMenuMainView implements IMeMenuView
   {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         while(_loc5_ < _window.numChildren)
         {
            ...
            _loc4_.addEventListener(WindowMouseEvent.const_33,onMouseOverOrOut);
            _loc5_++;
         }
      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "dance":
               ...
               _widget.changeView(MeMenuWidget.const_924);
               break;
            case "wave":
               if(false)
               {
               ...
               if(false)
               {
                  _widget.messageListener.processWidgetMessage(new RoomWidgetDanceMessage(RoomWidgetDanceMessage.const_1022));
            ...
            case "effects":
               ...
               _widget.changeView(MeMenuWidget.const_657);
               break;
            case "rooms":
               ...
               break;
            case "badges":
               _widget.messageListener.processWidgetMessage(new RoomWidgetOpenInventoryMessage(RoomWidgetOpenInventoryMessage.const_827));
               _widget.hide();
               break;
            case "clothes":
               _widget.changeView(MeMenuWidget.const_328);
               break;
            case "hc":
               _widget.messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_813));
               _widget.hide();
               break;
            case "settings":
               _widget.changeView(MeMenuWidget.const_673);
               break;
            case "news":
               if(false && false)
               {
