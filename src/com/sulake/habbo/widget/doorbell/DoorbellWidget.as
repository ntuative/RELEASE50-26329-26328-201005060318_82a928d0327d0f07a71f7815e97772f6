package com.sulake.habbo.widget.doorbell
{
   ...
   public class DoorbellWidget extends RoomWidgetBase
   {
      ...
      private static const const_1042:int = 50;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetDoorbellEvent.const_667,onDoorbellRinging);
         param1.addEventListener(RoomWidgetDoorbellEvent.const_116,onDoorbellHandled);
         param1.addEventListener(RoomWidgetDoorbellEvent.const_57,onDoorbellHandled);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetDoorbellEvent.const_667,onDoorbellRinging);
         param1.removeEventListener(RoomWidgetDoorbellEvent.const_116,onDoorbellHandled);
         param1.removeEventListener(RoomWidgetDoorbellEvent.const_57,onDoorbellHandled);
      }
