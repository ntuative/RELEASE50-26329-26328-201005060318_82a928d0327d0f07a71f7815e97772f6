package com.sulake.habbo.widget.infostand
{
   ...
   public class PetCommandTool
   {
      ...
      private var var_341:IFrameWindow;
      
      private var _widget:InfostandWidget;
      
      private var var_984:Map;
      
      private const const_1640:int = 1100;
      ...
      public function PetCommandTool(param1:InfostandWidget)
      {
         ...
         _widget = param1;
         var_984 = new Map();
         var_342 = new Timer(const_1640);
         var_342.addEventListener(TimerEvent.TIMER,onButtonDisableTimeout);
      }
      ...
      private function createCommandWindow() : void
      {
         ...
         var_41.setParamFlag(WindowParam.const_89,true);
      ...
      {
         var _loc2_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_641,param1);
      ...
      private function openInfoWindow() : void
      {
         ...
         if(var_341 == null)
         {
            ...
            var_341 = (_widget.windowManager as ICoreWindowManager).buildFromXML(_loc1_.content as XML) as IFrameWindow;
            if(var_341 == null)
            {
               throw new Error("Failed to construct command info window from XML!");
            }
            var_341.x = 200;
            var_341.procedure = onInfoWindowProcedure;
         }
         else
         {
      ...
      {
         var _loc2_:Array = var_984.getValue(var_566) as Array;
      ...
      private function onCommandWindowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null && _loc3_.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               _widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_428,var_566));
            }
            else if(param2.name.indexOf("btn_cmd_") > -1)
            {
               ...
               _loc7_ = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_622,var_566,var_1710 + " " + _loc6_);
      ...
      public function showCommandToolForPet(param1:int, param2:String, param3:BitmapData = null) : void
      {
         ...
         {
            updateCommandButtonsViewState(new Array());
            requestEnabledCommands(var_566);
         }
         else
         {
