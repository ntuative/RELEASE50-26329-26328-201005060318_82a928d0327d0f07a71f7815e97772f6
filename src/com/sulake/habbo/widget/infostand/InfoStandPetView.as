package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1656:uint = 6710886;
      
      private var _window:IItemListWindow;
      
      private const const_1663:String = "level";
      
      private var var_102:IItemListWindow;
      
      private const const_1658:String = "energy";
      
      private var var_1173:Map;
      
      private const const_1660:String = "nutrition";
      
      private var var_62:IItemListWindow;
      
      private const const_1657:uint = 3355443;
      
      private var var_242:IBorderWindow;
      
      private const const_1661:int = 158;
      
      private const const_1664:int = 16;
      
      private var _widget:InfostandWidget;
      
      private var var_177:PetCommandTool;
      
      private const const_1659:uint = 11184810;
      
      private const const_1662:String = "experience";
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var _loc3_:IWindow = var_242.findChildByTag("close");
         if(_loc3_ != null)
         {
         ...
         _loc4_ = 0;
         while(_loc4_ < var_62.numListItems)
         {
            _loc9_ = var_62.getListItemAt(_loc4_) as IRegionWindow;
            if(_loc9_ != null)
            {
         ...
         var _loc6_:IBitmapWrapperWindow = var_242.findChildByName("petrespect_icon") as IBitmapWrapperWindow;
         if(_loc6_ != null)
         {
         ...
         var _loc7_:* = [];
         var_62.groupListItemsWithTag("CMD_BUTTON",_loc7_,true);
      ...
      private function updateStateElement(param1:String, param2:int, param3:int) : void
      {
         ...
         var _loc4_:IWindowContainer = var_102.getListItemByName("status_container") as IWindowContainer;
         if(_loc4_ == null)
         {
            return;
         }
      ...
      private function set ageText(param1:int) : void
      {
         ...
         var _loc2_:ITextWindow = var_102.getListItemByName("age_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = var_1173.getValue(var_566) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      private function set image(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = var_102.getListItemByName("image_container") as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function set raceText(param1:String) : void
      {
         ...
         var _loc2_:ITextWindow = var_102.getListItemByName("race_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         ageText = param1.age;
         updateStateElement(const_1663,param1.level,param1.levelMax);
         updateStateElement(const_1662,param1.experience,param1.experienceMax);
         updateStateElement(const_1658,param1.energy,param1.energyMax);
         updateStateElement(const_1660,param1.nutrition,param1.nutritionMax);
         ...
         updateWindow();
         var_566 = param1.id;
         var_1173.remove(param1.id);
         var_1173.add(param1.id,param1);
      ...
      private function set petRespect(param1:int) : void
      {
         ...
         var _loc2_:IWindowContainer = var_102.getListItemByName("petrespect_container") as IWindowContainer;
      ...
      private function updateRespectButton() : void
      {
         ...
         var _loc1_:IRegionWindow = var_62.getListItemByName("petrespect") as IRegionWindow;
         if(_loc1_ == null)
         {
            return;
         }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(var_177 && var_177.getPetId() == var_566)
               {
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_459,_widget.petData.ownerId);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1661,const_1664,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),const_1659);
         var _loc6_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc5_.fillRect(_loc6_,const_1657);
         var _loc7_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc7_.width = _loc3_ * _loc7_.width;
         _loc5_.fillRect(_loc7_,const_1656);
         return _loc5_;
      }
