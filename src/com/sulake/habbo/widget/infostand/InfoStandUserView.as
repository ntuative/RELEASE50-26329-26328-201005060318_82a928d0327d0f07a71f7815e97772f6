package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private var var_102:IItemListWindow;
      
      private var var_864:TagListRenderer;
      
      protected var var_62:IItemListWindow;
      
      private var var_242:IBorderWindow;
      
      protected var _widget:InfostandWidget;
      
      private var var_115:IBorderWindow;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         var_864 = new TagListRenderer(param1,onTagSelected);
      }
      ...
      protected function createWindow(param1:String, param2:Boolean) : void
      {
         ...
         var_242 = _window.getListItemByName("info_border") as IBorderWindow;
         var_62 = _window.getListItemByName("button_list") as IItemListWindow;
         var _loc4_:* = [];
         var_62.groupListItemsWithTag("CMD_BUTTON",_loc4_,true);
         for each(_loc5_ in _loc4_)
         {
            ...
            _loc5_.addEventListener(WindowEvent.const_48,onButtonResized);
         }
         if(var_242 != null)
         {
            var_102 = var_242.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
         var _loc6_:IBitmapWrapperWindow = var_242.findChildByName("home_icon") as IBitmapWrapperWindow;
         ...
         var _loc7_:IWindow = var_242.findChildByTag("close");
         if(_loc7_ != null)
         {
         ...
         {
            _loc8_ = 0;
            while(_loc8_ < var_62.numListItems)
            {
               _loc13_ = var_62.getListItemAt(_loc8_) as IRegionWindow;
               if(_loc13_ != null)
               {
         ...
         while(_loc8_ < 5)
         {
            _loc10_ = var_242.findChildByName("badge_" + _loc8_);
            if(_loc10_ != null)
            {
               _loc10_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,showBadgeInfo);
               _loc10_.addEventListener(WindowMouseEvent.const_33,hideBadgeInfo);
            }
            _loc8_++;
         }
         _loc10_ = var_242.findChildByName("badge_group");
      ...
      private function showGroupBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         _loc3_ = var_115.getChildByName("name") as ITextWindow;
         if(_loc3_ != null)
         {
            _loc3_.text = "Group Info";
         }
         _loc4_ = var_115.getChildByName("description") as ITextWindow;
         if(_loc4_ != null)
         {
         ...
         var_115.x = _loc5_.left - 0;
         var_115.y = _loc5_.top + (_loc5_.height - 0) / 2;
      }
      
      public function clearGroupBadge() : void
      {
         var _loc1_:IWindowContainer = var_102.getListItemByName("image_and_badges_container") as IWindowContainer;
      ...
      {
         var _loc2_:ITextWindow = var_102.getListItemByName("realname_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:IWindowContainer = var_102.getListItemByName("image_and_badges_container") as IWindowContainer;
      ...
      {
         if(var_102 == null || var_242 == null || var_62 == null)
         {
            return;
         }
         var_62.width = var_62.scrollableRegion.width;
         var_102.height = var_102.scrollableRegion.height;
         var_242.height = NaN;
         _window.width = Math.max(var_242.width,var_62.width);
      ...
      {
         var _loc2_:ITextWindow = var_102.getListItemByName("motto_text") as ITextWindow;
         var _loc3_:IWindowContainer = var_102.getListItemByName("motto_spacer") as IWindowContainer;
      ...
      {
         var _loc3_:IWindowContainer = var_102.getListItemByName("tags_container") as IWindowContainer;
         var _loc4_:IWindowContainer = var_102.getListItemByName("tags_spacer") as IWindowContainer;
         ...
         if(param1.length != 0)
         {
            _loc3_.height = var_864.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      {
         var _loc4_:* = null;
         var _loc2_:ITextWindow = var_102.getListItemByName("handitem_txt") as ITextWindow;
         var _loc3_:IWindowContainer = var_102.getListItemByName("handitem_spacer") as IWindowContainer;
         if(_loc2_ == null || _loc3_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:ITextWindow = var_102.getListItemByName("name_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      protected function showButton(param1:String, param2:Boolean) : void
      {
         ...
         var _loc3_:IWindow = var_62.getListItemByName(param1);
         if(_loc3_ != null)
         {
            _loc3_.visible = param2;
            var_62.arrangeListItems();
         }
      }
      ...
      private function enableButton(param1:String, param2:Boolean = true) : void
      {
         ...
         var _loc3_:IRegionWindow = var_62.getListItemByName(param1) as IRegionWindow;
      ...
      private function createBadgeDetails() : void
      {
         ...
         var_115 = _widget.windowManager.buildFromXML(_loc1_.content as XML) as IBorderWindow;
         if(var_115 == null)
         {
            throw new Error("Failed to construct window from XML!");
         }
      ...
      private function updateRespectButton() : void
      {
         ...
         var _loc1_:IWindow = var_62.getListItemByName("respect");
         if(_loc1_ == null)
         {
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            case RoomWidgetUserInfoUpdateEvent.TRADE_REASON_NO_OWN_RIGHT:
               ...
               break;
            case RoomWidgetUserInfoUpdateEvent.const_867:
               _loc2_ = "${infostand.button.trade.tooltip.shutdown}";
               break;
            case RoomWidgetUserInfoUpdateEvent.const_968:
      ...
      private function showBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         createBadgeDetails();
         _loc6_ = var_115.getChildByName("name") as ITextWindow;
         if(_loc6_ != null)
         {
            _loc6_.text = "${badge_name_" + _loc5_ + "}";
         }
         _loc6_ = var_115.getChildByName("description") as ITextWindow;
         if(_loc6_ != null)
         {
         ...
         var_115.x = _loc7_.left - 0;
         var_115.y = _loc7_.top + (_loc7_.height - 0) / 2;
      }
      ...
      {
         var _loc2_:ITextWindow = var_102.getListItemByName("xp_text") as ITextWindow;
         var _loc3_:IWindowContainer = var_102.getListItemByName("xp_spacer") as IWindowContainer;
         if(_loc2_ == null || _loc3_ == null)
         {
            return;
         }
      ...
      protected function updateButtons(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetUserInfoUpdateEvent.const_223:
               var_62.visible = false;
               break;
            case RoomWidgetUserInfoUpdateEvent.const_219:
      ...
      {
         var _loc3_:IWindowContainer = var_102.getListItemByName("image_and_badges_container") as IWindowContainer;
