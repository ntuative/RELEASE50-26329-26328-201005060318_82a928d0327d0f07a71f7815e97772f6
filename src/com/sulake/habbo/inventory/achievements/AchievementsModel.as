package com.sulake.habbo.inventory.achievements
{
   ...
   public class AchievementsModel implements IInventoryModel
   {
      ...
      public function addAchievement(param1:Achievement, param2:Boolean = true) : void
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < var_347.length)
         {
            _loc5_ = var_347[_loc4_] as Achievement;
      ...
      public function removeAchievement(param1:String, param2:int) : void
      {
         ...
         _loc4_ = var_347[0] as Achievement;
      ...
      {
         if(param1 == InventoryCategory.const_311 && false)
         {
            var_28.events.dispatchEvent(new Event(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_ACHIEVEMENTS));
         }
      }
      ...
      public function getAchievements() : Array
      {
         ...
         var _loc2_:int = 0;
         while(_loc2_ < var_347.length)
         {
            _loc3_ = var_347[_loc2_] as Achievement;
            _loc1_.push(_loc3_);
            _loc2_++;
         }
         return _loc1_;
