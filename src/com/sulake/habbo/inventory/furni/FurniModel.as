package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      private static const const_1049:int = 100;
      
      public static const const_308:String = "pets";
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboLocalizationManager, param8:IHabboConfigurationManager)
      {
         ...
         _assets = param5;
         _roomEngine = param6;
         _roomEngine.events.addEventListener(RoomEngineObjectEvent.const_211,onObjectPlaced);
         var_471 = new Timer(const_1049,1);
         var_471.addEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
      ...
      {
         return var_28.getSubCategoryViewId() == InventorySubCategory.const_273;
      }
      ...
      {
         return var_28.canUserOfferToTrade();
      }
      ...
      public function getAllStripIds(param1:Array) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc2_:Array = var_391.getKeys();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_.length)
         {
            _loc4_ = var_391.getValue(_loc2_[_loc3_]) as Array;
            if(_loc4_ != null)
            {
               _loc5_ = 0;
               while(_loc5_ < _loc4_.length)
               {
                  ...
                  if(_loc6_.category == FurniCategory.const_519)
                  {
                     _loc7_ = 1;
                  }
                  _loc8_ = 0;
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(_roomEngine != null)
            {
               if(false)
               {
                  _roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_211,onObjectPlaced);
               }
               _roomEngine = null;
            }
            _communication = null;
            ...
            if(var_471 != null)
            {
               var_471.removeEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
               var_471.stop();
               var_471 = null;
            }
            if(var_125 != null)
            {
               var_125.removeEventListener(TimerEvent.TIMER_COMPLETE,initTimeout);
               var_125.stop();
               var_125 = null;
            }
            if(var_666 != null)
      ...
      private function requestSelectedFurniToMover(param1:IItem) : void
      {
         ...
         if(param1.category == FurniCategory.const_164)
         {
         ...
         {
            var_993 = param1.ref;
            if(!var_28.recyclerModel.running)
            {
               requestClose();
            }
            var_797 = true;
      ...
      public function method_2(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         var _loc7_:* = null;
         var _loc8_:* = null;
         var _loc9_:* = null;
         if(param3 == FurniCategory.const_301)
         {
         ...
         else if(param3 == FurniCategory.const_326)
         {
         ...
         if(var_666 == null)
         {
            var_666 = _windowManager.buildFromXML(_groupItemWindowBase) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = var_666.clone() as IWindowContainer;
         return new GroupItem(param1,param2,param3,_loc11_,_roomEngine,_loc9_.clone(),var_28.recyclerModel.running,param4,param5,_loc7_,param6);
      }
      ...
      public function requestSelectedFurniToTrading() : void
      {
         ...
         var _loc3_:TradingModel = var_28.tradingModel;
         if(_loc3_ != null)
         {
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_273:
               ...
               break;
            case InventorySubCategory.const_899:
               removeAllLocks();
               if(_view != null)
               {
                  _view.updateActionView();
      ...
      public function requestInitialization(param1:int = 0) : void
      {
         if(param1 > 0)
         {
            ...
            var_125 = new Timer(param1,1);
            var_125.addEventListener(TimerEvent.TIMER_COMPLETE,initTimeout);
            var_125.start();
         }
         else
         {
      ...
      {
         var_28.checkCategoryInitilization(InventoryCategory.const_333);
      ...
      {
         if(param1 == InventoryCategory.const_78 && false)
         {
            switch(_view.visibleCategoryId)
            {
               case const_45:
                  var_28.events.dispatchEvent(new Event(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_FURNI));
                  break;
               case const_46:
                  var_28.events.dispatchEvent(new Event(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_POSTERS));
                  break;
               case const_308:
                  var_28.toggleInventoryPage(InventoryCategory.const_142);
            }
         }
      }
      ...
      public function requestSelectedFurniSelling() : void
      {
         ...
         var _loc3_:MarketplaceModel = var_28.marketplaceModel;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function updateLocks() : void
      {
         ...
         var _loc3_:RecyclerModel = var_28.recyclerModel;
         if(_loc3_ != null)
         {
      ...
      {
         if(var_797 && param1.type == RoomEngineObjectEvent.const_211)
         {
            var_28.showView();
            var_797 = false;
         }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_296 || _loc3_.category == FurniCategory.const_301 || _loc3_.category == FurniCategory.const_326)
         {
            if(param1)
            {
               return false;
      ...
      {
         return var_391.getValue(param1);
      }
      
      public function clearFurniList() : void
      {
         var_391 = new Map();
         var_391.add(const_45,new Array());
         var_391.add(const_46,new Array());
         if(_view != null)
         {
            _view.clearViews();
         }
      ...
      public function addFurniAt(param1:IItem, param2:Boolean = false, param3:int = -1) : void
      {
         ...
         if(!param1.groupable)
         {
            _loc5_ = method_2(param1.type,_loc4_,param1.category,param1.stuffData,param1.extra,param2);
            _loc5_.push(param1);
            if(param3 == -1)
            {
               _loc6_.push(_loc5_);
