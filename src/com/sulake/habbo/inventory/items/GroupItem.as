package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      private const const_1650:int = 13421772;
      ...
      protected var var_2302:BitmapData;
      
      protected var var_957:Boolean;
      ...
      protected var var_457:int = 0;
      
      protected var var_1387:String;
      
      private const const_1649:int = 8947848;
      
      protected var _items:Map;
      
      protected var _category:int;
      
      protected var var_382:BitmapData;
      
      private const const_1437:Number = 0.2;
      
      protected var var_1399:Boolean;
      
      private const const_1436:Number = 1;
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(category == FurniCategory.const_519)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < _items.length)
      ...
      public function initImage() : void
      {
         ...
         if(_mainCategory == FurniModel.const_45)
         {
            _loc1_ = _roomEngine.getFurnitureIcon(_type,this,String(var_1567));
         }
         else
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               _window.blend = const_1437;
               _loc1_.blend = const_1437;
            }
            else
            {
               _window.blend = const_1436;
               _loc1_.blend = const_1436;
            }
         }
         if(isSelected)
         {
         ...
         if(_loc5_)
         {
            if(var_1399 && getRecyclableCount() > 0)
            {
               _loc5_.bitmap = var_2302;
               _loc5_.visible = true;
            }
            else
            {
