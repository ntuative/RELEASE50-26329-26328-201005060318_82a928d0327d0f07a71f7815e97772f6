package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_1099:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         if(_loc7_ != null)
         {
            var_632 = BitmapData(_loc7_.content);
         }
         ...
         _thumbWidth = var_632.width;
         var_95 = var_632.height;
         var_1098 = param5;
         var_934 = param6;
         var_247 = Math.floor(var_1098 / _thumbWidth);
         var_19 = new BitmapData(var_1098,var_934);
      }
      
      public function resolveIndexFromImageLocation(param1:Point) : int
      {
         var _loc2_:Point = resolveGridLocationFromImage(param1);
         return int(_loc2_.y * var_247 + _loc2_.x);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         var _loc4_:int = var_247 - param1.x - 1;
         ...
         if(var_19.height < var_934)
         {
            _loc12_ = new BitmapData(var_19.width,var_934);
      ...
      {
         var _loc4_:* = null;
         var _loc3_:BitmapData = new BitmapData(var_632.width,var_632.height);
         if(param2)
         {
            _loc3_.copyPixels(_itemBgImageSelected,var_632.rect,new Point(0,0),null,null,false);
         }
         else
         {
            _loc3_.copyPixels(var_632,var_632.rect,new Point(0,0),null,null,false);
         }
         if(param1 != null)
         {
      ...
      private function getList() : Array
      {
         ...
         if(var_1099 != null)
         {
            _loc1_ = var_1099.getDrawableList();
         }
      ...
      public function updateImageFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         var_541 = resolveRowCountFromList();
         if(var_541 == 0)
         {
            var_19 = new BitmapData(var_1098,var_934);
            return;
         }
         var_19 = new BitmapData(Math.max(var_247 * _thumbWidth,var_1098),Math.max(var_541 * var_95,var_934),true,16777215);
         var_19.fillRect(var_19.rect,4294967295);
         var _loc1_:int = 0;
         var _loc2_:Array = getList();
         var _loc3_:int = 0;
         while(_loc3_ < var_541)
         {
            _loc4_ = 0;
            while(_loc4_ < var_247)
            {
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == var_247 && var_19.height < _loc3_.y * var_95)
         {
         ...
         _loc4_ = new Rectangle(0,0,_thumbWidth * (var_247 - 1),var_95);
         _loc2_.copyPixels(var_19,_loc4_,new Point(_thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(_thumbWidth * (var_247 - 1),0,_thumbWidth,var_19.height);
         _loc2_.copyPixels(var_19,_loc4_,new Point(0,var_95),null,null,true);
         _loc4_ = new Rectangle(0,var_95,_thumbWidth * (var_247 - 1),0 - var_95);
      ...
      {
         var _loc1_:Array = getList();
         return int(Math.ceil(_loc1_.length / var_247));
      }
      ...
      {
         var _loc2_:int = Math.floor(param1 / var_247);
         var _loc3_:int = param1 % var_247;
         return new Point(_loc3_,_loc2_);
      }
