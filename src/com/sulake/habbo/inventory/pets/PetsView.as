package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView
   {
      ...
      private var var_315:PetsGridItem;
      ...
      private var var_524:IItemGridWindow;
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IAvatarRenderManager)
      {
         ...
         var_524 = _view.findChildByName("grid") as IItemGridWindow;
      ...
      {
         if(var_608 == null || false)
         {
            updatePreview();
            return;
         }
         setSelectedGridItem(var_608.getWithIndex(0));
      }
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(var_315 != null)
         {
            var_315.setSelected(false);
         }
         var_315 = param1;
         if(var_315 != null)
         {
            var_315.setSelected(true);
         }
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowEvent.const_60)
         {
            ...
            {
               case "tab_floor":
                  _model.switchCategory(FurniModel.const_45);
                  break;
               case "tab_wall":
                  _model.switchCategory(FurniModel.const_46);
            }
            method_3();
         }
      }
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = var_315.pet;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:PetsGridItem = var_608.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         var_524.removeGridItem(_loc2_.window);
         if(var_315 == _loc2_)
         {
            var_315 = null;
            selectFirst();
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(var_608.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            var_524.addGridItem(_loc2_.window);
            var_608.add(param1.id,_loc2_);
            if(var_315 == null)
            {
               selectFirst();
            }
      ...
      private function updatePreview(param1:PetsGridItem = null) : void
      {
         ...
         {
            _loc12_ = param1.pet;
            _loc13_ = _avatarRenderer.createPetImageFromFigure(_loc12_.figure,AvatarScaleType.const_56);
            if(_loc13_ == null)
            {
               return;
            }
            _loc13_.setDirection(AvatarSetType.const_40,4);
            _loc2_ = _loc13_.getCroppedImage(AvatarSetType.const_40);
            _loc3_ = _loc12_.name;
