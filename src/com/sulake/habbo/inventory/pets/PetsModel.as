package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsModel implements IInventoryModel
   {
      ...
      public function categorySwitch(param1:String) : void
      {
         ...
         {
            var_28.events.dispatchEvent(new Event(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_PETS));
         }
      }
      ...
      {
         var_28.furniModel.switchCategory(param1);
      ...
      public function onObjectPlaced(param1:Event) : void
      {
         ...
         if(var_1230 && param1.type == RoomEngineObjectEvent.const_211)
         {
            var_28.showView();
            var_1230 = false;
         }
      ...
      public function placePetToRoom(param1:int, param2:Boolean = false) : void
      {
         ...
         if(var_28.roomSession.isRoomOwner)
         {
            var_1230 = _roomEngine.initializeRoomObjectInsert(_loc3_.id,RoomObjectCategoryEnum.const_38,RoomObjectTypeEnum.const_294,_loc3_.figure);
            var_28.closeView();
            return;
         }
         if(!var_28.roomSession.arePetsAllowed)
         {
            return;
         }
         if(!param2)
      ...
      {
         if(var_1009.add(param1.id,param1))
         {
            _view.addPet(param1);
         }
      }
