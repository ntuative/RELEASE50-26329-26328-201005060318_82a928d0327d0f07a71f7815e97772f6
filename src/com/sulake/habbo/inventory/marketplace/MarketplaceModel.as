package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceModel implements IInventoryModel
   {
      ...
      public function proceedOfferMaking(param1:int, param2:int) : void
      {
         ...
         switch(param1)
         {
            ...
            case 3:
               ...
               break;
            case 4:
               _view.showBuyTokens(var_1545,var_1544);
         }
      }
      ...
      {
         if(param1 != var_1787 || param2 != var_1784)
         {
            return;
         }
         if(!_view)
         ...
         _view.updateAveragePrice(param3,var_1689);
      }
      ...
      {
         if(var_28 != null && false && var_225 != null)
         {
            var_28.furniModel.removeLockFrom(var_225.id);
            var_225 = null;
         }
      }
      ...
      public function startOfferMaking(param1:IItem) : void
      {
         ...
         if(false)
         {
            var_28.furniModel.addLockTo(param1.id);
         }
         var _loc2_:IConnection = _communication.getHabboMainConnection(null);
         if(_loc2_ == null)
         {
