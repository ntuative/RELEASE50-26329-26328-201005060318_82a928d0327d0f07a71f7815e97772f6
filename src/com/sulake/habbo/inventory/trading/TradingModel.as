package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_178:uint = 0;
      
      public static const const_1195:uint = 9;
      
      public static const const_226:uint = 5;
      ...
      public function updateItemGroupMaps(param1:int, param2:Map, param3:int, param4:Map) : void
      {
         ...
         var_47.updateItemList(var_1323);
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            var_47.alertPopup(TradingView.const_976);
         }
         else if(param1 is TradingAcceptEvent)
         {
            ...
            {
               var_519 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            {
               var_47.alertPopup(TradingView.const_848);
            }
            close();
         }
      ...
      {
         Logger.log("OLD STATE: " + var_33 + " NEW STATE: " + param1 + " OWN: " + var_519 + " OTHER: " + var_733);
         ...
         {
            case const_178:
               if(param1 == const_179 || param1 == const_226)
               {
                  var_33 = param1;
                  _loc2_ = true;
               }
      ...
      {
         var_47.setMinimized(param1 != InventoryCategory.const_78);
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         else
         {
            ...
            if(param3 == FurniCategory.const_164)
            {
      ...
      public function close() : void
      {
         if(var_585)
         {
            if(var_33 != const_178 && var_33 != const_226)
            {
               requestCancelTrading();
               state = TradingModel.TRADING_STATE_CANCELLED;
            }
            state = const_178;
            var_11.toggleInventorySubPage(InventorySubCategory.const_899);
            var_585 = false;
         }
         var_47.setMinimized(false);
      }
