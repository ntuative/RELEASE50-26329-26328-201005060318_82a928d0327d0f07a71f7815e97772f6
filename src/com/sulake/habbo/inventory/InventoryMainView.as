package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      private var var_2353:IWindowContainer;
      ...
      public function windowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowEvent.const_60)
         {
            ...
            if(_loc3_ != var_760)
            {
               var_28.toggleInventoryPage(_loc3_);
            }
         }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         var_28.checkCategoryInitilization(param1);
         var _loc2_:ITabContextWindow = var_14.findChildByName("contentArea") as ITabContextWindow;
         if(_loc2_ == null)
         {
            return;
         }
         _loc2_.container.removeChild(var_1360);
         _loc2_.invalidate();
         var _loc3_:IWindowContainer = var_28.getCategoryWindowContainer(param1);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(var_760 == InventoryCategory.const_142)
            {
               toggleCategoryView(InventoryCategory.const_142);
            }
            else if(var_760 == InventoryCategory.const_78)
            {
               toggleCategoryView(InventoryCategory.const_78);
            }
            else if(var_28 != null)
            {
               var_28.toggleInventoryPage(InventoryCategory.const_78);
            }
         }
      }
      ...
      public function toggleSubCategoryView(param1:String, param2:Boolean = true) : void
      {
         ...
         else
         {
            ...
            if(var_195 != null && var_932)
            {
               var_195.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_51,HabboToolbarIconEnum.INVENTORY,_loc3_ as IWindowContainer));
            }
         }
      }
      ...
      public function setHabboToolbarIcon() : void
      {
         if(var_195 != null)
         {
            var_195.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_117,HabboToolbarIconEnum.INVENTORY));
         }
      }
      ...
      private function setSubViewToCategory(param1:String) : void
      {
         ...
         var _loc3_:IWindowContainer = var_28.getCategorySubWindowContainer(param1);
         if(_loc3_ != null)
         {
            _loc2_.visible = true;
            _loc3_.visible = true;
         ...
         if(var_195 != null)
         {
            var_195.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_590,HabboToolbarIconEnum.INVENTORY,var_14 as IWindowContainer));
         }
      }
      ...
      public function showInventory() : void
      {
         ...
         if(var_195 != null && var_932)
         {
            var_195.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_51,HabboToolbarIconEnum.INVENTORY,_loc1_ as IWindowContainer));
            var_932 = false;
         }
         var_28.inventoryViewOpened(var_761);
      }
      ...
      public function toggleCategoryView(param1:String, param2:Boolean = true) : void
      {
         ...
         else
         {
            _loc3_.visible = true;
            _loc3_.activate();
            if(param1 != var_760 || !var_28.isInventoryCategoryInit(param1))
            {
               setViewToCategory(param1);
            }
            if(var_195 != null && var_932)
            ...
            var_28.inventoryViewOpened(param1);
         }
      }
