package com.sulake.habbo.inventory
{
   ...
   public class IncomingMessages
   {
      ...
      public function IncomingMessages(param1:HabboInventory)
      {
         super();
         var_11 = param1;
         var_25 = var_11.communication;
         var_25.addHabboConnectionMessageEvent(new FurniListEvent(onFurniList));
         var_25.addHabboConnectionMessageEvent(new FurniListInsertEvent(onFurniListInsert));
         var_25.addHabboConnectionMessageEvent(new FurniListRemoveEvent(onFurniListRemove));
         var_25.addHabboConnectionMessageEvent(new FurniListUpdateEvent(onFurniListUpdate));
         var_25.addHabboConnectionMessageEvent(new PostItPlacedEvent(onPostItPlaced));
         var_25.addHabboConnectionMessageEvent(new AvatarEffectsMessageEvent(onAvatarEffects));
         var_25.addHabboConnectionMessageEvent(new AvatarEffectActivatedMessageEvent(onAvatarEffectActivated));
         var_25.addHabboConnectionMessageEvent(new AvatarEffectAddedMessageEvent(onAvatarEffectAdded));
         var_25.addHabboConnectionMessageEvent(new AvatarEffectExpiredMessageEvent(onAvatarEffectExpired));
         var_25.addHabboConnectionMessageEvent(new HabboActivityPointNotificationMessageEvent(onPixelBalance));
         var_25.addHabboConnectionMessageEvent(new CreditBalanceEvent(onCreditsBalance));
         var_25.addHabboConnectionMessageEvent(new ScrSendUserInfoEvent(onClubStatus));
         var_25.addHabboConnectionMessageEvent(new BadgesEvent(onBadges));
         var_25.addHabboConnectionMessageEvent(new HabboUserBadgesMessageEvent(onUserBadges));
         var_25.addHabboConnectionMessageEvent(new HabboAchievementNotificationMessageEvent(onAchievementReceived));
         var_25.addHabboConnectionMessageEvent(new AchievementsEvent(onAchievements));
         var_25.addHabboConnectionMessageEvent(new TradingAcceptEvent(onTradingAccepted,TradingAcceptParser));
         var_25.addHabboConnectionMessageEvent(new TradingConfirmationEvent(onTradingConfirmation,TradingConfirmationParser));
         var_25.addHabboConnectionMessageEvent(new TradingAlreadyOpenEvent(onTradingAlreadyOpen,TradingAlreadyOpenParser));
         var_25.addHabboConnectionMessageEvent(new TradingCloseEvent(onTradingClose,TradingCloseParser));
         var_25.addHabboConnectionMessageEvent(new TradingCompletedEvent(onTradingCompleted,TradingCompletedParser));
         var_25.addHabboConnectionMessageEvent(new TradingItemListEvent(onTradingItemList,TradingItemListParser));
         var_25.addHabboConnectionMessageEvent(new TradingNotOpenEvent(onTradingNotOpen,TradingNotOpenParser));
         var_25.addHabboConnectionMessageEvent(new TradingOpenEvent(onTradingOpen,TradingOpenParser));
         var_25.addHabboConnectionMessageEvent(new TradingOtherNotAllowedEvent(onTradingOtherNotAllowed,TradingOtherNotAllowedParser));
         var_25.addHabboConnectionMessageEvent(new TradingYouAreNotAllowedEvent(onTradingYouAreNotAllowed,TradingYouAreNotAllowedParser));
         var_25.addHabboConnectionMessageEvent(new OpenConnectionMessageEvent(onRoomClosed));
         var_25.addHabboConnectionMessageEvent(new CloseConnectionMessageEvent(onRoomClosed));
         var_25.addHabboConnectionMessageEvent(new FlatAccessDeniedMessageEvent(onRoomClosed));
         var_25.addHabboConnectionMessageEvent(new PetInventoryEvent(onPets));
         var_25.addHabboConnectionMessageEvent(new PetAddedToInventoryEvent(onPetAdded));
         var_25.addHabboConnectionMessageEvent(new PetRemovedFromInventoryEvent(onPetRemoved));
         var_25.addHabboConnectionMessageEvent(new PetInventoryUpdatedEvent(onPetInventoryUpdated));
         var_25.addHabboConnectionMessageEvent(new MarketplaceConfigurationEvent(onMarketplaceConfiguration));
         var_25.addHabboConnectionMessageEvent(new MarketplaceCanMakeOfferResult(onMarketplaceCanMakeOfferResult));
         var_25.addHabboConnectionMessageEvent(new MarketplaceMakeOfferResult(onMarketplaceMakeOfferResult));
         var_25.addHabboConnectionMessageEvent(new MarketplaceItemStatsEvent(onMarketplaceItemStats));
         var_25.addHabboConnectionMessageEvent(new NotEnoughBalanceMessageEvent(onNotEnoughCredits));
         var_25.addHabboConnectionMessageEvent(new UserRightsMessageEvent(onUserRights));
      }
      ...
      private function onPetRemoved(param1:PetRemovedFromInventoryEvent) : void
      {
         ...
         var _loc3_:PetsModel = var_11.petsModel;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function onFurniListRemove(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FurniModel = var_11.furniModel;
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function onFurniListUpdate(param1:IMessageEvent) : void
      {
         ...
         var_11.setInventoryCategoryInit(InventoryCategory.const_78,false);
      }
      ...
      {
         var _loc2_:EffectsModel = var_11.effectsModel;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         var_11.notifyChangedEffects();
      }
      
      private function onTradingAccepted(param1:IMessageEvent) : void
      {
         var _loc2_:TradingModel = var_11.tradingModel;
         if(_loc2_ != null)
         {
      ...
      public function onAvatarEffects(param1:IMessageEvent) : void
      {
         ...
         var_11.setInventoryCategoryInit(InventoryCategory.const_612);
         _loc2_.refreshViews();
         var_11.notifyChangedEffects();
      }
      ...
      private function onTradingItemList(param1:IMessageEvent) : void
      {
         ...
         var _loc11_:FurniModel = var_11.furniModel;
         if(_loc11_ == null)
         {
            return;
         }
         ...
         while(_loc10_ < _loc5_)
         {
            ...
            if(_loc9_.category == FurniCategory.const_164)
            {
            ...
            if(_loc9_.itemType == "S")
            {
               if(_loc6_ == null)
               {
                  _loc6_ = _loc11_.method_2(_loc7_,FurniModel.const_45,_loc9_.category,_loc9_.stuffData);
            ...
            else
            {
               ...
               if(_loc6_ == null)
               {
                  _loc6_ = _loc11_.method_2(_loc7_,FurniModel.const_46,_loc9_.category,_loc9_.stuffData);
                  _loc3_.add(_loc8_,_loc6_);
               }
         ...
         var _loc12_:TradingModel = var_11.tradingModel;
         if(_loc12_ != null)
         {
      ...
      public function onClubStatus(param1:IMessageEvent) : void
      {
         ...
         {
            var_11.setClubStatus(_loc2_.periodsSubscribedAhead,_loc2_.daysToPeriodEnd,_loc2_.hasEverBeenMember,_loc2_.isVIP);
            var_11.events.dispatchEvent(new HabboInventoryHabboClubEvent());
         }
      }
      ...
      private function onMarketplaceItemStats(param1:MarketplaceItemStatsEvent) : void
      {
         ...
         var _loc3_:MarketplaceModel = var_11.marketplaceModel;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:* = null;
         if(var_11.isInventoryCategoryInit(InventoryCategory.const_333))
         {
            _loc2_ = var_11.marketplaceModel;
            if(_loc2_ == null)
            {
               return;
            }
      ...
      public function onAchievementReceived(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:BadgesModel = var_11.badgesModel;
         if(_loc3_ != null)
         {
            _loc3_.updateBadge(_loc2_.badgeID,false);
            _loc3_.removeBadge(_loc2_.removedBadgeID);
         }
         var _loc4_:AchievementsModel = var_11.achievementsModel;
         if(_loc4_ != null)
         {
      ...
      private function getConnection() : IConnection
      {
         ...
         return var_25.getHabboMainConnection(null);
      }
      ...
      private function onPets(param1:PetInventoryEvent) : void
      {
         ...
         var_11.setInventoryCategoryInit(InventoryCategory.const_142);
      }
      ...
      public function onUserBadges(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.userId != var_11.sessionData.userId)
         {
            return;
         }
         var _loc3_:BadgesModel = var_11.badgesModel;
      ...
      {
         var_11.creditBalance = (param1 as CreditBalanceEvent).getParser().balance;
      }
      ...
      public function onAchievements(param1:IMessageEvent) : void
      {
         ...
         _loc4_.refreshViews();
         var_11.setInventoryCategoryInit(InventoryCategory.const_311);
      }
      ...
      public function onFurniList(param1:IMessageEvent) : void
      {
         ...
         var_11.setInventoryCategoryInit(InventoryCategory.const_78);
         ...
         if(_loc4_.getSelectedItemIndex(FurniModel.const_46) == -1)
         {
            _loc4_.toggleItemSelection(FurniModel.const_46,0);
         }
      ...
      private function onTradingOpen(param1:IMessageEvent) : void
      {
         ...
         var _loc2_:ISessionDataManager = var_11.sessionData;
         var _loc3_:IRoomSession = var_11.roomSession;
         if(!_loc2_)
         {
         ...
         var_11.toggleInventorySubPage(InventorySubCategory.const_273);
         ...
         var _loc13_:TradingModel = var_11.tradingModel;
         if(_loc13_)
         {
      ...
      {
         var _loc2_:PetsModel = var_11.petsModel;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function onBadges(param1:IMessageEvent) : void
      {
         ...
         _loc3_.updateView();
         var_11.setInventoryCategoryInit(InventoryCategory.const_257);
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         var_11.setInventoryCategoryInit(InventoryCategory.const_333);
         var _loc4_:FurniModel = var_11.furniModel;
         if(_loc4_ != null)
         {
            _loc4_.updateView();
      ...
      {
         var_11.pixelBalance = (param1 as HabboActivityPointNotificationMessageEvent).amount;
      }
      ...
      private function onNotEnoughCredits(param1:NotEnoughBalanceMessageEvent) : void
      {
         ...
         var _loc2_:MarketplaceModel = var_11.marketplaceModel;
         if(_loc2_ == null)
         {
            return;
         }
