package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private var var_1442:IIssueBrowserView;
      
      private const const_1647:String = "open_issues";
      ...
      private var var_1441:IIssueBrowserView;
      
      private const const_1667:String = "closed_issues";
      
      private var _issueManager:IssueManager;
      
      private const const_1645:String = "my_issues";
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_220:ITabContextWindow;
      
      private var var_1443:PickedIssuesView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         var_345.view.width = var_220.container.width;
         var_345.view.height = var_220.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case const_1645:
               if(var_1441 == null)
               {
                  var_1441 = new MyIssuesView(issueManager,this,var_220.container);
               }
               return var_1441;
            case const_1647:
               if(var_1442 == null)
               {
                  var_1442 = new OpenIssuesView(issueManager,this,var_220.container);
               }
               return var_1442;
            case const_1646:
               if(var_1443 == null)
               {
                  var_1443 = new PickedIssuesView(issueManager,this,var_220.container);
               }
               return var_1443;
            default:
               return null;
