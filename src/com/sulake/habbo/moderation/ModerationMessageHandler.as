package com.sulake.habbo.moderation
{
   ...
   public class ModerationMessageHandler
   {
      ...
      private function onCfhChatlog(param1:CfhChatlogEvent) : void
      {
         ...
         onChatlog("Call For Help Chatlog: " + _loc2_.data.chatRecordId,WindowTracker.const_961,_loc2_.data.callId,_loc3_,_loc4_);
      }
      
      private function onIssueInfo(param1:IssueInfoMessageEvent) : void
      {
         if(param1 == null || var_57 == null)
         {
            return;
         }
         ...
         var_57.issueManager.playSound(_loc3_);
         var_57.issueManager.updateIssue(_loc3_);
         var_57.issueManager.updatePriorities();
      }
      ...
      private function onUserChatlog(param1:UserChatlogEvent) : void
      {
         ...
         onChatlog("User Chatlog: " + _loc2_.data.userName,WindowTracker.const_886,_loc2_.data.userId,_loc2_.data.rooms,_loc3_);
      }
      ...
      private function onModeratorInit(param1:ModeratorInitMessageEvent) : void
      {
         ...
         {
            var_57.issueManager.updateIssue(_loc5_);
         }
         var_57.issueManager.updatePriorities();
         var_57.initMsg = _loc2_;
         var_57.startPanel.show();
      }
      ...
      private function onRoomEnter(param1:RoomEntryInfoMessageEvent) : void
      {
         ...
         if(_loc2_.guestRoom)
         {
            this.var_57.currentFlatId = _loc2_.guestRoomId;
            this.var_57.startPanel.guestRoomEntered(_loc2_);
         }
         else
         {
            this.var_57.currentFlatId = 0;
         }
         for each(_loc3_ in var_709)
         {
            _loc3_.onRoomChange();
         }
      }
      ...
      private function onIssuePickFailed(param1:IssuePickFailedMessageEvent) : void
      {
         ...
         var_57.windowManager.alert("Error","Issue picking failed",0,function(param1:IAlertDialog, param2:Event):void
         {
            param1.dispose();
         });
      }
      ...
      private function onRoomExit(param1:CloseConnectionMessageEvent) : void
      {
         var _loc2_:* = null;
         this.var_57.currentFlatId = 0;
         this.var_57.startPanel.roomExited();
      ...
      private function onRoomChatlog(param1:RoomChatlogEvent) : void
      {
         ...
         var _loc4_:Dictionary = new Dictionary();
         onChatlog("Room Chatlog: " + _loc2_.data.roomName,WindowTracker.const_564,_loc2_.data.roomId,_loc3_,_loc4_);
      }
      ...
      private function onModeratorActionResult(param1:ModeratorActionResultMessageEvent) : void
      {
         ...
         if(_loc2_.success)
         {
            var_57.connection.send(new GetModeratorUserInfoMessageComposer(_loc2_.userId));
         }
         else
         {
            var_57.windowManager.alert("Alert","Moderation action failed",0,onAlertClose);
         }
      }
      ...
      private function onIssueDeleted(param1:IssueDeletedMessageEvent) : void
      {
         ...
         var_57.issueManager.removeIssue(_loc2_.issueId);
      }
   }
}
