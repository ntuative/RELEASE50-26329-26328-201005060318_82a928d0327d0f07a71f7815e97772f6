package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1607:IMessageComposer;
      ...
      {
         var_888 = IWindowContainer(_main.getXmlWindow("chatlog_roomheader"));
         var_889 = IWindowContainer(_main.getXmlWindow("chatlog_chatline"));
         ...
         var_50 = IItemListWindow(var_52.findChildByName("chatline_list"));
         var_52.procedure = onWindow;
         var _loc1_:IWindow = var_52.findChildByTag("close");
         _loc1_.procedure = onClose;
         _main.connection.send(var_1607);
      ...
      {
         var _loc5_:* = null;
         var _loc2_:IWindowContainer = IWindowContainer(var_888.clone());
      ...
      {
         if(param1.type != WindowEvent.const_48 || param2 != var_52)
         {
            return;
         }
      ...
      {
         var _loc4_:IWindowContainer = IWindowContainer(var_889.clone());
         _loc4_.color = var_1299[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
