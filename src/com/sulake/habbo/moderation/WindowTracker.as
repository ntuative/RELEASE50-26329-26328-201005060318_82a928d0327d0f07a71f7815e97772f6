package com.sulake.habbo.moderation
{
   ...
   public class WindowTracker
   {
      ...
      public static const const_1260:int = 6;
      
      public static const const_564:int = 4;
      
      public static const TYPE_ROOMINFO:int = 9;
      
      public static const const_1151:int = 7;
      
      public static const const_961:int = 3;
      
      public static const const_1271:int = 8;
      
      public static const const_886:int = 5;
      
      public static const const_1160:int = 1;
      
      public static const const_1372:int = 2;
       
      
      private var var_1594:Dictionary;
      
      public function WindowTracker()
      {
         var_1594 = new Dictionary();
         super();
      }
      
      private function getWindowsForType(param1:int) : Dictionary
      {
         var _loc2_:Dictionary = var_1594[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            var_1594[param1] = _loc2_;
         }
         return _loc2_;
      }
