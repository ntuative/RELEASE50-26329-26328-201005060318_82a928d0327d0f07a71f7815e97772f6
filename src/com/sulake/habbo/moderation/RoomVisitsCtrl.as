package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(var_1885.clone());
      ...
      {
         var_1885 = IWindowContainer(_main.getXmlWindow("roomvisits_row"));
         ...
         var_50 = IItemListWindow(var_52.findChildByName("visits_list"));
