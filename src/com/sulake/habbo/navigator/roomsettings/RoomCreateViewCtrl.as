package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1136:Boolean = true;
      
      private var var_786:RoomLayout;
      ...
      private var var_969:TextFieldManager;
      
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_462 = new Timer(100);
         var_462.addEventListener(TimerEvent.TIMER,updateArrowPos);
         var_40 = new Array();
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_55,104,"a"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_55,94,"b"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_55,36,"c"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_55,84,"d"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_55,80,"e"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_55,80,"f"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_55,416,"i"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_55,320,"j"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_55,448,"k"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_55,352,"l"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_55,384,"m"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_55,372,"n"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_59,80,"g"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_59,74,"h"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_59,416,"o"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_59,352,"p"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_59,304,"q"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_59,336,"r"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_59,748,"u"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_59,438,"v"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_52,540,"t"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_52,512,"w"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_52,396,"x"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_52,440,"y"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_52,456,"z"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_52,208,"0"));
      }
      ...
      private function prepare() : void
      {
         ...
         var_50 = IItemListWindow(var_20.findChildByName("item_list"));
         ...
         var_969 = new TextFieldManager(_navigator,ITextFieldWindow(var_20.findChildByName("room_name_input")),25,null,_navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      private function method_6(param1:String) : RoomLayout
      {
         var _loc2_:* = null;
      ...
      public function dispose() : void
      {
         if(var_462)
         {
            var_462.removeEventListener(TimerEvent.TIMER,updateArrowPos);
            var_462.reset();
            var_462 = null;
         }
      }
      ...
      {
         var_969.goBackToInitialState();
         var_969.input.textBackgroundColor = 4294967295;
         var_786 = var_40[0];
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow("","",HabboWindowType.const_62,HabboWindowStyle.const_42,HabboWindowParam.const_72,new Rectangle(0,0,100,300)));
      }
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = var_969.getText();
      ...
      {
         var _loc1_:Boolean = var_969.checkMandatory(_navigator.getText("navigator.createroom.nameerr"));
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(var_786.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!var_1136 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            var_1136 = true;
            _loc3_.y = 1;
      ...
      private function refreshRoomThumbnails() : void
      {
         ...
         while(false)
         {
            _loc6_ = var_50.removeListItemAt(0);
            _loc6_.destroy();
         }
         for each(_loc1_ in var_40)
         {
