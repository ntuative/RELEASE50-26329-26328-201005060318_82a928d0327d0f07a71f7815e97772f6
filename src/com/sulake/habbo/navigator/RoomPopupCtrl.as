package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         var_1870 = new RoomThumbnailRenderer(param1);
         var_864 = new TagRenderer(param1,hideInstantly);
      }
      
      private function refreshOwnerName() : void
      {
         refreshTextWithCaption("roomowner",var_176,var_116.ownerName);
         var _loc1_:ITextWindow = ITextWindow(var_176.findChildByName("roomowner"));
         if(true)
         {
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(var_176.findChildByName("extra_cont"));
         Util.hideChildren(_loc1_);
         var_864.refreshTags(_loc1_,var_116.tags);
         refreshTextWithCaption("rating",_loc1_,"undefined");
         if(false)
         {
            refreshTextWithCaption("startedat",_loc1_,"undefined");
         }
         var_1870.refreshThumbnail(_loc1_,var_116.thumbnail,false);
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         if(var_176 == null)
         {
            var_176 = IWindowContainer(param1.findChildByName("details_container"));
         }
         var_176.visible = true;
         Util.hideChildren(var_176);
         refreshRoomName(var_176,var_116);
         if(true)
         {
         }
         refreshOwnerName();
         refreshTextWithCaption("roomctg",var_176,!true ? getEventCtg(var_116.categoryId) : getRoomCtg(var_116.categoryId));
         refreshRoomDesc(var_176,var_116);
         refreshExtraCont();
         refreshInfo(var_176,"trading_allowed",var_116.allowTrading);
         refreshInfo(var_176,"doormode_doorbell",false);
         refreshInfo(var_176,"doormode_password",false);
         Util.moveChildrenToColumn(var_176,["roomname","roomctg_cont","roomowner_cont","roomdesc","extra_cont","doormode_doorbell","doormode_password","trading_allowed"],0,0);
         var_176.height = Util.getLowestPoint(var_176);
      }
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_198,Tabs.const_224,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
