package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      {
         var_358 = new Timer(500,1);
         var_313 = new Timer(100,1);
         super();
         _navigator = param1;
         var_1239 = param4;
         var_1729 = param2;
         _popupIndentLeft = param3;
         var_358.addEventListener(TimerEvent.TIMER,onDisplayTimer);
      ...
      public function dispose() : void
      {
         ...
         if(var_358)
         {
            var_358.removeEventListener(TimerEvent.TIMER,onDisplayTimer);
            var_358.reset();
            var_358 = null;
         }
         if(var_313)
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(var_49 == null)
         {
            var_49 = IWindowContainer(_navigator.getXmlWindow(var_1239));
            var_49.visible = false;
         ...
         var_49.x = _loc2_.x + var_1729 + param1.width;
