package com.sulake.habbo.navigator
{
   ...
   public class Util
   {
      ...
      private static var var_1454:CutToHeight = new CutToHeight();
      
      private static var var_1455:CutToWidth = new CutToWidth();
      ...
      {
         var _loc4_:IWindow = param1.findChildByName(param2);
         _loc4_.setParamFlag(HabboWindowParam.const_44,true);
      ...
      public static function cutTextToHeight(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1454.beforeSearch(param2,param1,param3);
         binarySearch(var_1454,param2.length - 1);
      }
      ...
      public static function cutTextToWidth(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1455.beforeSearch(param2,param1,param3);
         binarySearch(var_1455,param2.length - 1);
      }
   }
}
