package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class MyRoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_509:IDropMenuWindow;
      ...
      private function getSearchTypeForIndex(param1:int) : int
      {
         if(param1 == 1)
         {
            return Tabs.const_707;
         }
         if(param1 == 2)
         {
            return Tabs.const_718;
         }
         if(param1 == 3)
         {
            return Tabs.const_715;
         }
         if(param1 == 4)
         {
            return Tabs.const_702;
         }
         return Tabs.const_220;
      }
      
      private function startSearch() : void
      {
         var _loc1_:int = var_509 == null ? 0 : int(var_509.selection);
         Logger.log("Me subNavi selection changed: " + _loc1_);
         _navigator.mainViewCtrl.startSearch(Tabs.const_247,getSearchTypeForIndex(_loc1_));
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_509 == null)
         {
            var_509 = IDropMenuWindow(_loc3_.findChildByName("meSubNavi"));
            var_509.procedure = onChangeSubNavi;
            prepareSubNavi();
         }
         _loc3_.visible = true;
      }
