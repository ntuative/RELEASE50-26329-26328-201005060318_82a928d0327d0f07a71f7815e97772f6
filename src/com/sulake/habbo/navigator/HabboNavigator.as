package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_2386:Dictionary;
      ...
      private var var_827:RoomCreateViewCtrl;
      
      private var var_1870:RoomThumbnailRenderer;
      
      private var var_195:IHabboToolbar;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_584:RoomInfoViewCtrl;
      ...
      private var var_1032:GuestRoomPasswordInput;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_266 = new MainViewCtrl(this);
         var_584 = new RoomInfoViewCtrl(this);
         var_827 = new RoomCreateViewCtrl(this);
         var_1870 = new RoomThumbnailRenderer(this);
         var_1032 = new GuestRoomPasswordInput(this);
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_266.startSearch(Tabs.const_198,Tabs.const_321,param1);
         var_266.mainWindow.activate();
      }
      ...
      public function animateWindowOpen(param1:IWindowContainer) : void
      {
         ...
         {
            var_195.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_51,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var _loc3_:String = var_153.getKey("navigator.default_tab");
         switch(_loc3_)
         {
            case "popular":
               _loc4_ = 0;
      ...
      private function setHabboToolbarIcon() : void
      {
         if(var_195 != null)
         {
            var_195.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_117,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.settings != null && this._data.settings.homeRoomId > 0)
            {
               var_195.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_117,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(_windowManager.createWindow(param1,"",HabboWindowType.BITMAP_WRAPPER,HabboWindowStyle.const_43,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      public function showOwnRooms() : void
      {
         ...
         var_266.startSearch(Tabs.const_247,Tabs.const_220);
         var_394.getTab(Tabs.const_247).tabPageDecorator.tabSelected();
      }
      ...
      {
         var _loc1_:Boolean = var_266.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
