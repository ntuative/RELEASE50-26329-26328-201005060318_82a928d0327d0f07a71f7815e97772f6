package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailRenderer
   {
      ...
      private static const const_1062:int = -16;
      
      private static const const_766:int = 32;
      
      private static const const_1063:int = 8;
      
      public static const const_442:int = 10;
      
      private static const const_1064:int = 40;
      ...
      private var var_818:ThumbnailImageConfigurations;
      
      private var var_1199:BitmapData;
      ...
      public function RoomThumbnailRenderer(param1:HabboNavigator)
      {
         ...
         super();
         _navigator = param1;
         var_818 = new ThumbnailImageConfigurations(_navigator);
      ...
      public function refreshThumbnail(param1:IWindowContainer, param2:RoomThumbnailData, param3:Boolean) : void
      {
         ...
         if(_loc5_ == null)
         {
            ...
            _loc5_ = IBitmapWrapperWindow(_navigator.windowManager.createWindow("bitmap","",HabboWindowType.BITMAP_WRAPPER,HabboWindowStyle.const_43,0 | (!!param3 ? HabboWindowParam.const_44 : HabboWindowParam.const_43),new Rectangle(0,0,_loc7_.width,_loc7_.height)));
      ...
      {
         var _loc3_:ThumbnailImageConfiguration = this.var_818.getImage(ThumbnailEditorModel.const_36,param2.imgId);
         if(_loc3_ == null)
         {
         ...
         var _loc4_:Point = this.getScreenLocForPos(param2.method_1);
         if(_loc4_ == null)
         {
            Logger.log("Unknown object position: " + param2.method_1);
            return;
         }
         ...
         Logger.log("Drawing object: " + param2.method_1 + ", " + _loc4_);
         param1.copyPixels(_loc5_,_loc5_.rect,new Point(_loc4_.x + const_1062,_loc4_.y + const_1064 - _loc5_.height),null,null,true);
      }
      ...
      {
         return Point(this.var_1831[param1]);
      }
      ...
      private function refreshBg(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_818.getImage(ThumbnailEditorModel.const_41,param2);
         if(_loc3_ == null)
         {
            Logger.log("Unknown bg image id: " + param2);
            _loc3_ = this.var_818.getImage(ThumbnailEditorModel.const_41,1);
         }
      ...
      private function refreshFront(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_818.getImage(ThumbnailEditorModel.const_58,param2);
         if(_loc3_ == null)
         {
      ...
      {
         var _loc3_:int = param2 % 2 == 0 ? 0 : int(const_766 / 2);
         return new Point(param1 * const_766 + _loc3_,param2 * const_1063);
      }
      ...
      private function refreshObjects(param1:BitmapData, param2:Array) : void
      {
         ...
         var _loc4_:* = null;
         _loc3_ = 0;
         while(_loc3_ <= const_442)
         {
            var_1000[_loc3_] = null;
            _loc3_++;
         }
         for each(_loc4_ in param2)
         {
            var_1000[_loc4_.method_1] = _loc4_;
         }
         _loc3_ = 0;
         while(_loc3_ <= const_442)
         {
            if(false)
            {
               refreshObj(param1,var_1000[_loc3_]);
            }
            _loc3_++;
         }
      }
      ...
      private function refreshCover(param1:BitmapData) : void
      {
         if(var_1199 == null)
         {
            var_1199 = _navigator.getButtonImage("rico_rnd");
         }
         param1.copyPixels(var_1199,var_1199.rect,new Point(0,0),null,null,true);
      }
   }
}
