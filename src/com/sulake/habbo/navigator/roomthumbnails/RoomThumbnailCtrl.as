package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_1833:IWindowContainer;
      ...
      {
         setEnabled(_bgTabButton,this._model.mode != ThumbnailEditorModel.const_41);
         setEnabled(var_1456,this._model.mode != ThumbnailEditorModel.const_58);
         setEnabled(var_1457,this._model.mode != ThumbnailEditorModel.const_36);
      }
      ...
      private function onBgTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this._model.mode = ThumbnailEditorModel.const_41;
         this.reload();
      }
      ...
      private function onSaveButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            _loc5_.addObj(_loc4_.method_1,_loc4_.imgId);
         }
      ...
      private function onTopTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this._model.mode = ThumbnailEditorModel.const_58;
         this.reload();
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1456 = IButtonWindow(find("top_tab"));
         var_1457 = IButtonWindow(find("obj_tab"));
         var_1833 = IWindowContainer(find("tile_grid"));
         var_1832 = IWindowContainer(find("now_editing_container"));
         ...
         Util.setProcDirectly(var_1456,onTopTabButton);
         Util.setProcDirectly(var_1457,onObjTabButton);
      }
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = var_1833;
         _loc1_.visible = true;
         if(_loc1_.numChildren == 0)
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_442)
            {
         ...
         _loc2_.visible = true;
         refreshTileLoc(_loc2_,_model.selected.method_1);
      ...
      {
         var _loc1_:IWindowContainer = var_1832;
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(_navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_62,HabboWindowStyle.const_42,HabboWindowParam.const_72,new Rectangle(0,0,param1.width,66)));
               param1.addListItem(_loc7_);
            }
            _loc10_ = _loc6_[_loc8_];
            _loc11_ = IBitmapWrapperWindow(_navigator.windowManager.createWindow("img_" + _loc8_,"",HabboWindowType.BITMAP_WRAPPER,HabboWindowStyle.const_43,0 | 0,new Rectangle(_loc9_ * 66,0,66,66),onImgSel,_loc10_.id));
      ...
      {
         refreshImgSelector(ThumbnailEditorModel.const_41);
         refreshImgSelector(ThumbnailEditorModel.const_58);
