package com.sulake.habbo.session.handler
{
   ...
   public class RoomDataHandler extends BaseHandler
   {
      ...
      private function onRoomResult(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:IRoomSession = listener.getSession(_xxxRoomId,var_35);
         if(_loc4_ == null)
         {
            return;
         }
         ...
         listener.events.dispatchEvent(new RoomSessionPropertyUpdateEvent(RoomSessionPropertyUpdateEvent.const_410,_loc4_));
      }
   }
}
