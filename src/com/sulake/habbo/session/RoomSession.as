package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private var var_33:String = "RSE_CREATED";
      
      private var var_1110:UserDataManager;
      ...
      {
         if(var_33 == RoomSessionEvent.const_317 && _connection != null)
         {
            var_33 = RoomSessionEvent.const_98;
            if(isPrivateRoom)
            {
      ...
      {
         return var_1110 as IUserDataManager;
      }
