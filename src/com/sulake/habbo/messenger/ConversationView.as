package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1136:int = 10;
      
      private static const const_1137:int = 20;
      
      private static const const_801:int = 100;
       
      
      private var var_2276:IScrollbarWindow;
      
      private var var_131:HabboMessenger;
      
      private var var_1608:IContainerButtonWindow;
      
      private var var_544:Conversation;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         var_131 = param1;
         var_1608 = initButton("follow_friend",onFollowButtonClick,param2);
         var_50 = IItemListWindow(param2.findChildByName("msg_list"));
         var_2276 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_649 || param3.type == Message.const_648 ? param3.time + ": " : "";
      ...
      private function refreshList() : void
      {
         ...
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,var_544.messages.length - const_801);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < var_544.messages.length)
         {
            refreshEntry(true,_loc1_,var_544.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      public function refresh() : void
      {
         ...
         if(var_544 == null || _loc1_.id != var_544.id)
         {
            var_544 = _loc1_;
            refreshList();
            afterResize();
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_801 + const_1137)
         {
            refreshList();
            afterResize();
         }
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_131.send(new FollowFriendMessageComposer(var_544.id));
      }
      ...
      private function getChatBgColor(param1:int) : uint
      {
         ...
         if(param1 == Message.const_648)
         {
            return 4292801535;
         }
         if(param1 == Message.const_1009)
         {
            return 4294927974;
         }
         if(param1 == Message.const_692)
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1136;
         param1.invalidate();
      }
   }
}
