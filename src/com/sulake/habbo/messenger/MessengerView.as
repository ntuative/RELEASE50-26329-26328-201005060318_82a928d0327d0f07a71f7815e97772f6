package com.sulake.habbo.messenger
{
   ...
   public class MessengerView implements IDisposable
   {
      ...
      private var var_782:ConversationsTabView;
      
      private var _disposed:Boolean = false;
      
      private var var_131:HabboMessenger;
      
      private var var_1134:ConversationView;
      ...
      private function onResizeTimer(param1:TimerEvent) : void
      {
         ...
         this.var_1134.afterResize();
         this.var_782.refresh();
      }
      ...
      private function sendMsg() : void
      {
         ...
         var_703.text = "";
         var_131.conversations.addMessageAndUpdateView(new Message(Message.const_649,_loc2_.id,_loc1_,Util.getFormattedNow()));
      }
      ...
      public function openMessenger() : void
      {
         ...
         if(var_14 == null)
         {
            prepareContent();
            refresh(true);
            var_131.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_51,HabboToolbarIconEnum.MESSENGER,var_14));
         }
         else
         {
            refresh(true);
      ...
      {
         return this.var_782 == null ? 7 : int(this.var_782.getTabCount());
      }
      ...
      private function prepareContent() : void
      {
         ...
         var_782 = new ConversationsTabView(var_131,var_14);
         var_782.refresh();
         var_703 = ITextFieldWindow(var_14.findChildByName("message_input"));
         var_703.addEventListener(WindowKeyboardEvent.const_146,onMessageInput);
         var_1134 = new ConversationView(var_131,var_14);
         var_14.scaler.setParamFlag(HabboWindowParam.const_552,false);
         var_14.scaler.setParamFlag(HabboWindowParam.const_1021,true);
      }
   }
}
