package com.sulake.habbo.messenger.domain
{
   ...
   public class Conversations
   {
      ...
      private static var var_1316:int = 1;
      ...
      public function addConversation(param1:int) : Conversation
      {
         ...
         if(false)
         {
            var_133[0].setSelected(true);
         }
         if(_loc2_)
         {
            _loc3_.addMessage(new Message(Message.const_692,0,var_442.getText("messenger.moderationinfo"),""));
         }
         return _loc3_;
      }
      ...
      public function closeConversation() : void
      {
         ...
         var _loc2_:int = var_133.indexOf(_loc1_);
         Util.remove(var_133,_loc1_);
         ...
         while(_loc2_ >= 0)
         {
            if(false)
            {
               var_133[_loc2_].setSelected(true);
               break;
            }
            _loc2_--;
         }
      ...
      public function setSelected(param1:Conversation) : void
      {
         ...
         var _loc2_:int = var_133.indexOf(param1);
      ...
      {
         return new Message(Message.const_576,0,getOnlineText(param1),Util.getFormattedNow());
      }
      ...
      public function addMessageAndUpdateView(param1:Message) : void
      {
         ...
         if(_loc2_ != var_133.length || _loc4_ != _loc3_.newMessageArrived)
         {
            var_442.refresh(false);
         }
      }
