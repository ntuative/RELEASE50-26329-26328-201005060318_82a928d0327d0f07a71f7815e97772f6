package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      private var var_664:FaqCategory;
      
      private var var_663:FaqCategory;
      ...
      {
         super();
         var_663 = new FaqCategory(-999,"${help.faq.title.urgent}");
         _frontPageNormal = new FaqCategory(-9999,"${help.faq.title.normal}");
         var_664 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
         var_124 = new Map();
      }
      ...
      {
         var _loc4_:* = null;
         if(var_663.hasItem(param1))
         {
            var_663.getItem(param1).answerText = param2;
         }
         if(_frontPageNormal.hasItem(param1))
         {
            _frontPageNormal.getItem(param1).answerText = param2;
         }
         if(var_664.hasItem(param1))
         {
            var_664.getItem(param1).answerText = param2;
         }
         var _loc3_:int = 0;
