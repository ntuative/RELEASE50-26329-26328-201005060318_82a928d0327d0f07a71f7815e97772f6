package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private static const const_1423:int = 0;
      ...
      private var var_1991:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         _windowManager.registerLocalizationParameter("info.client.version","version","26329-26328-201005060241");
         var_195 = param5;
         var_101 = new Map();
         var_101.add(HabboHelpViewEnum.const_1337,IHelpViewController(new PlaceholderView(this,_windowManager,_assetLibrary)));
         var_101.add(HabboHelpViewEnum.const_152,IHelpViewController(new HelpMainView(this,_windowManager,_assetLibrary)));
         var_101.add(HabboHelpViewEnum.const_472,IHelpViewController(new FaqBrowseTopView(this,_windowManager,_assetLibrary)));
         var_101.add(HabboHelpViewEnum.const_270,IHelpViewController(new FaqBrowseCategoryView(this,_windowManager,_assetLibrary)));
         var_101.add(HabboHelpViewEnum.const_230,IHelpViewController(new FaqBrowseEntry(this,_windowManager,_assetLibrary)));
         var_101.add(HabboHelpViewEnum.const_562,IHelpViewController(new FaqBrowseSearchResults(this,_windowManager,_assetLibrary)));
         var_101.add(HabboHelpViewEnum.const_288,IHelpViewController(new CallForHelpTopicSelection(this,_windowManager,_assetLibrary)));
         var_101.add(HabboHelpViewEnum.const_533,IHelpViewController(new CallForHelpTextInput(this,_windowManager,_assetLibrary)));
         var_101.add(HabboHelpViewEnum.const_234,IHelpViewController(new CallForHelpSentView(this,_windowManager,_assetLibrary,"help_cfh_thanks")));
         ...
         var_101.add(HabboHelpViewEnum.const_998,IHelpViewController(new CallForHelpPendingItemView(this,_windowManager,_assetLibrary)));
         var_101.add(HabboHelpViewEnum.const_620,IHelpViewController(new CallForHelpReportUserSelection(this,_windowManager,_assetLibrary)));
      }
      ...
      private function createWindow() : void
      {
         ...
         var_1517 = 0 - _loc3_.width;
         var_1518 = _window.height;
      }
      ...
      private function addBackButtonWindow() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(var_273 == HabboHelpViewEnum.const_152 || false)
         {
            return;
         }
         if(var_427 == null)
         {
            ...
            var_427 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
         }
         var _loc1_:IItemListWindow = _window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || var_427 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(var_427 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(var_427 as IWindow);
      ...
      {
         return var_101.getValue(var_273);
      }
      ...
      {
         var_1993 = param1;
         var _loc2_:IHelpViewController = var_101.getValue(HabboHelpViewEnum.const_152) as IHelpViewController;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_234:
               showUI(HabboHelpViewEnum.const_234);
               break;
            case CallForHelpResultEnum.const_1017:
               showUI(HabboHelpViewEnum.const_998);
               break;
            case CallForHelpResultEnum.const_806:
      ...
      {
         var _loc3_:* = null;
         if(var_273 == HabboHelpViewEnum.const_152)
         {
            return;
         }
         if(true)
         {
            ...
            var_599.push(_loc3_.content as BitmapData);
            _loc3_ = _assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            var_599.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = var_427.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(var_599[1],var_599[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(var_599[0],var_599[0].rect,new Point(0,0));
         }
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         _window.height = _loc1_.height + var_1518;
         _window.width = _loc1_.width + var_1517;
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         if(_loc3_)
         {
            if(var_195 != null)
            {
               var_195.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_51,HabboToolbarIconEnum.HELP,_window));
            }
         }
      ...
      public function handleCallGuideBot() : void
      {
         ...
         hideUI();
         var_22.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_388));
      }
