package com.sulake.habbo.help.cfh
{
   ...
   public class CallForHelpTopicSelection extends HelpViewController implements IHelpViewController
   {
      ...
      private static const const_1139:int = 0;
      
      private static const const_358:int = 1;
      ...
      private function handleListItemClick(param1:IWindow) : void
      {
         ...
         if(var_773 == null || _loc3_ < 0 || _loc3_ >= var_773.length)
         {
            return;
         }
         if(_loc3_ > -1)
         {
            main.component.callForHelpData.topicIndex = var_773[_loc3_];
            main.showUI(HabboHelpViewEnum.const_533);
            main.tellUI(HabboHelpViewEnum.const_533,null);
         }
      }
   }
}
