package com.sulake.habbo.help.cfh
{
   ...
   public class CallForHelpReportUserSelection extends HelpViewController
   {
      ...
      override public function update(param1:* = null) : void
      {
         ...
         var_569 = main.component.userRegistry.getRegistry();
         if(false)
         {
            main.showUI(HabboHelpViewEnum.const_152);
         ...
         var i:int = 0;
         while(i < var_569.length)
         {
            u = var_569.getWithIndex(i);
      ...
      private function handleListItemClick(param1:IWindow) : void
      {
         ...
         if(_loc3_ < 0 || _loc3_ > var_569.length)
         {
            return;
         }
         var _loc4_:UserRegistryItem = var_569.getWithIndex(_loc3_);
         if(_loc4_ == null)
         {
            return;
         }
