package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public static const const_204:String = "TUI_NAME_VIEW";
      
      public static const const_87:String = "TUI_MAIN_VIEW";
      
      public static const const_341:String = "TUI_CLOTHES_VIEW";
      
      public static const const_458:String = "TUI_GUIDEBOT_VIEW";
      ...
      public function TutorialUI(param1:HabboHelp)
      {
         super();
         _main = param1;
         _main.events.addEventListener(HabboHelpTutorialEvent.const_388,onTaskDoneEvent);
         _main.events.addEventListener(HabboHelpTutorialEvent.const_380,onTaskDoneEvent);
         _main.events.addEventListener(HabboHelpTutorialEvent.const_466,onTaskDoneEvent);
      }
      ...
      public function update(param1:Boolean, param2:Boolean, param3:Boolean) : void
      {
         ...
         var_971 = param2;
         var_972 = param3;
         if(var_37 == null || var_37.id == const_87)
         {
            prepareForTutorial();
            showView(const_87);
         }
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         if(var_37 != null && (var_37.id == const_204 || var_37.id == const_87))
         {
            showView(const_87);
         }
      }
      ...
      public function showView(param1:String) : void
      {
         ...
         _window.height = _loc2_.height + var_1518;
         _window.width = _loc2_.width + var_1517;
         if(_loc3_)
         {
            if(_window == null)
            {
      ...
      public function dispose() : void
      {
         ...
         if(_main)
         {
            _main.events.removeEventListener(HabboHelpTutorialEvent.const_388,onTaskDoneEvent);
            _main.events.removeEventListener(HabboHelpTutorialEvent.const_380,onTaskDoneEvent);
            _main.events.removeEventListener(HabboHelpTutorialEvent.const_466,onTaskDoneEvent);
            _main = null;
         }
      }
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_388:
               var_972 = true;
               if(var_37 != null && var_37.id == const_458)
               {
                  showView(const_87);
               }
               break;
            case HabboHelpTutorialEvent.const_380:
               if(var_37 != null && var_37.id == const_341)
               {
                  var_1138 = true;
                  disposeWindow();
               }
               break;
            case HabboHelpTutorialEvent.const_466:
               if(var_1138)
               {
                  var_1138 = false;
                  showView(const_87);
      ...
      {
         var_970 = true;
         if(var_37 != null && (var_37.id == const_341 || var_37.id == const_87))
         {
            showView(const_87);
         }
      }
      ...
      {
         return var_970 && var_971 && var_972;
      }
   }
}
