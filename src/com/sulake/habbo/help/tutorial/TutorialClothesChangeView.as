package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialClothesChangeView implements ITutorialUIView
   {
      ...
      private var var_563:IWindowContainer;
      ...
      public function TutorialClothesChangeView(param1:IItemListWindow, param2:TutorialUI)
      {
         ...
         _main.help.toolbar.events.addEventListener(HabboToolbarShowMenuEvent.const_51,onShowMenuEvent);
         _main.prepareForTutorial();
      }
      
      public function get id() : String
      {
         return TutorialUI.const_341;
      }
      ...
      private function windowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param2.name)
         {
            case "button_cancel":
               ...
               {
                  _main.showView(TutorialUI.const_87);
               }
         }
      }
      ...
      private function showToolbarIconHighlightArrow() : void
      {
         ...
         var_563 = _main.buildXmlWindow("tutorial_arrow") as IWindowContainer;
         var _loc1_:IBitmapWrapperWindow = var_563.findChildByName("arrow") as IBitmapWrapperWindow;
         if(_loc1_ != null)
         {
         ...
         _main.help.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_51,HabboToolbarIconEnum.MEMENU_ARROW,var_563));
      }
      ...
      {
         if(param1.menuId == HabboToolbarIconEnum.MEMENU && param1.type == HabboToolbarShowMenuEvent.const_51)
         {
            setToolbarIconHighlight(false);
            hideToolbarIconHighlightArrow();
            _main.help.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_451));
         }
      }
      ...
      {
         var _loc2_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_166,HabboToolbarIconEnum.MEMENU);
         if(param1)
         {
      ...
      {
         setToolbarIconHighlight(false);
         _main.help.toolbar.events.removeEventListener(HabboToolbarShowMenuEvent.const_51,onShowMenuEvent);
      }
   }
}
