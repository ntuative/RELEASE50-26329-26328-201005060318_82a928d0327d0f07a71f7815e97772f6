package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialNameChangeView implements ITutorialUIView
   {
      ...
      private var var_279:IBorderWindow;
      ...
      public function setNameAvailableView() : void
      {
         ...
         _main.localization.registerParameter("help.tutorial.name.available","name",var_376);
      ...
      private function showConfirmationView(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            _main.localization.registerParameter("help.tutorial.name.confirmation","name",var_376);
         }
         if(var_279 == null)
         {
            var_279 = _main.buildXmlWindow("tutorial_change_name_confirmation") as IBorderWindow;
            if(var_279 == null)
            {
               return;
            }
            ...
            _loc2_.addChild(var_279);
            var_279.procedure = confirmationViewEventHandler;
         }
         _window.visible = !param1;
         var_279.visible = param1;
      }
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         _loc5_.visible = true;
         var_920 = new NameSuggestionListRenderer(_main);
