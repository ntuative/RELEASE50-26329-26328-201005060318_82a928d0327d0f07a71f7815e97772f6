package com.sulake.habbo.localization
{
   ...
   public class HabboLocalizationManager extends CoreLocalizationManager implements IHabboLocalizationManager
   {
      ...
      public function HabboLocalizationManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.events.addEventListener(com.sulake.core.localization.enum.LocalizationEvent.const_96,onLocalizationLoaded);
      }
      ...
      private function onConfigurationReady(param1:Event = null) : void
      {
         ...
         if("false" == var_153.getKey("use.default.localizations","false"))
         {
            _loc4_ = var_153.getKey("external.texts.txt","external_texts.txt");
            super.loadLocalizationFromURL(_loc4_);
         }
         var _loc3_:int = 1;
         while(var_153.keyExists("localization." + _loc3_))
         {
            _loc5_ = var_153.getKey("localization." + _loc3_,"");
            _loc6_ = var_153.getKey("localization." + _loc3_ + ".name","");
            _loc7_ = var_153.getKey("localization." + _loc3_ + ".url","");
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            (var_153 as Component).events.addEventListener(HabboConfigurationEvent.INIT,onConfigurationReady);
         }
      }
      ...
      {
         events.dispatchEvent(new Event(com.sulake.habbo.localization.enum.LocalizationEvent.const_96));
      }
   }
}
