package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_351:uint = 3;
      
      private static var _instance:IHabboWindowManager;
      
      private static const const_1086:uint = 1;
       
      
      private var var_652:ISkinContainer;
      
      private var var_236:Array;
      
      private var var_2396:Array;
      ...
      private var var_1279:ProfilerAgentTask;
      
      private var var_1277:IEventDispatcher;
      
      private var var_2397:uint = 0;
      
      private var var_1278:ProfilerAgentTask;
      
      private var var_1276:ProfilerOutput;
      
      private var var_714:IWindowRenderer;
      ...
      public function HabboWindowManagerComponent(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         _instance = this;
         var_1277 = Component(param1).events;
         var_431 = new Array();
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         var_652 = new SkinContainer(_loc3_.content as XML,assets);
         var_714 = new WindowRenderer(var_652);
         var_236 = new Array(const_351);
         var _loc5_:int = 0;
         while(_loc5_ < const_351)
         {
            _loc4_ = new WindowContext("layer_" + _loc5_,var_714,this,_localization,context.displayObjectContainer,new Rectangle(0,0,context.displayObjectContainer.stage.stageWidth,context.displayObjectContainer.stage.stageHeight),this);
            var_236[_loc5_] = _loc4_;
            _loc5_++;
         }
         _windowContext = var_236[const_1086];
         registerUpdateReceiver(this,0);
         _loc6_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         _windowContext.getMouseCursor().defineCustomCursorType(MouseCursorType.const_327,_loc6_);
         _loc6_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         _windowContext.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1375,_loc6_);
      }
      ...
      {
         return var_236[param1].getDesktopWindow().getChildAt(_windowContext.getDesktopWindow().numChildren - 1);
      }
      
      public function getLayoutByTypeAndStyle(param1:uint, param2:uint) : XML
      {
         var _loc3_:Dictionary = var_431[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? var_431[0][param1] as XML : _loc4_;
      }
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(var_1276 == null)
         {
            ...
            if(_loc3_ != null)
            {
               var_1276 = new ProfilerOutput(_loc3_,this,var_714);
               var_1279 = new ProfilerAgentTask("Update","Event processing");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1279);
               var_1278 = new ProfilerAgentTask("Redraw","Window rasterizer");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1278);
               var_1058 = true;
            }
         }
      }
      ...
      {
         return var_652.getDefaultAttributesByTypeAndStyle(param1,param2);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_945.length > 0)
         {
            var_1277.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_351 - 1;
            while(_loc2_ >= 0)
            {
         ...
         var_1277.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_351)
         {
         ...
         if(WindowContext.var_945.length > 0)
         {
            WindowContext.var_945.flush();
         }
         if(WindowContext.var_1385.length > 0)
         {
            WindowContext.var_1385.flush();
         }
         var_1277.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1335,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1376,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1204,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1347,param2.name + ": " + param2.toString());
            }
         }
      }
   }
