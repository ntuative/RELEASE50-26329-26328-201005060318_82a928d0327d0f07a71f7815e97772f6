package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      public function AchievementNotification(param1:String, param2:int, param3:IAssetLibrary, param4:IHabboWindowManager, param5:IHabboLocalizationManager, param6:IHabboConfigurationManager, param7:ISessionDataManager)
      {
         ...
         var_1674 = param2;
         var_344 = param7;
         param7.events.addEventListener(BadgeImageReadyEvent.const_109,onBadgeImageReady);
         ...
         var_197 = param5.getKey("notifications.text.achievement");
         registerBadgeParameters("notifications.text.achievement_facebook");
         var_1987 = param5.getKey("notifications.text.achievement_facebook");
         setText("achievement_info",var_197);
      ...
      public function dispose() : void
      {
         if(var_344 != null)
         {
            var_344.events.removeEventListener(BadgeImageReadyEvent.const_109,onBadgeImageReady);
            var_344 = null;
         }
         if(_window != null)
         {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               if(false)
               {
                  ExternalInterface.call("FlashExternalInterface.postAchievement",var_707,var_1987);
               }
               dispose();
               break;
      ...
      {
         _localizations.registerParameter(param1,"badge_name",_localizations.getKey("badge_name_" + var_707,var_707));
         _localizations.registerParameter(param1,"badge_desc",_localizations.getKey("badge_desc_" + var_707,var_707));
         _localizations.registerParameter(param1,"level",var_1674.toString());
         _localizations.registerParameter(param1,"name",var_344.userName);
         _localizations.registerParameter(param1,"realname",var_344.realName);
      }
   }
}
