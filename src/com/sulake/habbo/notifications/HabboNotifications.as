package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1057:String = "badges";
      
      private static const const_1056:String = "pet_inventory";
      
      private static const const_1052:String = "pixelbalance";
      
      private static const const_1054:String = "credits";
      
      private static const const_1051:String = "inventory";
      
      private static const const_1053:String = "friendlist";
      
      private static const const_1058:String = "selectfurni";
      
      private static const const_1055:String = "selectbadge";
       
      
      private var _assetLibrary:IAssetLibrary;
      
      private var var_576:ParkBusDialogManager;
      
      private var var_574:IHabboToolbar;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _roomEngine:IRoomEngine;
      
      private var var_398:HabboNotificationViewManager;
      
      private var var_676:ClubEndingNotification;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),var_808);
         }
         var _loc6_:Map = var_808["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1354);
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         var_675 = new ClubGiftNotification(_loc2_.numGifts,_assets,_windowManager,_catalog);
      }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_842)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1332);
         }
      ...
      override public function dispose() : void
      {
         ...
         if(var_575)
         {
            var_575.release(new IIDAvatarRenderManager());
            var_575 = null;
         }
         if(_catalog)
         {
         ...
         if(var_574)
         {
            var_574.release(new IIDHabboToolbar());
            var_574 = null;
         }
         if(_windowManager)
         {
         ...
         switch(param1)
         {
            ...
            case CatalogPageMessageProductData.const_84:
               ...
               else
               {
                  switch(_loc7_)
                  {
                     case FurniCategory.const_301:
                        _loc4_ = (var_11 as Component).assets.getAssetByName("icon_wallpaper_png") as BitmapDataAsset;
                        if(_loc4_ != null)
                        {
                           _loc6_ = (_loc4_.content as BitmapData).clone();
                        }
                        break;
                     case FurniCategory.const_326:
                        _loc4_ = (var_11 as Component).assets.getAssetByName("icon_landscape_png") as BitmapDataAsset;
                        if(_loc4_ != null)
                        {
                           _loc6_ = (_loc4_.content as BitmapData).clone();
                        }
                     ...
                     case FurniCategory.const_296:
                        _loc4_ = (var_11 as Component).assets.getAssetByName("icon_floor_png") as BitmapDataAsset;
                        if(_loc4_ != null)
                        {
                           _loc6_ = (_loc4_.content as BitmapData).clone();
                        }
               ...
               break;
            case CatalogPageMessageProductData.const_228:
               _loc4_ = (var_11 as Component).assets.getAssetByName("fx_icon_" + param2 + "_png") as BitmapDataAsset;
               if(_loc4_ != null)
               {
                  _loc6_ = (_loc4_.content as BitmapData).clone();
               }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!var_1795)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_1000);
            var_1795 = true;
      ...
      public function onExecuteLink(param1:String) : void
      {
         switch(param1)
         {
            ...
            case const_1057:
               if(var_11 != null)
               {
                  var_11.toggleInventoryPage(InventoryCategory.const_257);
               }
               break;
            case const_1055:
               break;
            ...
            case const_1056:
               if(var_11)
               {
                  var_11.toggleInventoryPage(InventoryCategory.const_142);
               }
               break;
            case const_1058:
               break;
      ...
      {
         if(param1 != null && this.var_398 != null)
         {
            var_398.replaceIcon(param1);
         }
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         addItem(_loc5_,NotificationType.const_1000,_loc6_);
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_575.createPetImageFromFigure(_loc2_.pet.figure,AvatarScaleType.const_56);
         if(_loc4_ == null)
         {
            return;
         }
         _loc4_.setDirection(AvatarSetType.const_40,3);
         var _loc5_:BitmapData = _loc4_.getCroppedImage(AvatarSetType.const_49);
         _loc4_.dispose();
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1024,_loc5_);
         }
      }
      
      public function onAlert(param1:IAlertDialog, param2:WindowEvent) : void
      {
         if(param2.type == WindowEvent.const_177 || param2.type == WindowEvent.const_520)
         {
            param1.dispose();
         }
      }
      ...
      {
         if(var_398.isSpaceAvailable() && false)
         {
            var_398.showItem(getNextItemFromQueue());
         }
      }
      
      private function method_11(param1:IMessageEvent) : void
      {
         var _loc2_:ParkBusCannotEnterMessageParser = (param1 as ParkBusCannotEnterMessageEvent).getParser();
         if(var_576 == null)
         {
            var_576 = new ParkBusDialogManager(_windowManager,assets,_localization);
         }
         if(_loc2_ != null || var_576 != null)
         {
            var_576.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = var_997.splice(0,1);
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_575.createPetImageFromFigure(_loc2_.figure,AvatarScaleType.const_56);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         new AchievementNotification(_loc2_.badgeID,_loc2_.level,_assets,_windowManager,_localization,_config,var_344);
      }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc8_)
            {
               ...
               {
                  _loc9_ = var_344.getFloorItemData(_loc8_.furniClassId);
               }
               else if(_loc8_.productType == CatalogPageMessageProductData.const_84)
               {
                  _loc9_ = var_344.getWallItemData(_loc8_.furniClassId);
               }
               _loc5_ = getProductImage(_loc8_.productType,_loc8_.furniClassId,_loc8_.extraParam);
            }
            _loc6_ = var_344.getProductData(_loc4_.localizationId);
         }
         if(!_loc6_)
         {
            return;
         ...
         if(_loc7_)
         {
            addItem(_loc7_.value,NotificationType.const_1144,_loc5_);
         }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = var_575.createAvatarImage(param2,AvatarScaleType.const_56);
         if(_loc7_ != null)
         {
            _loc7_.setDirection(AvatarSetType.const_49,3);
            _loc4_ = _loc7_.getCroppedImage(AvatarSetType.const_49);
            _loc7_.dispose();
         }
         if(param3 == "")
         {
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.responseType == ScrSendUserInfoMessageParser.const_1368)
         {
         ...
         else
         {
            ...
            if(_loc8_ > 0 && _loc2_.daysToPeriodEnd > 0 && _loc2_.daysToPeriodEnd <= _loc8_ && _loc2_.periodsSubscribedAhead == 0)
            {
               ...
               var_676 = new ClubEndingNotification(_loc2_.daysToPeriodEnd,_loc2_.isVIP,_assets,_windowManager,_catalog,_localization);
            }
         }
      }
      ...
      {
         var_574 = IHabboToolbar(param2);
         var_574.events.addEventListener(HabboToolbarEvent.const_91,onHabboToolbarEvent);
      }
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_344.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               addItem(_loc3_.value,NotificationType.const_864);
            }
            if(_loc4_)
            {
               addItem(_loc4_.value,NotificationType.const_864);
            }
         }
      }
      ...
      private function tempCategoryMapping(param1:String, param2:int) : int
      {
         ...
         if(param1 == "I")
         {
            if(param2 == 3001)
            {
               return FurniCategory.const_301;
            }
            if(param2 == 3002)
            {
            ...
            if(param2 == 4057)
            {
               return FurniCategory.const_326;
            }
            return 1;
         }
         return 1;
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_91)
         {
            ...
            var_398 = new HabboNotificationViewManager(_assetLibrary,_windowManager,var_808["styles"],var_808["view"],var_574);
            ...
            _communication.addHabboConnectionMessageEvent(new ParkBusCannotEnterMessageEvent(method_11));
            ...
            registerUpdateReceiver(var_398,1);
            registerUpdateReceiver(this,2);
            var_344.events.addEventListener(BadgeImageReadyEvent.const_109,onBadgeImage);
            var_574.events.addEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,onToolbarRepositionEvent);
         }
      }
   }
}
