package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_504:String = "room";
      
      private static const const_788:int = -2;
      
      private static const const_505:String = "temporary_room";
      
      private static const const_285:String = "object_icon_sprite";
      
      private static const const_789:int = -3;
      
      private static const const_790:String = "overlay";
      
      private static const OBJECT_TYPE_SELECTION_ARROW:String = "selection_arrow";
      
      private static const const_1112:String = "tile_cursor";
      
      private static const const_284:int = -1;
       
      
      private var var_445:IRoomObjectVisualizationFactory = null;
      ...
      private var var_253:IAdManager = null;
      
      private var var_626:NumberBank;
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(var_66 != null)
         {
            ...
            {
               return var_66.deleteWallItem(var_119,var_120,param1);
            }
         }
         return false;
      }
      ...
      private function getRoomCanvas(param1:int, param2:int, param3:int) : IRoomRenderingCanvas
      {
         ...
         var _loc5_:IRoomInstance = var_42.getRoom(_loc4_);
         if(_loc5_ == null)
         {
            return null;
         }
      ...
      private function updateRoomCameras(param1:uint) : void
      {
         ...
         var _loc49_:* = null;
         var _loc2_:int = 0;
         for(; _loc2_ < var_325.length; _loc2_++)
         {
            _loc3_ = var_325.getWithIndex(_loc2_) as RoomInstanceData;
            _loc4_ = null;
            _loc5_ = 0;
            _loc6_ = 0;
            if(_loc3_ != null)
               ...
               if(_loc8_ != null)
               {
                  ...
                  if(_loc11_ != null)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc15_ != null)
                        {
                           _loc16_ = _loc15_.getNumber(RoomVariableEnum.const_555) - 0.5;
                           _loc17_ = _loc15_.getNumber(RoomVariableEnum.const_663) - 0.5;
                           _loc18_ = _loc15_.getNumber(RoomVariableEnum.const_536) + 0.5;
                           _loc19_ = _loc15_.getNumber(RoomVariableEnum.const_625) + 0.5;
      ...
      public function objectInitialized(param1:String, param2:int, param3:int) : void
      {
         ...
         {
            _loc7_ = _loc6_.getModel().getString(RoomObjectVariableEnum.const_147);
            if(_loc7_ != null)
            {
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_66 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_32)
            {
               return var_66.modifyWallItemData(var_119,var_120,param1,param3);
            }
         }
         return false;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_29 != null)
         {
            var_29.release(new IIDRoomObjectFactory());
            var_29 = null;
         }
         if(var_445 != null)
         {
            var_445.release(new IIDRoomObjectVisualizationFactory());
            var_445 = null;
         }
         if(var_42 != null)
         {
            var_42.release(new IIDRoomManager());
            var_42 = null;
         }
         if(var_746 != null)
         {
            var_746.release(new IIDRoomRendererFactory());
            var_746 = null;
         }
         ...
         if(var_253)
         {
            var_253.release(new IIDHabboAdManager());
            var_253 = null;
         }
         _connection = null;
         if(var_626 != null)
         ...
         if(var_325 != null)
         {
            ...
            {
               _loc2_ = var_325.getWithIndex(_loc1_) as RoomInstanceData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      {
         var _loc4_:IRoomInstance = var_42.getRoom(param1);
         if(_loc4_ == null)
         {
            return null;
         }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         var _loc8_:IRoomInstance = var_42.getRoom(_loc7_);
         if(_loc8_ == null)
         {
            return null;
         }
         ...
         if(_loc9_ == null)
         {
            _loc9_ = var_746.createRenderer();
         }
         if(_loc9_ == null)
         {
            return null;
         }
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_919;
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_694);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_598);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_585);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_870);
            _loc16_ = _loc8_.getNumber(RoomObjectVariableEnum.const_995);
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_987) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_816);
                  _loc10_ = _loc7_.getLocation();
                  if(param4)
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_417,_loc5_,_loc9_,_loc10_);
                  }
                  else
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_534,_loc5_);
                  }
               }
            }
         }
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_717,var_119,var_120,param2,param3));
            }
         }
      }
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_66 != null)
         {
            return var_66.modifyRoomObject(var_119,var_120,param1,param2,param3);
         }
         return false;
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(_loc6_ == null)
         {
            ...
            _loc9_ = var_324.getValue(_loc8_);
            if(_loc9_ == null)
            {
               _loc9_ = new RoomData(param1,param2,null);
               var_324.add(_loc8_,_loc9_);
            }
            if(param3 != null)
            {
         ...
         if(param3 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_712,param3);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param4 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_745,param4);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param5 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_517,param5);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         return true;
      }
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_42 = param2 as IRoomManager;
         if(var_42 != null)
         {
            var_42.addObjectUpdateCategory(RoomObjectCategoryEnum.const_34);
            var_42.addObjectUpdateCategory(RoomObjectCategoryEnum.const_32);
            var_42.addObjectUpdateCategory(RoomObjectCategoryEnum.const_38);
            var_42.addObjectUpdateCategory(RoomObjectCategoryEnum.OBJECT_CATEGORY_CURSOR);
            var_42.addObjectUpdateCategory(RoomObjectCategoryEnum.const_68);
            var_42.setContentLoader(var_12);
         }
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(var_66 != null)
         {
            var_66.handleRoomObjectEvent(param1,var_119,var_120);
         }
      }
      ...
      public function addObjectFurniture(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN, param10:int = -1) : Boolean
      {
         ...
         {
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_215,_loc12_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_305,param4,true);
            _loc14_.getModelController().setString(RoomObjectVariableEnum.const_331,_loc13_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_898,1,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_990,param10);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_832,getTimer());
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_256,param1,param2,param3,RoomObjectCategoryEnum.const_34));
         }
      ...
      {
         if(var_29 == null || var_445 == null || var_42 == null || var_746 == null || _communication == null || _habboConfiguration == null || !var_2177)
         {
            return;
         }
         var_42.initialize(<nothing/>,this);
      }
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_284,RoomObjectCategoryEnum.const_68);
      }
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1230,param3,param4,param5);
         _loc6_.getEventHandler().processUpdateMessage(_loc7_);
      ...
      public function update(param1:uint) : void
      {
         if(var_42 != null)
         {
            var_42.update(param1);
         }
         updateRoomCameras(param1);
         var _loc2_:IRoomInstance = var_42.getRoom(getRoomIdentifier(var_119,var_120));
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_789,RoomObjectCategoryEnum.OBJECT_CATEGORY_CURSOR);
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = getRoomCanvas(var_119,var_120,var_1343);
         if(_loc2_ != null)
         {
            _loc3_ = getOverlaySprite(_loc2_);
            _loc4_ = getOverlayIconSprite(_loc3_,const_285);
            if(_loc4_ != null)
            {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = getRoomCanvas(var_119,var_120,var_1343);
         if(_loc1_ != null)
         {
            _loc2_ = getOverlaySprite(_loc1_);
            removeOverlayIconSprite(_loc2_,const_285);
         }
      }
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_445 = param2 as IRoomObjectVisualizationFactory;
         if(var_12 != null)
         {
            var_12.visualizationFactory = var_445;
         }
         initializeRoomManager();
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(var_29 != null)
         {
            if(false)
            {
               var_29.events.addEventListener(RoomObjectMouseEvent.const_231,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectMouseEvent.const_490,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectMouseEvent.ROOM_OBJECT_MOUSE_DOWN,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectStateChangeEvent.const_241,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectStateChangeEvent.const_653,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectWidgetRequestEvent.const_113,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectWidgetRequestEvent.ROOM_OBJECT_WIDGET_REQUEST_CREDITFURNI,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectWidgetRequestEvent.const_110,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectWidgetRequestEvent.const_131,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectWidgetRequestEvent.const_123,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectWidgetRequestEvent.const_119,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectWidgetRequestEvent.const_122,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectWidgetRequestEvent.const_101,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectFurnitureActionEvent.const_394,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectFurnitureActionEvent.const_425,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectFurnitureActionEvent.const_395,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectFurnitureActionEvent.ROOM_OBJECT_STICKIE,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectFurnitureActionEvent.const_409,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectFurnitureActionEvent.const_363,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectFurnitureActionEvent.const_399,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectFurnitureActionEvent.const_382,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectFurnitureActionEvent.const_479,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectFurnitureActionEvent.ROOM_OBJECT_JUKEBOX_DISPOSE,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectDimmerStateUpdateEvent.const_65,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectMoveEvent.const_437,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectMoveEvent.const_426,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectRoomAdEvent.const_274,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectRoomAdEvent.const_460,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectRoomAdEvent.const_342,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectRoomAdEvent.const_302,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectRoomActionEvent.const_419,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectRoomActionEvent.const_1018,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectRoomActionEvent.const_421,roomObjectEventHandler);
               var_29.events.addEventListener(AvatarWalkWarpingWarningEvent.const_411,warningEventHandler);
            }
         }
      }
      ...
      public function getRoomObjectCategory(param1:String) : int
      {
         ...
         return RoomObjectCategoryEnum.const_225;
      }
      ...
      public function initializeRoomObjectInsert(param1:int, param2:int, param3:int, param4:String = null) : Boolean
      {
         ...
         if(_loc5_ == null || _loc5_.getNumber(RoomVariableEnum.const_719) != 0)
         {
            return false;
         }
         if(var_66 != null)
         {
            return var_66.initializeRoomObjectInsert(var_119,var_120,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         {
            var_530 = true;
            events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_560,0,0));
            _loc2_ = 0;
            while(_loc2_ < var_324.length)
            {
               _loc3_ = var_324.getWithIndex(_loc2_) as RoomData;
               if(_loc3_ != null)
               {
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_256,param1,param2,param3,RoomObjectCategoryEnum.const_38));
         }
         return true;
      }
      ...
      {
         return var_42.isContentAvailable(param1);
      }
      ...
      public function getRoomObjectImage(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:int, param7:IGetImageListener, param8:uint = 0) : ImageResult
      {
         ...
         var _loc13_:IRoomInstance = var_42.getRoom(_loc12_);
         if(_loc13_ != null)
         {
            ...
            if(_loc14_ != null && _loc14_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_32:
                     _loc10_ = String(_loc14_.getModel().getNumber(RoomObjectVariableEnum.const_215));
                     _loc11_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_436);
                     break;
      ...
      public function updateObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:IVector3d = null, param7:Number = NaN) : Boolean
      {
         ...
         if(isNaN(param7))
         {
            param7 = _loc8_.getModel().getNumber(RoomObjectVariableEnum.const_340);
         }
      ...
      {
         if(param1 != null && param1.type == RoomContentLoader.const_732)
         {
            var_2177 = true;
            initializeRoomManager();
         }
      ...
      public function addObjectWallItem(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         if(_loc12_ != null && _loc12_.getModelController() != null)
         {
            ...
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_305,param4,true);
            _loc12_.getModelController().setString(RoomObjectVariableEnum.const_331,_loc11_,true);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_919,1,true);
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_256,param1,param2,param3,RoomObjectCategoryEnum.const_32));
         }
      ...
      {
         var _loc5_:IRoomInstance = var_42.getRoom(param1);
         if(_loc5_ == null)
         {
            return null;
         }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_253 = param2 as IAdManager;
         var_253.events.addEventListener(AdEvent.const_400,showRoomAd);
      }
      ...
      private function getOverlaySprite(param1:IRoomRenderingCanvas) : Sprite
      {
         ...
         return _loc2_.getChildByName(const_790) as Sprite;
      }
      ...
      {
         var _loc3_:String = getRoomIdentifier(param1,param2);
         var_42.disposeRoom(_loc3_);
         var _loc4_:RoomInstanceData = var_325.remove(_loc3_);
         if(_loc4_ != null)
         {
            _loc4_.dispose();
         }
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_709,param1,param2));
      }
      ...
      private function onRendererFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_746 = param2 as IRoomRendererFactory;
         initializeRoomManager();
      }
      ...
      public function getRoomObjectWithIndex(param1:int, param2:int, param3:int, param4:int) : IRoomObject
      {
         ...
         var _loc6_:IRoomInstance = var_42.getRoom(_loc5_);
         if(_loc6_ == null)
         {
            return null;
         }
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:String = null, param7:uint = 0, param8:String = null) : ImageResult
      {
         ...
         _loc9_.id = -1;
         if(!var_530 || param1 == null)
         {
            return _loc9_;
         }
         var _loc10_:IRoomInstance = var_42.getRoom(const_505);
         if(_loc10_ == null)
         {
            _loc10_ = var_42.createRoom(const_505,null);
            if(_loc10_ == null)
            {
               return _loc9_;
            }
         }
         var _loc11_:int = var_626.reserveNumber();
         ...
         switch(_loc12_)
         {
            case RoomObjectCategoryEnum.const_34:
            case RoomObjectCategoryEnum.const_32:
               _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_215,int(param2));
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_436,param8);
               break;
            case RoomObjectCategoryEnum.const_38:
            ...
            case RoomObjectCategoryEnum.const_68:
               if(param2 != null)
               {
                  ...
                  if(_loc17_.length >= 3)
                  {
                     ...
                     _loc21_.addPlane(RoomPlaneData.const_150,new Vector3d(0,0,0),new Vector3d(10,0,0),new Vector3d(0,10,0));
                     ...
                     _loc21_.addPlane(RoomPlaneData.const_246,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
                     _loc22_ = _loc21_.getXML();
                     _loc13_.getEventHandler().initialize(_loc22_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_713,_loc18_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_615,_loc19_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_600,_loc20_);
                     if(param6 != null)
                     {
                        _loc23_ = null;
                        _loc24_ = "undefined_" + _loc11_;
                        _loc23_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_417,_loc24_,param6,new Vector3d(2,0,1.75));
         ...
         {
            var_1083.add(String(_loc11_),param5);
            _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_818,param4,true);
         }
         else
         {
            _loc10_.disposeObject(_loc11_,_loc12_);
            var_626.freeNumber(_loc11_ - 1);
            _loc9_.id = 0;
         }
         _loc15_.dispose();
         return _loc9_;
      ...
      public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
         ...
         if(_loc9_ != null)
         {
            ...
            _loc11_ = getOverlayIconSprite(_loc10_,const_285);
            if(_loc11_ != null)
            {
               _loc12_ = _loc11_.getRect(_loc11_);
               _loc11_.x = var_1585 - _loc12_.width / 2;
               _loc11_.y = var_1586 - _loc12_.height / 2;
            }
            if(!_loc9_.method_13(param2,param3,param4,param5,param6,param7,param8))
            {
               _loc13_ = "";
               if(param4 == MouseEvent.CLICK)
               {
                  if(events != null)
                  {
                     events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_418,var_119,var_120,-1,RoomObjectCategoryEnum.const_225));
                  }
                  _loc13_ = "null";
               }
               ...
               if(var_66 != null)
               {
                  _loc14_ = new RoomObjectMouseEvent(_loc13_,const_284,const_504);
                  var_66.handleRoomObjectEvent(_loc14_,var_119,var_120);
               }
            }
         }
      }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         var _loc7_:IRoomRenderingCanvas = getRoomCanvas(var_119,var_120,var_1343);
         if(_loc7_ != null)
         {
            _loc10_ = getOverlaySprite(_loc7_);
            removeOverlayIconSprite(_loc10_,const_285);
            _loc11_ = addOverlayIconSprite(_loc10_,const_285,_loc6_.data);
            if(_loc11_ != null)
            {
               _loc11_.x = var_1585 - _loc6_.data.width / 2;
               _loc11_.y = var_1586 - _loc6_.data.height / 2;
            }
         }
      }
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(var_12 != null)
         {
            ...
            var_12.addGraphicAsset(var_12.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_295,param1.image,true);
            var_12.addGraphicAsset(var_12.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_888,param1.adWarningL,true);
            var_12.addGraphicAsset(var_12.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_873,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_956,RoomObjectVariableEnum.const_295,param1.clickUrl);
      ...
      {
         var _loc3_:String = getRoomIdentifier(param1,param2);
         var _loc4_:RoomInstanceData = var_325.getValue(_loc3_) as RoomInstanceData;
         if(_loc4_ == null)
         {
            _loc4_ = new RoomInstanceData(param1,param2);
            var_325.add(_loc3_,_loc4_);
         }
         return _loc4_;
      }
      ...
      private function onObjectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_29 = param2 as IRoomObjectFactory;
      ...
      private function onHabboConfigurationInit(param1:Event) : void
      {
         if(var_12 != null)
         {
            _events.addEventListener(RoomContentLoader.const_732,onContentLoaderReady);
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(var_66 != null)
         {
            var_66.cancelRoomObjectInsert(var_119,var_120);
         }
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = var_42.getRoom(const_505);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_818);
               ...
               var_626.freeNumber(_loc10_ - 1);
               _loc13_ = var_1083.remove(String(_loc10_)) as IGetImageListener;
      ...
      {
         return getRoomObjectBoundingRectangle(var_119,var_120,const_284,RoomObjectCategoryEnum.const_68,param1);
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         var _loc7_:IRoomInstance = var_42.createRoom(param1,param2);
         if(_loc7_ == null)
         {
            return null;
         }
         ...
         if(isPublicRoomWorldType(param6))
         {
            ...
            _loc9_ = _loc7_.createRoomObject(const_284,_loc12_,_loc8_) as IRoomObjectController;
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_860,param6,true);
            _loc7_.setNumber(RoomVariableEnum.const_719,1,true);
            _loc13_ = parseInt(_habboConfiguration.getKey("ads.billboard.displayDelayMillis","1000"));
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_821,_loc13_,true);
            if(var_12 != null)
            {
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_284,const_504,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_719,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_694,_loc10_,true);
         if(param2 != null)
         {
            _loc14_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_555,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_536,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_663,_loc18_);
               _loc7_.setNumber(RoomVariableEnum.const_625,_loc19_);
               _loc14_ += _loc16_ * 423 + _loc17_ * 671 + _loc18_ * 913 + _loc19_ * 7509;
               if(_loc9_ != null && _loc9_.getModelController() != null)
               {
                  _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_939,_loc14_,true);
               }
            }
         }
         if(_loc9_ != null && _loc9_.getEventHandler() != null)
         ...
         if(param3 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_712,param3);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param4 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_745,param4);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param5 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_517,param5);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param2 != null)
         {
            if(param2.doors.door.length() > 0)
            {
               ...
               while(_loc23_ < _loc20_.length())
               {
                  ...
                  if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                  {
                     ...
                     _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_417,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_236);
                     _loc9_.getEventHandler().processUpdateMessage(_loc22_);
                     if(_loc28_ == 90 || _loc28_ == 180)
                     {
                        if(_loc28_ == 90)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_598,_loc25_ - 0.5,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_585,_loc26_,true);
                        }
                        if(_loc28_ == 180)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_598,_loc25_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_585,_loc26_ - 0.5,true);
                        }
                        _loc7_.setNumber(RoomObjectVariableEnum.const_870,_loc27_,true);
                        _loc7_.setNumber(RoomObjectVariableEnum.const_995,_loc28_,true);
                     }
                  }
                  _loc23_++;
               }
         ...
         _loc7_.createRoomObject(const_788,const_1112,RoomObjectCategoryEnum.OBJECT_CATEGORY_CURSOR);
         _loc7_.createRoomObject(const_789,OBJECT_TYPE_SELECTION_ARROW,RoomObjectCategoryEnum.OBJECT_CATEGORY_CURSOR);
         return _loc7_;
      }
