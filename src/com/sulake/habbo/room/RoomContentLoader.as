package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IDisposable
   {
      ...
      private static const const_768:String = "selection_arrow";
      
      private static const const_769:String = "tile_cursor";
      
      private static const const_282:String = "RCL_PUBLICROOM_";
      
      private static const const_496:String = "wall_place_holder";
      
      private static const STATE_READY:int = 2;
      
      private static const const_349:String = "place_holder";
      
      private static const const_1065:String = const_349;
      
      private static const const_1419:int = 0;
      
      private static const const_767:int = 1;
      
      private static const ROOM_CONTENT:String = "room";
      
      public static const const_732:String = "RCL_LOADER_READY";
       
      
      private var _isDisposed:Boolean = false;
      
      private var var_475:Map = null;
      ...
      private var var_1002:IEventDispatcher = null;
      
      private var var_1205:Map = null;
      ...
      private var var_579:Map = null;
      
      private var var_1847:Array;
      
      private var var_349:Map = null;
      
      private var var_169:PublicRoomData = null;
      
      public function RoomContentLoader()
      {
         var_476 = [];
         var_477 = [];
         var_1847 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         var_1844 = ["room_public","room_public_park","room_public_pool"];
         super();
         var_403 = new Map();
         _events = new Map();
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               {
                  case RoomObjectCategoryEnum.const_34:
                     if(var_476.indexOf(_loc4_) == -1)
                     {
                        var_476.push(_loc4_);
                     }
                     break;
                  case RoomObjectCategoryEnum.const_32:
                     if(var_477.indexOf(_loc4_) == -1)
                     {
                        var_477.push(_loc4_);
                     }
                     break;
               ...
               _loc6_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_323,_loc4_);
      ...
      private function getRoomObjectOriginalName(param1:String) : String
      {
         ...
         if(var_401 != null)
         {
            _loc2_ = var_401.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      {
         if(var_169 != null && var_169.hasWorldType(const_282 + param1))
         {
            return var_169.type;
         }
         return param1;
                  ...
                  for each(_loc8_ in _loc7_)
                  {
                     ...
                     if(_loc8_.length > 0)
                     {
                        ...
                        if(_loc9_.length >= 3)
                        {
                           ...
                           {
                              var_475.add(_loc10_,_loc11_);
                              if(var_476.indexOf(_loc14_) < 0)
                              {
                                 var_476.push(_loc14_);
                              }
                           }
                           else if(_loc9_[0] as String == "i")
                           {
                              ...
                              if(var_477.indexOf(_loc14_) < 0)
                              {
                                 var_477.push(_loc14_);
                              }
                           }
      ...
      public function dispose() : void
      {
         ...
         if(var_403 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc3_ = var_403.getWithIndex(_loc2_) as AssetLibrary;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
         ...
         if(var_349 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc4_ = var_349.getWithIndex(_loc2_) as IGraphicAssetCollection;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = var_403.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            _loc4_ = var_579.getValue(_loc2_);
            if(_loc4_ != null)
            {
               _loc2_ = getContentType(_loc4_);
               _loc3_ = var_403.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      {
         return [const_349,const_496,ROOM_CONTENT,const_769,const_768];
      }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         while(_loc5_ < _loc3_.length)
         {
            if(_loc3_[_loc5_].toString().length > 0 && var_1847.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_182 && _loc5_ != RoomObjectLogicEnum.const_137)
         {
            _loc6_ = "@shadow";
      ...
      {
         var _loc2_:String = var_475.getValue(param1) as String;
         return getObjectType(_loc2_);
      }
      
      public function getPlaceHolderType(param1:String) : String
      {
         if(var_476.indexOf(param1) >= 0)
         {
            return const_349;
         }
         if(var_477.indexOf(param1) >= 0)
         {
            return const_496;
         }
         if(var_169 != null && (var_169.type == param1 || var_169.hasWorldType(param1)))
         {
            return ROOM_CONTENT;
         }
         return const_1065;
      ...
      {
         if(var_578.getValue(param1) != null)
         {
            return var_578.getValue(param1);
         }
         return "";
      }
      ...
      private function getRoomObjectAlias(param1:String) : String
      {
         ...
         if(var_402 != null)
         {
            _loc2_ = var_402.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1340);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(var_1844.indexOf(getVisualizationType(_loc5_)) >= 0)
            {
               _loc7_ = getVisualizationXML(_loc5_);
               _loc8_ = extractPublicRoomFromXML(_loc5_,_loc7_);
               var_1205.add(_loc5_,_loc8_);
               var_169 = _loc8_;
               extractPublicRoomFurnitures(_loc5_,_loc2_);
            }
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_323,_loc5_);
         }
         else
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_439,_loc5_);
         }
      ...
      private function continueInitilization() : void
      {
         if(var_1843)
         {
            ...
            if(var_1002 != null)
            {
               var_1002.dispatchEvent(new Event(const_732));
            }
         }
      }
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         if(var_169 != null)
         {
            return var_169.getWorldHeightScale(const_282 + param1);
         }
         return 1;
      }
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         if(_assetLibrary != null && param2 != null)
         {
            ...
            var_1002 = param1;
            var_1842 = param2.getKey("flash.dynamic.download.url","furniture/");
            var_1848 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
            var_1845 = param2.getKey("public.room.dynamic.download.url","");
            var_1846 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         }
         var_33 = const_767;
      }
      ...
      {
         var _loc2_:String = getContentType(param1);
         return var_349.getValue(_loc2_) as IGraphicAssetCollection;
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(var_402 != null)
         {
            var_402.remove(param1);
            var_402.add(param1,param2);
         }
         if(var_401 != null)
         {
            var_401.remove(param2);
            var_401.add(param2,param1);
         }
      }
      ...
      public function getVisualizationType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectVisualizationEnum.const_182 && _loc5_ != RoomObjectVisualizationEnum.const_137)
         {
            _loc6_ = "@shadow";
            if(param1.indexOf(_loc6_) > -1)
            {
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = var_445.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
            _loc3_.assetLibrary = param2;
            var_349.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      {
         if(getObjectCategory(const_282 + param1) == RoomObjectCategoryEnum.const_68)
         {
            return true;
         }
         return false;
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(var_1205.getValue(param1) != null)
         {
            var_169 = var_1205.getValue(param1) as PublicRoomData;
         }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(var_169 != null)
         {
            return var_169.getWorldScale(const_282 + param1);
         }
         return 32;
      }
