package com.sulake.habbo.room.object
{
   ...
   public class RoomPlaneParser
   {
      ...
      private var var_764:Number = 0;
      
      private var var_365:int = 0;
      
      private var var_366:int = 0;
      
      private var var_1336:Number = 0;
      ...
      public function getPlaneType(param1:int) : int
      {
         ...
         {
            return RoomPlaneData.const_869;
         }
         var _loc2_:RoomPlaneData = var_104[param1] as RoomPlaneData;
         if(_loc2_ != null)
         {
            return _loc2_.type;
         }
      ...
      private function addWall(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:Boolean, param6:Boolean, param7:Boolean) : void
      {
         ...
         addPlane(RoomPlaneData.const_246,param1,param2,param3,[param4]);
         var _loc9_:Vector3d = Vector3d.crossProduct(param2,param3);
         var _loc10_:Vector3d = Vector3d.product(_loc9_,1 / _loc9_.length * -var_917);
         addPlane(RoomPlaneData.const_153,Vector3d.sum(param1,param3),param2,_loc10_,[_loc9_,param4]);
         if(param5)
         {
            addPlane(RoomPlaneData.const_153,Vector3d.sum(Vector3d.sum(param1,param2),param3),Vector3d.product(param3,-(param3.length + var_117) / param3.length),_loc10_,[_loc9_,param4]);
         }
         if(param6)
         {
            addPlane(RoomPlaneData.const_153,Vector3d.sum(param1,Vector3d.product(param3,-var_117 / param3.length)),Vector3d.product(param3,(param3.length + var_117) / param3.length),_loc10_,[_loc9_,param4]);
            if(param7)
            {
               _loc11_ = Vector3d.product(param2,var_917 / param2.length);
      ...
      {
         if(param1 == null || var_103 == null || param1 == var_103)
         {
            return false;
         }
         var _loc3_:int = 0;
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(param1.length > var_103.length)
         {
            return false;
         }
         ...
         while(_loc3_ < _loc7_)
         {
            ...
            _loc6_ = var_103[_loc3_] as Array;
      ...
      private function getTileHeightInternal(param1:int, param2:int) : Number
      {
         ...
         var _loc3_:Array = var_103[param2] as Array;
      ...
      public function getPlaneMaskLeftSideLoc(param1:int, param2:int) : Number
      {
         ...
         var _loc3_:RoomPlaneData = var_104[param1] as RoomPlaneData;
         if(_loc3_ != null)
         {
            ...
            if(_loc6_ != null && _loc7_ != null && _loc8_ != null)
            {
               ...
               if(getPlaneMaskCount(_loc2_) > 0)
               {
                  ...
                  while(_loc13_ < getPlaneMaskCount(_loc2_))
                  {
                     ...
                     _loc15_ = method_5(_loc2_,_loc13_);
      ...
      public function initializeFromTileData(param1:Boolean = false) : Boolean
      {
         var _loc7_:* = null;
         var _loc8_:int = 0;
         var _loc2_:Point = findEntranceTile(var_103);
         var _loc3_:int = 0;
         if(_loc2_ != null)
         {
         ...
         var_764 = getFloorHeight(var_103);
         if(!param1)
         {
            createWallPlanes();
         }
      ...
      public function setTileHeight(param1:int, param2:int, param3:Number) : Boolean
      {
         ...
         if(param1 >= 0 && param1 < _width && param2 >= 0 && param2 < _height)
         {
            _loc4_ = var_103[param2] as Array;
            ...
            {
               if(param1 == var_366 || param1 == var_364)
               {
                  _loc5_ = false;
                  _loc6_ = var_365;
                  while(_loc6_ < var_367)
                  {
               ...
               if(param2 == var_365 || param2 == var_367)
               {
                  _loc7_ = false;
                  _loc8_ = var_366;
                  while(_loc8_ < var_364)
                  {
      ...
      {
         var _loc12_:RoomPlaneData = addPlane(RoomPlaneData.const_150,param1,param2,param3);
         ...
         if(_loc12_)
         {
            ...
            if(param6)
            {
               ...
               _loc14_ = addPlane(RoomPlaneData.const_150,_loc13_,new Vector3d(0,0,-var_117),param2);
               if(_loc14_ != null)
               {
                  if(param8 > 0)
                  {
            ...
            if(param7)
            {
               ...
               _loc14_ = addPlane(RoomPlaneData.const_150,_loc13_,new Vector3d(0,0,-var_117),Vector3d.product(param2,-1));
               if(_loc14_ != null)
               {
                  if(param9 > 0)
                  {
            ...
            if(param4)
            {
               ...
               _loc15_ = addPlane(RoomPlaneData.const_150,_loc13_,new Vector3d(0,0,-var_117),Vector3d.product(param3,-1));
               if(_loc15_ != null)
               {
                  if(param11 > 0)
                  {
            ...
            if(param5)
            {
               ...
               _loc15_ = addPlane(RoomPlaneData.const_150,_loc13_,new Vector3d(0,0,-var_117),param3);
               if(_loc15_ != null)
               {
                  if(param10 > 0)
                  {
      ...
      public function method_5(param1:int, param2:int) : Number
      {
         if(param1 < 0 || param1 >= planeCount)
         {
            return -1;
