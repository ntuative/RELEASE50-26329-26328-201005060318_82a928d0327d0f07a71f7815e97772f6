package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurniturePushableLogic extends FurnitureMultiStateLogic
   {
      ...
      private static const const_1074:int = 0;
       
      
      private var var_1498:Vector3d = null;
      ...
      override public function update(param1:int) : void
      {
         if(object != null)
         {
            var_1498.assign(object.getLocation());
            super.update(param1);
            if(Vector3d.dif(object.getLocation(),var_1498).length > 0)
            {
               if(object.getState(0) != const_773)
               {
                  object.setState(const_773,0);
               }
            }
            else
            {
               object.setState(const_1074,0);
            }
         }
      }
   }
