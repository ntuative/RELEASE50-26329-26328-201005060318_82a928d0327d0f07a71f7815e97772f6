package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1542:int = 1500;
      
      private var var_1541:int = 255;
      
      private var var_1540:int = 255;
      
      private var var_1293:uint = 16777215;
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomUpdateMessage.const_712:
                  _loc2_.setString(RoomObjectVariableEnum.const_713,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_745:
                  _loc2_.setString(RoomObjectVariableEnum.const_615,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_517:
                  _loc2_.setString(RoomObjectVariableEnum.const_600,_loc3_.value);
            }
            return;
         }
         ...
         if(_loc4_ != null)
         {
            ...
            switch(_loc4_.type)
            {
               case RoomObjectRoomMaskUpdateMessage.const_417:
                  _loc8_ = "null";
                  if(_loc4_.maskCategory == RoomObjectRoomMaskUpdateMessage.const_236)
                  {
                     _loc8_ = "null";
                  }
                  var_435.addMask(_loc4_.maskId,_loc4_.maskType,_loc4_.maskLocation,_loc8_);
                  _loc7_ = true;
                  break;
               case RoomObjectRoomMaskUpdateMessage.const_534:
                  _loc7_ = var_435.removeMask(_loc4_.maskId);
            }
            if(_loc7_)
            {
               _loc9_ = var_435.getXML();
               _loc10_ = _loc9_.toXMLString();
               _loc2_.setString(RoomObjectVariableEnum.const_999,_loc10_);
            }
            return;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_927,int(_loc5_.bgOnly));
            var_1293 = _color;
            var_1541 = var_1224;
            var_1063 = _loc11_;
            var_1540 = _loc12_;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_851,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_664,16777215);
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1222,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1199,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1317,_loc22_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc13_ == RoomPlaneData.const_153 || _loc13_ == RoomPlaneData.const_246)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(var_884)
         {
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_664,_loc3_);
         }
      }
   }
}
