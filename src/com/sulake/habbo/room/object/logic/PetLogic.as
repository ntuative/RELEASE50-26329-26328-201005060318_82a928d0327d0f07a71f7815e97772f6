         ...
         if(object != null)
         {
            ...
            if(object.getType() == "pet")
            {
               if(param1 is RoomObjectAvatarUpdateMessage)
               {
                  ...
                  if(_loc3_ != null)
                  {
                     _loc2_.setNumber(RoomObjectVariableEnum.const_340,_loc3_.dirHead);
                  }
               }
               if(param1 is RoomObjectAvatarFigureUpdateMessage)
               {
                  _loc4_ = param1 as RoomObjectAvatarFigureUpdateMessage;
                  _loc5_ = _loc2_.getString(RoomObjectVariableEnum.const_176);
                  _loc2_.setString(RoomObjectVariableEnum.const_176,_loc4_.figure);
                  _loc2_.setString(RoomObjectVariableEnum.const_1243,_loc4_.race);
               }
               if(param1 is RoomObjectAvatarWaveUpdateMessage)
               {
                  ...
                  if(_loc6_.isWaving)
                  {
                     _loc2_.setNumber(RoomObjectVariableEnum.const_316,new Date().valueOf());
                  }
                  else
                  {
               ...
               if(param1 is RoomObjectAvatarSleepUpdateMessage)
               {
                  ...
                  _loc2_.setNumber(RoomObjectVariableEnum.const_375,Number(_loc7_.isSleeping));
               }
               if(param1 is RoomObjectAvatarPetGestureUpdateMessage)
               {
                  _loc8_ = param1 as RoomObjectAvatarPetGestureUpdateMessage;
                  _loc2_.setString(RoomObjectVariableEnum.const_476,_loc8_.gesture);
                  _loc2_.setNumber(RoomObjectVariableEnum.const_383,getTimer());
               }
               if(param1 is RoomObjectAvatarChatUpdateMessage)
               {
                  _loc9_ = param1 as RoomObjectAvatarChatUpdateMessage;
                  _loc2_.setNumber(RoomObjectVariableEnum.const_672,_loc9_.numberOfWords);
                  _loc2_.setNumber(RoomObjectVariableEnum.const_572,new Date().valueOf());
               }
               ...
               if(param1 is RoomObjectAvatarExperienceUpdateMessage)
               {
                  ...
                  _loc2_.setNumber(RoomObjectVariableEnum.const_975,Number(getTimer()));
                  _loc2_.setNumber(RoomObjectVariableEnum.const_862,Number(_loc12_.gainedExperience));
               }
            }
         }
      }
