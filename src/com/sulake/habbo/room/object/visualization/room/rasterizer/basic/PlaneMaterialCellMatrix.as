package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1198:int = const_334;
      ...
      public static const const_543:int = 6;
      
      public static const ALIGN_DEFAULT:int = const_107;
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(var_1584 == const_107)
         {
            _loc5_ = new Rectangle(0,0,var_24.width,var_369);
         }
         else
         {
            _loc5_ = new Rectangle(0,0 - var_369,var_24.width,var_369);
         }
         ...
         if(isStatic)
         {
            if(var_24 != null)
            {
               if(var_24.width == param2 && var_24.height == param3 && Vector3d.isEqual(var_625,param4))
               {
                  if(param1 != null)
                  {
                     copyCachedBitmapOnCanvas(param1,var_369,param6,param7);
                     return param1;
                  }
                  return var_24;
               }
