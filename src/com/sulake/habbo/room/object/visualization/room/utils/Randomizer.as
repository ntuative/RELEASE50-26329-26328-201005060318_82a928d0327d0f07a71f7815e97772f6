package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_1487:int = 16777216;
      
      public static const const_1512:int = 1;
       
      
      private var var_2366:int = 69069;
      
      private var var_1137:int = 1;
      
      private var var_2365:int = 5;
      
      private var var_1410:int = 16777216;
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / var_1410 * param2);
      }
      ...
      {
         var _loc1_:int = var_2366 * var_1137 + var_2365;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
