package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      private var var_748:IPlaneRasterizer = null;
      
      private var var_922:Vector3d = null;
      ...
      public function RoomPlane(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:int, param6:Boolean, param7:Array, param8:int, param9:Number = 0, param10:Number = 0, param11:Number = 0, param12:Number = 0)
      {
         ...
         super();
         var_2184 = param8;
         var_922 = new Vector3d();
         var_922.assign(param1);
         var_72 = new Vector3d();
         ...
         var_531 = Vector3d.crossProduct(var_288,var_287);
         if(false)
         {
            var_531.mul(Infinity);
         }
         if(param7 != null)
         {
            _loc13_ = 0;
      ...
      public function addBitmapMask(param1:String, param2:Number, param3:Number) : Boolean
      {
         ...
         if(var_921)
         {
            _loc4_ = null;
            _loc5_ = 0;
            while(_loc5_ < var_209.length)
            {
               _loc4_ = var_209[_loc5_] as RoomPlaneBitmapMask;
               if(_loc4_ != null)
               {
      ...
      private function draw(param1:BitmapData, param2:Matrix) : void
      {
         ...
         if(_bitmapData != null)
         {
            if(param2.a == 1 && param2.d == 1 && param2.c == 0 && param2.b != 0 && Math.abs(param2.b) <= 1 && (_type == const_210 || _type == const_190))
            {
               _loc3_ = 0;
               _loc4_ = 0;
               _loc5_ = 0;
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!var_921 || false && false && !var_161 || var_609 == null)
         {
            return;
         }
         ...
         if(var_161)
         {
            ...
            _loc9_ = param2.getCoordinatePosition(var_531);
            _loc10_ = 0;
            _loc11_ = 0;
            _loc5_ = 0;
            while(_loc5_ < var_209.length)
            {
               _loc3_ = var_209[_loc5_] as RoomPlaneBitmapMask;
               if(_loc3_ != null)
               {
                  _loc10_ = 0 - 0 * _loc3_.leftSideLoc / 0;
                  _loc11_ = 0 - 0 * _loc3_.rightSideLoc / 0;
                  _loc12_ = _loc3_.type;
                  var_609.updateMask(var_61,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
                  var_749.push(new RoomPlaneBitmapMask(_loc12_,_loc3_.leftSideLoc,_loc3_.rightSideLoc));
               }
               _loc5_++;
            }
            _loc6_ = 0;
            while(_loc6_ < var_280.length)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  var_1084.push(new RoomPlaneRectangleMask(_loc4_.leftSideLength,_loc4_.rightSideLoc,_loc4_.leftSideLength,_loc4_.rightSideLength));
               }
               _loc6_++;
            }
            var_161 = false;
      ...
      private function getTextureIdentifier(param1:Number) : String
      {
         if(var_748 != null)
         {
            return var_748.getTextureIdentifier(param1,normal);
         }
      ...
      {
         if(var_141 == null || var_107 == null || var_79 == null || var_106 == null || param2 == null || _bitmapData == null)
         {
            return;
         }
         ...
         if(_type == const_210 || _type == const_190)
         {
      ...
      {
         var_141.assign(param1.getScreenPosition(var_72));
         var_107.assign(param1.getScreenPosition(Vector3d.sum(var_72,var_287)));
         var_79.assign(param1.getScreenPosition(Vector3d.sum(Vector3d.sum(var_72,var_288),var_287)));
         var_106.assign(param1.getScreenPosition(Vector3d.sum(var_72,var_288)));
         _offset = param1.getScreenPoint(var_922);
         ...
         var _loc2_:Number = Math.min(var_141.x,var_107.x,var_79.x,var_106.x);
         var _loc3_:Number = Math.max(var_141.x,var_107.x,var_79.x,var_106.x);
         var _loc4_:Number = Math.min(var_141.y,var_107.y,var_79.y,var_106.y);
         var _loc5_:Number = Math.max(var_141.y,var_107.y,var_79.y,var_106.y);
         _loc3_ -= _loc2_;
         _offset.x = 0 - _loc2_;
         var_141.x = 0 - _loc2_;
         var_107.x = 0 - _loc2_;
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         if(true)
         {
            ...
            {
               _loc4_ = var_209[_loc1_] as RoomPlaneBitmapMask;
               if(_loc4_ != null)
               {
                  _loc6_ = false;
                  while(_loc2_ < var_749.length)
                  {
                     _loc7_ = var_749[_loc2_] as RoomPlaneBitmapMask;
                     if(_loc7_ != null)
                     {
      ...
      public function update(param1:IRoomGeometry, param2:int, param3:Boolean) : Boolean
      {
         ...
         if(param3)
         {
            ...
            _loc5_ = 0;
            while(_loc5_ < var_1273.length)
            {
               _loc4_ = Number(Vector3d.cosAngle(param1.directionAxis,var_1273[_loc5_]));
               if(_loc4_ > -0.001)
               {
                  if(_isVisible)
                  {
            ...
            _loc6_ = param1.getScreenPosition(var_922);
            _loc7_ = _loc6_.z;
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         updateMaskChangeStatus();
         if(_loc3_ == null || _loc3_.timeStamp >= 0 && param2 > _loc3_.timeStamp || var_161)
         {
            return true;
         }
         return false;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         if(needsNewTexture(param1,param2))
         {
            ...
            _loc7_ = param1.getCoordinatePosition(var_531);
            _loc4_ = getTextureIdentifier(param1.scale);
            if(var_246 != null)
            {
               _loc3_ = var_246;
            ...
            if(var_748 != null)
            {
               _loc3_ = var_748.render(_loc8_,_id,_loc5_,_loc6_,param1.scale,_loc7_,var_1590,var_2185,var_2188,var_2189,var_2187,param2);
               if(_loc3_ != null)
               {
