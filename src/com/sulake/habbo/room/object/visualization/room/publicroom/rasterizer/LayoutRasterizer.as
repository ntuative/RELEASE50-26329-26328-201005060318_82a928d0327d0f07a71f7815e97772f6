package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_1023:Point = null;
      
      private var var_487:Array;
      
      private var var_1022:LayoutRasterizerData = null;
      ...
      private var var_489:Boolean = true;
      
      private var _adBgIndex:int = -1;
      
      private var var_829:IGraphicAssetCollection;
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc11_:* = null;
         var_1024 = param1;
         var _loc3_:LayoutRasterizerData = var_40.getValue(var_691);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              var_1227 = RoomObjectVariableEnum.const_888;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              var_1227 = RoomObjectVariableEnum.const_873;
                           }
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(var_1024 + _adBgIndex);
                              if(_loc5_ != null)
                              {
                        ...
                        if(_loc10_ == "billboard_img")
                        {
                           ...
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(var_1024 + _adImgIndex);
                              if(_loc5_ != null)
                              {
                                 _loc5_.visible = false;
                                 _loc5_.alpha = 0;
      ...
      public function showAd(param1:IRoomObjectSpriteVisualization, param2:String = "", param3:Boolean = false) : void
      {
         ...
         if(param1 != null)
         {
            _loc4_ = param1.getSprite(var_1024 + _adBgIndex);
            _loc5_ = param1.getSprite(var_1024 + _adImgIndex);
         }
         ...
         {
            exchangeElementGraphics("billboard_img",var_1227);
         }
         ...
         if(param3)
         {
            ...
            _loc5_.tag = RoomObjectVariableEnum.const_369;
         }
         if(param2 != "")
         {
            _loc4_.visible = true;
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         var _loc3_:Point = param1.getScreenPoint(var_1909);
         _loc3_.x -= _loc2_.x;
         _loc3_.y -= _loc2_.y;
      ...
      public function set layout(param1:String) : void
      {
         if(param1 != var_691)
         {
            ...
            _adBgIndex = -1;
            _adImgIndex = -1;
            var_1022 = var_40.getValue(var_691);
         }
      }
      ...
      {
         var _loc1_:LayoutRasterizerData = var_40.getValue(var_691);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         var _loc5_:XMLList = var_1022.elementList;
         if(_loc5_ == null)
         {
            return;
         }
         ...
         var _loc9_:IGraphicAsset = var_829.getAsset(_loc8_.@asset);
         ...
         param2.offsetX = int(_loc8_.@x) + _loc9_.offsetX + var_1023.x;
         param2.offsetY = int(_loc8_.@y) + _loc9_.offsetY + var_1023.y;
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(var_353.indexOf(_loc10_) >= 0 && var_489)
            {
               param1 = var_353.indexOf(_loc10_);
               if(true)
               {
                  _loc9_ = var_829.getAsset(var_488[param1]);
                  if(_loc9_ != null && _loc9_.asset != null)
                  {
                     param2.asset = _loc9_.asset.content as BitmapData;
                  }
               ...
               if(true)
               {
                  param2.alpha = var_487[param1];
               }
               var_353.splice(param1,1);
               var_488.splice(param1,1);
               var_487.splice(param1,1);
               if(false)
               {
                  var_489 = false;
               }
