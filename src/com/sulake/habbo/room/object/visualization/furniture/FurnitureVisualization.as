package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected static const const_1410:Number = Math.sqrt(0.5);
      ...
      protected var var_1411:String = null;
      ...
      protected var var_2282:Number = NaN;
      ...
      protected function getSpriteAssetName(param1:int, param2:Number) : String
      {
         ...
         if(_loc3_ == null || _loc3_.length == 0)
         {
            ...
            var_593[param1] = _loc3_;
            var_592[param1] = _loc4_;
         }
         if(_loc4_)
         {
      ...
      protected function updateSprites(param1:int, param2:Number) : void
      {
         ...
         var _loc4_:Boolean = false;
         if(var_1411 != null && var_1411.indexOf("http") == 0)
         {
            _loc4_ = true;
         }
      ...
      protected function getBlendMode(param1:int) : String
      {
         ...
         switch(param1)
         {
            case LayerData.const_881:
               _loc2_ = "null";
               break;
            case LayerData.INK_DARKEN:
               _loc2_ = "null";
               break;
            case LayerData.const_959:
               _loc2_ = "null";
         }
         return _loc2_;
      }
      ...
      {
         var _loc3_:int = 0;
         if(var_1959 != param1 || var_1961 != param2)
         {
            _loc3_ = spriteCount - 1;
            while(_loc3_ >= 0)
            {
               var_593[_loc3_] = "";
               var_592[_loc3_] = false;
               _loc3_--;
            }
            var_1959 = param1;
            var_1961 = param2;
      ...
      {
         var _loc3_:int = 0;
         if(var_1962 != param1 || var_1960 != param2)
         {
            _loc3_ = spriteCount - 1;
            while(_loc3_ >= 0)
            {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            var_2292 = _loc3_.getNumber(RoomObjectVariableEnum.const_215);
            ...
            var_1411 = _loc3_.getString(RoomObjectVariableEnum.const_331);
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_293 != _loc3_.getUpdateID() || param1 != var_213 || param2 != var_2282)
         {
