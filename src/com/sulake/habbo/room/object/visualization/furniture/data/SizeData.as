package com.sulake.habbo.room.object.visualization.furniture.data
{
   ...
   public class SizeData
   {
      ...
      private var var_1295:int = 360;
      
      private var var_2064:int = 0;
      
      private var var_719:DirectionData = null;
      ...
      public function getDirectionValue(param1:int) : int
      {
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc2_:int = (param1 % 360 + 360 + var_1295 / 2) % 360 / var_1295;
         if(var_237.getValue(String(_loc2_)) != null)
         {
            return _loc2_;
         }
         ...
         var _loc4_:int = -1;
         var _loc5_:int = 0;
         while(_loc5_ < var_237.length)
         {
            _loc6_ = int(var_237.getKey(_loc5_)) * var_1295;
         ...
         if(_loc4_ >= 0)
         {
            return int(var_237.getKey(_loc4_));
         }
         return const_1232;
      }
      ...
      private function defineDirection(param1:DirectionData, param2:XMLList) : Boolean
      {
         ...
         },_loc5_++)
         {
            ...
            {
               case "ADD":
                  param1.setInk(_loc7_,LayerData.const_881);
                  break;
               case "SUBTRACT":
                  param1.setInk(_loc7_,LayerData.const_959);
                  break;
               case "DARKEN":
      ...
      private function getDirectionData(param1:int) : DirectionData
      {
         ...
         var _loc2_:* = null;
         _loc2_ = var_237.getValue(String(param1)) as DirectionData;
         if(_loc2_ == null)
         {
      ...
      public function dispose() : void
      {
         ...
         if(var_237 != null)
         {
            _loc2_ = null;
            _loc1_ = 0;
            while(_loc1_ < var_237.length)
            {
               _loc2_ = var_237.getWithIndex(_loc1_) as DirectionData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function defineDirections(param1:XML) : Boolean
      {
         ...
         while(_loc5_ < _loc4_.length())
         {
            ...
            _loc7_ = int(_loc6_.@id);
            _loc8_ = _loc6_.layer;
            if(var_237.getValue(String(_loc7_)) != null)
            {
               return false;
            }
            ...
            var_237.add(String(_loc7_),_loc3_);
            var_1294 = -1;
            var_719 = null;
            _loc5_++;
         }
