package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_770:int = 15;
      
      private static const const_1066:int = 2;
      
      private static const const_354:int = 2;
      
      private static const const_771:int = 31;
      ...
      private function getNewPoint(param1:int, param2:Number) : Point
      {
         ...
         var_1007[param1] = _loc3_;
         if(int(_loc9_) == 0)
         {
            var_1005[param1] = getRandomAmplitudeFactor();
         }
      ...
      private function initItems(param1:Number) : void
      {
         ...
         var_1007 = new Array();
         var_1007.push(Math.random() * _loc2_ * 1.5);
         var_1007.push(Math.random() * _loc2_ * 1.5);
         var_1008 = new Array();
         var_1008.push(1);
         var_1008.push(-1);
         var_1006 = new Array();
         var_1006.push(const_1066);
         var_1006.push(const_1067);
         var_1005 = new Array();
         var_1005.push(getRandomAmplitudeFactor());
         var_1005.push(getRandomAmplitudeFactor());
      }
