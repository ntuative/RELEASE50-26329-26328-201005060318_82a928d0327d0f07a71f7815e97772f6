   ...
   public class FurniturePlane
   {
      ...
      public function setRotation(param1:Boolean) : void
      {
         if(param1 != var_2209)
         {
            if(!param1)
            {
               var_288.assign(var_629);
               var_287.assign(var_630);
            }
            else
            {
               var_288.assign(var_629);
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc9_:* = null;
         if(param1 == null || var_72 == null && var_922 != null || var_288 == null || var_287 == null || var_531 == null)
         {
            return false;
         }
         ...
         if(param1.updateId != var_1357)
         {
            ...
            if(_loc4_ != null && (_loc4_.x != var_1095 || _loc4_.y != var_2042 || _loc4_.z != var_2044 || param1.scale != var_2045))
            {
               var_1095 = _loc4_.x;
               var_2042 = _loc4_.y;
               var_2044 = _loc4_.z;
