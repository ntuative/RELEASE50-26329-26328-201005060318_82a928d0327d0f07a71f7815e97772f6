package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_815:BitmapData = null;
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_400,0,0,_loc4_,var_1452,var_814,var_815));
         }
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         var _loc6_:* = null;
         var _loc7_:* = null;
         var_1811 = int(_config.getKey("interstitial.interval","30000"));
         var_1810 = int(_config.getKey("interstitial.show.time","5000"));
         var_1451 = int(_config.getKey("interstitial.max.displays.flash","-1"));
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         var_1191 = _loc2_.imageUrl;
         var_1452 = _loc2_.clickUrl;
         if(var_1191 != "" && var_1452 != "")
         {
            _loc3_ = var_1191;
            ...
            _loc4_ = new URLRequest(var_1191);
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         var_1190 = _loc2_.imageUrl;
         var_1812 = _loc2_.clickUrl;
         var_679 = getTimer();
         if(var_1190 != "")
         {
            _loc3_ = var_1190;
            ...
            var_221.start();
            _loc4_ = new URLRequest(var_1190);
            _loc5_ = _assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_433,0,0,param1.bitmapData,var_1812));
            var_679 = getTimer();
         }
         else
         {
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_815 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(var_1451 > 0 && var_1453 >= var_1451)
         {
            return false;
         }
         var _loc1_:int = getTimer() - var_679;
         if(_loc1_ > var_1811)
         {
            ++var_1453;
      ...
      {
         var_302 = param2 as IHabboCommunicationManager;
         if(var_302 == null)
         {
            return;
         }
         _connection = var_302.getHabboMainConnection(onConnectionReady);
         if(_connection != null)
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_359));
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_814 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
