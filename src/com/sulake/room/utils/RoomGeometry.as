package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_744:Number = 64;
      
      public static const const_805:Number = 32;
      ...
      private var var_1477:Number = 1;
      
      private var var_2370:Number = 500;
      
      private var var_1479:Number = 1;
      
      private var var_83:Vector3d;
      
      private var var_82:Vector3d;
      
      private var var_2371:Number = -500;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         _y = new Vector3d();
         var_82 = new Vector3d();
         var_1019 = new Vector3d();
         var_1478 = 1;
         var_1479 = 1;
         x_scale = 1;
         y_scale = 1;
         var_1477 = Math.sqrt(0.5) / Math.sqrt(0.75);
         z_scale = 1;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:* = 0;
         var_228.assign(param1);
         if(var_228.x != _loc2_ || var_228.y != _loc3_ || var_228.z != _loc4_)
         {
            ++var_76;
         }
      ...
      {
         if(var_415 != param1 * var_1477)
         {
            var_415 = param1 * var_1477;
            ++var_76;
         }
      }
      ...
      {
         if(var_412 != param1 * var_1478)
         {
            var_412 = param1 * var_1478;
            ++var_76;
         }
      }
      ...
      {
         if(var_413 != param1 * var_1479)
         {
            var_413 = param1 * var_1479;
            ++var_76;
         }
      }
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(var_414 != null)
         {
            ...
            var_414.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            var_414.add(_loc3_,_loc4_);
            ++var_76;
         }
      }
      ...
      {
         return new Vector3d(var_228.x,var_228.y,var_228.z);
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            var_1019.assign(_loc22_);
         }
         else
         {
            var_1019.assign(_loc17_);
         }
         ++var_76;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.y *= var_413;
         _loc2_.z *= var_415;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,var_1019);
         if(_loc3_ < var_2371 || _loc3_ > var_2370)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= var_413;
            _loc2_.z *= var_415;
            _loc3_ = Vector3d.scalarProjection(_loc2_,var_1019);
         }
      ...
      {
         return new Vector3d(0 * var_412,0 * var_413,0 * var_415);
      }
      ...
      {
         return scale == const_744;
      }
      
      public function get scale() : Number
      {
         return var_202 / Math.sqrt(0.5);
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(var_414 != null)
         {
            ...
            return var_414.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc5_:Number = param1.x / var_202;
         var _loc6_:Number = -param1.y / var_202;
         var _loc7_:IVector3d = Vector3d.sum(Vector3d.product(var_83,_loc5_),Vector3d.product(_y,_loc6_));
         var _loc8_:Vector3d = new Vector3d(0 * var_412,0 * var_413,0 * var_415);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_82;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_412,param2.y * var_413,param2.z * var_415);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_412,param3.y * var_413,param3.z * var_415);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_412,param4.y * var_413,param4.z * var_415);
