package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private var var_1867:Number = -10000000;
      
      private var var_1864:Number = -10000000;
      
      private var var_2369:int = 0;
      
      private var var_484:RoomObjectCache;
      
      private var var_686:int;
      
      private var var_265:Sprite;
      
      private var var_1015:IRoomRenderingCanvasMouseListener = null;
      ...
      public function update() : void
      {
         if(var_1016 == 0)
         {
            checkMouseHits(var_1014.x,var_1014.y,MouseEvent.MOUSE_MOVE);
         }
         var_1016 = 0;
         ++var_1462;
      }
      ...
      public function initialize(param1:int, param2:int) : void
      {
         ...
         var_53.graphics.beginFill(var_2369);
      ...
      {
         var _loc11_:Number = param1 - var_686 / 2;
         var _loc12_:Number = param2 - var_687 / 2;
         var _loc13_:* = null;
      ...
      public function render(param1:int) : void
      {
         ...
         if(var_686 != var_1865 || var_687 != var_1866)
         {
            _loc10_ = true;
         }
         _loc5_ = 0;
         while(_loc5_ < _loc4_)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               _loc6_ += renderObject(_loc8_,_loc7_,param1,_loc10_,_loc6_);
            }
            _loc5_++;
         }
         var_411.sortOn("z",0 | 0);
         if(_loc6_ < var_411.length)
         {
            var_411.splice(_loc6_);
         }
         var _loc11_:* = null;
         _loc5_ = 0;
         while(_loc5_ < _loc6_)
         {
            _loc11_ = var_411[_loc5_] as SortableSprite;
            if(_loc11_ != null)
            {
         ...
         var_826.push(_loc12_ - _loc2_);
         if(var_826.length == const_772)
         {
            _loc13_ = 0;
            _loc14_ = 0;
            while(_loc14_ < const_772)
            {
               _loc13_ += var_826[_loc14_];
               _loc14_++;
            }
            var_826 = [];
         }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_485.length)
            {
               cleanSprite(var_485[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            var_485 = [];
         }
         ...
         while(_loc1_ < var_305.length)
         {
            ...
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  if(var_1015 != null)
                  {
                     var_1015.processRoomCanvasMouseEvent(_loc3_,_loc4_,_id + var_1462,geometry);
                  }
                  else
                  {
      ...
      public function method_13(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         var_1014.x = param1;
         var_1014.y = param2;
      ...
      {
         if(param1 < 0 || param1 >= var_411.length)
         {
            return null;
         }
         return var_411[param1] as SortableSprite;
      }
      ...
      private function checkMouseHits(param1:Number, param2:Number, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK || !_loc10_.clickHandling)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = var_483.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        var_483.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != var_1867 || param2 != var_1864)
                     {
                        bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = var_483.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = var_483.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  bufferMouseEvent(_loc11_,_loc9_);
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         if(false)
         {
            _loc3_ = var_485.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         if(_loc6_ == null)
         {
            var_484.removeObjectCache(param2);
            return 0;
         }
         var _loc7_:RoomObjectCacheItem = var_484.getObjectCache(param2);
         ...
         _loc13_ += int(var_686 / 2);
         _loc14_ += int(var_687 / 2);
         var _loc16_:int = 0;
         var _loc17_:* = null;
         var _loc18_:* = null;
         var _loc19_:int = 0;
         ...
         while(_loc22_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc23_ != null)
               {
                  ...
                  if(_loc19_ + _loc23_.width >= 0 && _loc19_ < var_686 && (_loc20_ + _loc23_.height >= 0 && _loc20_ < var_687))
                  {
