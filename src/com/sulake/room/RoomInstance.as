package com.sulake.room
{
   ...
   public class RoomInstance implements IRoomInstance
   {
      ...
      protected function disposeObjectManager(param1:int) : Boolean
      {
         ...
         if(var_239.getValue(_loc2_) != null)
         {
            _loc3_ = var_239.remove(_loc2_) as IRoomObjectManager;
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
      ...
      {
         if(var_1003.indexOf(param1) >= 0)
         {
            return;
         }
         if(param3)
         {
            var_1003.push(param1);
         }
      ...
      public function dispose() : void
      {
         ...
         if(var_239 != null)
         {
            ...
            {
               _loc3_ = var_239.getWithIndex(_loc2_) as IRoomObjectManager;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      public function setNumber(param1:String, param2:Number, param3:Boolean = false) : void
      {
         ...
         if(var_480[param1] != param2)
         {
            var_480[param1] = param2;
         }
      }
      ...
      protected function createObjectManager(param1:int) : IRoomObjectManager
      {
         ...
         if(var_239.getValue(_loc2_) != null)
         {
            return var_239.getValue(_loc2_) as IRoomObjectManager;
         }
         if(_container == null)
         {
            return null;
      ...
      {
         return var_239.getKeys();
      }
      
      protected function getObjectManager(param1:int) : IRoomObjectManager
      {
         return var_239.getValue(String(param1)) as IRoomObjectManager;
      }
