package com.sulake.room.object.visualization
{
   ...
   public class RoomObjectSpriteVisualization implements IRoomObjectSpriteVisualization
   {
      ...
      protected var var_213:int = -1;
      
      private var _updateID:int = 0;
      
      private var var_170:Array;
      
      protected var var_293:int = -1;
      
      protected var var_164:int = -1;
      ...
      public function dispose() : void
      {
         ...
         if(var_170 != null)
         {
            while(false)
            {
               _loc1_ = var_170[0] as RoomObjectSprite;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      protected function createSprites(param1:int) : void
      {
         ...
         {
            _loc2_ = var_170["-1"] as RoomObjectSprite;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
