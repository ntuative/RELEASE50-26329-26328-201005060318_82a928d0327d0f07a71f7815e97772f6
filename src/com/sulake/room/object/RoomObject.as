package com.sulake.room.object
{
   ...
   public class RoomObject implements IRoomObjectController
   {
      ...
      private var var_447:IRoomObjectEventHandler;
      ...
      {
         var_1592.assign(var_228);
         return var_1592;
      }
      
      public function setState(param1:int, param2:int) : Boolean
      {
         if(param2 >= 0 && param2 < var_532.length)
         {
            if(var_532[param2] != param1)
            {
               var_532[param2] = param1;
               ++_updateID;
            }
            return true;
         }
      ...
      public function setEventHandler(param1:IRoomObjectEventHandler) : void
      {
         ...
         var _loc2_:IRoomObjectEventHandler = var_447;
         if(_loc2_ != null)
         {
            var_447 = null;
            _loc2_.object = null;
      ...
      {
         if(param1 >= 0 && param1 < var_532.length)
         {
            return var_532[param1];
         }
         return -1;
      }
