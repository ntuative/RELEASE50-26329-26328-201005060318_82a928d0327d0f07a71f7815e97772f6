package com.sulake.core.window
{
   ...
   public class WindowModel implements IDisposable
   {
      ...
      protected var var_1397:uint;
      
      protected var var_644:Boolean = false;
      
      protected var var_433:Number = 1;
      ...
      public function WindowModel(param1:uint, param2:String, param3:uint, param4:uint, param5:uint, param6:WindowContext, param7:Rectangle, param8:Array = null)
      {
         ...
         _type = param3;
         _param = param5;
         var_33 = WindowState.const_88;
         var_80 = param4;
         var_643 = param8 == null ? new Array() : param8;
         var_16 = param6;
         var_8 = param7.clone();
      ...
      public function testStateFlag(param1:uint, param2:uint = 0) : Boolean
      {
         if(param2 > 0)
         {
            return (var_33 & param2 ^ param1) == 0;
         }
         return (var_33 & param1) == param1;
      }
