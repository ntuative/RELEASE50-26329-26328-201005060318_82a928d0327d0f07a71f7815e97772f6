package com.sulake.core.window.utils
{
   ...
   public class WindowRectLimits implements IRectLimiter
   {
      ...
      private var var_404:int = -2147483648;
      ...
      {
         return var_406 == int.MIN_VALUE && var_405 == int.MAX_VALUE && var_404 == int.MIN_VALUE && var_407 == int.MAX_VALUE;
      }
      ...
      {
         var_404 = param1;
         if(var_404 > int.MIN_VALUE && true && _target.height < var_404)
         {
