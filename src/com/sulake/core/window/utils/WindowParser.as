package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1460:String = "_INCLUDE";
      
      public static const const_820:String = "_EXCLUDE";
      
      public static const const_1496:String = "_TEMP";
      
      private static const const_1130:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1131:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1124:Dictionary;
      
      private var _disposed:Boolean = false;
      
      protected var var_958:Dictionary;
      
      protected var var_1403:Map;
      
      protected var var_16:IWindowContext;
      
      protected var var_1402:Dictionary;
      
      protected var var_1123:Dictionary;
      
      public function WindowParser(param1:IWindowContext)
      {
         super();
         var_16 = param1;
         var_1123 = new Dictionary();
         var_1124 = new Dictionary();
         TypeCodeTable.fillTables(var_1123,var_1124);
         var_958 = new Dictionary();
         var_1402 = new Dictionary();
         ParamCodeTable.fillTables(var_958,var_1402);
         var_1403 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1131,"");
         return param1.replace(const_1130,"");
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            for(_loc1_ in var_1123)
            {
               delete var_1123[_loc1_];
            }
            for(_loc1_ in var_1124)
            {
               delete var_1124[_loc1_];
            }
            for(_loc1_ in var_958)
            {
               delete var_958[_loc1_];
            }
            for(_loc1_ in var_1402)
            {
               delete var_1402[_loc1_];
            }
            var_1403.dispose();
            var_1403 = null;
            var_16 = null;
         ...
         if(window != null)
         {
            if(parent != null)
            {
               if(parent is IIterable)
               {
                  ...
                  {
                     if((params & 0) == WindowParam.const_163)
                     {
                        window.x = rect.x;
                     }
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_820) == -1)
                  {
