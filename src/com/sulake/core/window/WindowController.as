package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      private static var var_1574:Point = new Point();
      
      protected static const EXCLUDE_CHILD_TAG:String = "_EXCLUDE";
      
      protected static const INTERNAL_CHILD_TAG:String = "_INTERNAL";
      
      private static var var_1335:uint = 0;
       
      
      protected var var_166:Boolean = true;
      
      private var var_1081:Boolean = false;
      
      protected var _events:IEventDispatcher;
      
      private var var_323:Rectangle;
      
      protected var var_645:Function;
      
      protected var _children:Array;
      
      protected var var_1400:Boolean = false;
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_loc13_)
         {
            var_433 = _loc13_.blend;
            var_551 = _loc13_.treshold;
            if(var_644 != _loc13_.background)
            {
               background = _loc13_.background;
            }
            if(var_552 != _loc13_.color)
            {
               color = _loc13_.color;
            }
         }
      ...
      public static function resizeToAccommodateChildren(param1:WindowController, param2:Boolean = true) : void
      {
         ...
         var _loc11_:Boolean = param1.getParamFlag(WindowParam.const_67);
         if(param2)
         {
            _loc3_ = 0;
         ...
         if(_loc9_)
         {
            ...
            if(param2)
            {
               ...
               while(_loc3_ < _loc10_)
               {
                  ...
                  _loc13_ = param1.testParamFlag(WindowParam.const_89);
                  if(_loc13_)
                  {
      ...
      public static function expandToAccommodateChild(param1:WindowController, param2:IWindow) : void
      {
         ...
         if(_loc8_)
         {
            _loc9_ = param1.getParamFlag(WindowParam.const_67);
            param1.setParamFlag(WindowParam.const_67,false);
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_128,WindowParam.const_143);
         var _loc2_:* = !testParamFlag(WindowParam.const_112,WindowParam.const_140);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_8.clone();
            if(_loc1_)
            {
               ...
               if(_loc5_ == WindowParam.const_272)
               {
                  _loc3_.width += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_300)
               {
                  _loc3_.x += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_163)
               {
            ...
            if(_loc2_)
            {
               ...
               else if(_loc5_ == WindowParam.const_345)
               {
                  _loc3_.y += _loc4_;
               }
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            if(true)
            {
               if(!isChildWindow())
               {
                  if(getStateFlag(WindowState.const_99))
                  {
                     deactivate();
                  }
               }
      ...
      public function open() : Boolean
      {
         ...
         visible = true;
         _loc1_.type = WindowNotifyEvent.const_810;
         update(this,_loc1_);
         return true;
      }
      ...
      {
         var_644 = param1;
         var_552 = !!var_644 ? uint(var_552 | var_1397) : uint(var_552 & 16777215);
         var_166 = var_166 || param1;
         var_16.invalidate(this,var_8,WindowRedrawFlag.const_76);
      }
      
      public function set mouseTreshold(param1:uint) : void
      {
         var_551 = param1 > 255 ? 255 : uint(param1);
      }
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + var_2173 + "]";
      }
      ...
      protected function forwardWindowNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_1014:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_318:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_847:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_904:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1296:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            ...
            case WindowNotifyEvent.const_966:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_810:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_852:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_828:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_918:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            ...
            case WindowNotifyEvent.const_854:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_962:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_991:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_803:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            ...
            case WindowNotifyEvent.const_401:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_374:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_465:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_628:
               _loc2_ = "null";
               break;
      ...
      public function deactivate() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_847,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         _loc1_.type = WindowNotifyEvent.const_904;
         update(this,_loc1_);
         return true;
      }
      ...
      public function restore() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_991;
         update(this,_loc1_);
         return true;
      }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_17)
         {
            var_17 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_593,var_8);
            var_17.visible = var_348;
         }
         return var_17;
      }
      ...
      public function minimize() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_918,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         _loc1_.type = WindowNotifyEvent.const_836;
         update(this,_loc1_);
         return true;
      }
      ...
      {
         var_433 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
         var_16.invalidate(this,var_8,WindowRedrawFlag.const_871);
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(var_1081 || _loc3_.hasGraphicsContext())
         {
      ...
      {
         return testLocalPointHitAgainstAlpha(param1,param2,var_551);
      }
      
      public function set color(param1:uint) : void
      {
         var_1397 = param1 & 4278190080;
         var_552 = !!var_644 ? uint(param1) : uint(param1 & 16777215);
         var_16.invalidate(this,var_8,WindowRedrawFlag.const_76);
      }
      ...
      public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         var _loc7_:* = 0;
         var _loc8_:* = 0;
         if(!testParamFlag(WindowParam.const_569))
         {
         ...
         if(param2 is MouseEvent)
         {
            switch(param2.type)
            {
               case MouseEvent.MOUSE_DOWN:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_863;
                  if(testParamFlag(WindowParam.const_289))
                  {
                     _loc5_ = {};
                     while(_loc5_ != null)
                     {
                        if(_loc5_.testParamFlag(WindowParam.const_207))
                        {
               ...
               case MouseEvent.MOUSE_UP:
                  ...
                  if(testParamFlag(WindowParam.const_207))
                  {
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_162:
                  ...
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_488,this,null));
                     if(testParamFlag(WindowParam.const_163,WindowParam.const_143))
                     {
                        updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_167,WindowParam.const_140))
                     {
                        updateScaleRelativeToParent();
                     }
                     if(var_9 != null)
                     {
                        _loc8_ = uint(_param);
                        _param &= ~(0 | 0);
                        if(testParamFlag(WindowParam.const_470))
                        {
                           var_9.width += 0 - 0;
                        }
                  ...
                  break;
               case WindowNotifyEvent.const_481:
                  var_16.invalidate(this,var_8.union(var_56),WindowRedrawFlag.const_443);
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_844,this,null));
                     if(var_9 != null)
                     {
                        var_9.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_248,var_9,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_318:
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_628,this,null));
                     if(var_9 != null)
                     {
                        var_9.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_239,var_9,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_374:
                  var_16.invalidate(this,var_8,WindowRedrawFlag.const_857);
                  break;
               case WindowNotifyEvent.const_401:
                  _loc6_ = new Array();
               ...
               case WindowNotifyEvent.const_465:
                  if(!(_param & 0))
                  {
                     ...
                     {
                        setupGraphicsContext();
                        var_16.invalidate(this,var_8,WindowRedrawFlag.const_443);
                     }
                  }
                  else if(_param & 0)
                  {
               ...
               case WindowNotifyEvent.const_239:
                  ...
                  break;
               case WindowNotifyEvent.const_488:
                  var_9.getRegionProperties(null,var_323);
                  updateScaleRelativeToParent();
                  break;
               case WindowNotifyEvent.const_315:
      ...
      {
         return var_645 != null ? var_645 : (var_9 != null ? var_9.procedure : nullEventProc);
      }
      ...
      public function focus() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_803,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         _loc1_.type = WindowNotifyEvent.const_878;
         update(this,_loc1_);
         return true;
      }
      ...
      public function maximize() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_854,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         setStateFlag(WindowState.const_69,true);
         _loc1_.type = WindowNotifyEvent.const_962;
         update(this,_loc1_);
         return true;
      }
      ...
      public function validateGlobalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         ...
         return testLocalPointHitAgainstAlpha(_loc3_,param2,var_551);
      }
      ...
      public function activate() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_318;
         update(this,_loc1_);
         return true;
      }
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_742,this,param1));
         return param1;
      }
      ...
      public function disable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_529;
         update(this,_loc1_);
         return true;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(var_1081 || _loc2_.hasGraphicsContext())
         {
            setupGraphicsContext();
      ...
      public function set state(param1:uint) : void
      {
         ...
         {
            var_33 = param1;
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_374,this,null));
         }
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            else if(_loc7_ == WindowParam.const_413)
            {
               param1 -= param3 - 0;
               _loc5_ = true;
            }
            _loc7_ = uint(_param & 0);
            if(_loc7_ == WindowParam.const_360)
            {
               param2 -= (param4 - 0) / 2;
               _loc5_ = true;
            }
            else if(_loc7_ == WindowParam.const_402)
            {
               param2 -= param4 - 0;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_866,this,null,true);
               update(this,_loc10_);
            ...
            if(_loc6_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_724,this,null,true);
               update(this,_loc10_);
               if(_loc10_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc5_)
            {
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_481,this,null));
            }
            if(_loc6_)
            {
      ...
      public function lock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1311,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         setStateFlag(WindowState.const_69,true);
         _loc1_.type = WindowNotifyEvent.const_1216;
         update(this,_loc1_);
         return true;
      }
         ...
         if(var_166 && var_551 > 0)
         {
            if(!testParamFlag(WindowParam.const_35))
            {
               if(param1.x <= var_8.width && param1.y <= var_8.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1574,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1574,param3,param1)) : false;
            }
         }
      ...
      override public function invalidate(param1:Rectangle = null) : void
      {
         ...
         var_16.invalidate(this,param1,WindowRedrawFlag.const_76);
      }
      ...
      public function unlock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1238,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(var_9 != param1)
         {
            ...
            if(var_9 != null)
            {
               var_323 = var_9.rectangle.clone();
               var_56.x = var_8.x;
               var_56.y = var_8.y;
               var_56.width = var_8.width;
               var_56.height = var_8.height;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_398,this,var_9));
            }
            else
            {
               var_323.x = 0;
               ...
               var_323.width = 0;
               var_323.height = 0;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_915,this,_loc2_));
            }
         }
      }
      ...
      public function setParamFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(_param != _loc3_)
         {
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_465,this,null));
         }
      }
      ...
      public function expandToAccommodateChildren() : void
      {
         ...
         var _loc8_:Boolean = getParamFlag(WindowParam.const_67);
         for each(_loc1_ in _children)
         {
         ...
         if(_loc7_)
         {
            if(_loc8_)
            {
               setParamFlag(WindowParam.const_67,false);
            }
            ...
            if(_loc8_)
            {
               setParamFlag(WindowParam.const_67,true);
            }
         }
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_80,_param,var_16,var_8,null,var_645,properties,var_643.concat(),_id) as WindowController;
         _loc2_.var_551 = var_551;
         _loc2_.var_166 = var_166;
         _loc2_.var_1400 = var_1400;
         _loc2_.var_323 = var_323.clone();
         ...
         _loc2_.var_552 = var_552;
         _loc2_.var_1397 = var_1397;
         _loc2_.var_1122 = var_1122;
         _loc2_.var_348 = var_348;
      ...
      public function enable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_611;
         update(this,_loc1_);
         return true;
      }
      ...
      protected function forwardMouseEvent(param1:MouseEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_DOWN:
               ...
               break;
            case MouseEvent.MOUSE_UP:
               _loc2_ = !!_loc6_ ? "null" : WindowMouseEvent.const_464;
               break;
            case MouseEvent.MOUSE_WHEEL:
               _loc2_ = "null";
         }
      ...
      public function unfocus() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_935,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function close() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_852,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         visible = false;
         _loc1_.type = WindowNotifyEvent.const_828;
         update(this,_loc1_);
         return true;
      }
      ...
      {
         if(var_33 == WindowState.const_475)
         {
            return true;
         }
         var_33 = WindowState.const_475;
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_811,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
