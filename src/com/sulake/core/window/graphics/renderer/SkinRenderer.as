package com.sulake.core.window.graphics.renderer
{
   ...
   public class SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_332:Dictionary;
      
      protected var var_459:Dictionary;
      
      public function SkinRenderer(param1:Array)
      {
         super();
         var_333 = new Dictionary();
         var_332 = new Dictionary();
      ...
      public function removeTemplate(param1:ISkinTemplate) : ISkinTemplate
      {
         ...
         if(param1 != null)
         {
            for(_loc2_ in var_332)
            {
               _loc3_ = uint(_loc2_ as uint);
               if(var_332[_loc3_] == param1)
               {
      ...
      {
         var _loc3_:ISkinLayout = var_459[param2];
         if(_loc3_ == null)
         {
      ...
      public function dispose() : void
      {
         ...
         {
            ISkinLayout(var_459[_loc1_]).dispose();
