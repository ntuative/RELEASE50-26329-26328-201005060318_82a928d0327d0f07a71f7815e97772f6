package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_853:uint = 256;
      
      protected static var var_648:uint = 0;
      
      protected static var var_385:uint = 0;
      
      public static const const_992:uint = 2;
      
      public static const const_1632:uint = 128;
      
      public static const const_1545:uint = 64;
      
      public static const const_636:uint = 4;
      
      public static const const_1396:uint = 0;
      
      public static const const_1246:uint = 16;
      
      public static const const_593:uint = 1;
      
      public static const const_1240:uint = 8;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_992:
               ...
               break;
            case GraphicContext.const_1240:
               setDisplayObject(new Shape());
               break;
            case GraphicContext.const_1246:
               setDisplayObject(new MorphShape());
               break;
            case GraphicContext.const_636:
               setDisplayObject(new Sprite());
               break;
            case GraphicContext.const_853:
               break;
            case GraphicContext.const_1396:
               break;
            default:
      ...
      protected function releaseDrawBuffer() : void
      {
         ...
         if(var_640)
         {
            ...
            if(_loc1_ is Bitmap)
            {
               ...
               if(_loc2_ != null)
               {
                  var_385 -= _loc2_.width * _loc2_.height * 4;
                  _loc2_.dispose();
               }
            }
         }
         ...
         if(var_640)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap != null)
               {
                  ...
                  {
                     var_385 -= bitmap.width * bitmap.height * 4;
                     bitmap.dispose();
                     bitmap = null;
                  }
               }
      ...
      public function method_9(param1:Rectangle, param2:Boolean) : void
      {
         if(var_640 && param2)
         {
