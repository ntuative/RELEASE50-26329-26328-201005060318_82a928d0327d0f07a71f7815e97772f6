package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_813:IItemListWindow;
      
      private var var_346:IScrollbarWindow;
      ...
      public function ScrollableItemListWindow(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_scrollBar.testStateFlag(WindowState.const_75))
         {
            hideScrollBar();
         }
      }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_346)
         {
            var_346 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(var_346)
            {
               var_346.addEventListener(WindowEvent.const_268,scrollBarEventProc);
               var_346.addEventListener(WindowEvent.const_199,scrollBarEventProc);
            }
         }
         return var_346;
      }
      ...
      override public function dispose() : void
      {
         if(var_346)
         {
            var_346.removeEventListener(WindowEvent.const_268,scrollBarEventProc);
            var_346.removeEventListener(WindowEvent.const_199,scrollBarEventProc);
            var_346 = null;
         }
         if(var_813)
         {
      ...
      {
         if(param1.type == WindowEvent.const_268)
         {
            showScrollBar();
         }
         else if(param1.type == WindowEvent.const_199)
         {
            hideScrollBar();
         }
      }
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!var_813)
         {
            var_813 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
         return var_813;
      }
