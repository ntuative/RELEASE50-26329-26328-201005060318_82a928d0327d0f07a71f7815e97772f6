package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      protected static const const_1037:String = "tool_tip_caption";
      ...
      protected var var_953:uint = 500;
      
      public function InteractiveController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         param4 |= 0;
         var_458 = new Array();
         var_458[0] = MouseCursorType.const_327;
         var_458[1] = MouseCursorType.const_42;
         var_458[2] = MouseCursorType.const_327;
         var_458[3] = MouseCursorType.const_327;
         var_458[4] = MouseCursorType.const_42;
         var_458[5] = MouseCursorType.const_42;
         var_458[6] = MouseCursorType.const_327;
         if(var_334 == null)
         {
            var_334 = new Array();
            var_334[0] = WindowState.const_99;
            var_334[1] = WindowState.const_79;
            var_334[2] = WindowState.const_82;
            var_334[3] = WindowState.const_69;
            var_334[4] = WindowState.WINDOW_STATE_SELECTED;
            var_334[5] = WindowState.const_100;
      ...
      {
         param2.push(new PropertyStruct(const_1037,param1.toolTipCaption,PropertyStruct.STRING,param1.toolTipCaption != const_747));
         param2.push(new PropertyStruct(KEY_TOOLTIP_DELAY,param1.toolTipDelay,PropertyStruct.const_1008,param1.toolTipDelay != const_1412));
         return param2;
      }
         ...
         for each(_loc3_ in param2)
         {
            switch(_loc3_.key)
            {
               ...
               case "mouse_cursor_pressed":
                  param1.setMouseCursorByState(WindowState.const_100,_loc3_.value as uint);
                  break;
      ...
      {
         var_954 = param1 == null ? const_747 : param1;
      }
