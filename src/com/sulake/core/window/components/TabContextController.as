package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      protected var var_955:ITabSelectorWindow;
      
      private var var_807:Boolean = false;
      
      protected var var_1620:IWindowContainer;
      ...
      public function get container() : IWindowContainer
      {
         if(var_1620 == null)
         {
            var_1620 = findChildByTag(TabContextController.TAB_CONTEXT_CONTENT_TAG) as IWindowContainer;
         }
         return var_1620;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         if(var_955 == null)
         {
            var_955 = findChildByTag(TabContextController.TAB_CONTEXT_SELECTOR_TAG) as ITabSelectorWindow;
            if(var_955 != null)
            {
               var_955.procedure = selectorEventProc;
            }
         }
         return var_955;
      }
      ...
      {
         return !!var_807 ? selector.iterator : null;
      }
