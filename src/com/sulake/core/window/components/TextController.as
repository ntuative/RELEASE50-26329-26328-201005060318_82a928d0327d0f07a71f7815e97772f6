package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static var var_2364:Rectangle = new Rectangle();
       
      
      protected var var_214:Boolean;
      
      protected var var_69:TextMargins;
      
      protected var var_550:String = "none";
      
      protected var var_642:Number;
      
      protected var var_379:Number;
      
      protected var _field:TextField;
      
      protected var var_776:Boolean = false;
      ...
      {
         var_69 = new TextMargins(0,0,0,0,setTextMargins);
         var_214 = false;
         var_642 = 0;
         var_379 = 0;
         if(_field == null)
      ...
      {
         param1.var_69.dispose();
         param1.var_69 = new TextMargins(int(param2["left"]),int(param2["top"]),int(param2["right"]),int(param2["bottom"]),param1.setTextMargins);
         param1.refreshTextImage();
      }
      ...
      {
         return new Rectangle(var_642 * maxScrollH,var_379 * maxScrollV,width,height);
      }
      ...
      override public function dispose() : void
      {
         if(var_776)
         {
            context.removeLocalizationListener(var_331,this);
         }
         if(var_69 != null)
         {
            var_69.dispose();
      ...
      {
         var_642 = param1;
         _field.scrollH = var_642 * Number(_field.maxScrollH);
         refreshTextImage();
      }
      ...
      public function set text(param1:String) : void
      {
         ...
         var_331 = param1;
         if(var_331.charAt(0) == "$" && var_331.charAt(1) == "{")
         {
            context.registerLocalizationListener(var_331.slice(2,var_331.indexOf("}")),this);
            var_776 = true;
         }
         else if(_field != null)
         {
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         if(!var_214)
         {
            if(param2.type == WindowNotifyEvent.const_162)
            {
               refreshTextImage();
            }
         }
      ...
      public function setTextMargins(param1:IMargins) : void
      {
         ...
         {
            var_69.dispose();
            var_69 = new TextMargins(param1.left,param1.top,param1.right,param1.bottom,setTextMargins);
         }
         refreshTextImage();
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("font_size",defaultTextFormat.size,PropertyStruct.const_1008,true));
         _loc1_.push(new PropertyStruct("text_color",_field.textColor,PropertyStruct.const_485,true));
         _loc1_.push(new PropertyStruct("antialias_type",_field.antiAliasType,PropertyStruct.STRING,true));
         _loc1_.push(new PropertyStruct("always_show_selection",_field.alwaysShowSelection,PropertyStruct.const_61,true));
         _loc1_.push(new PropertyStruct("border",_field.border,PropertyStruct.const_61,false));
         _loc1_.push(new PropertyStruct("border_color",_field.borderColor,PropertyStruct.const_485,true));
         _loc1_.push(new PropertyStruct("condense_white",_field.condenseWhite,PropertyStruct.const_61,true));
         _loc1_.push(new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_61,true));
         _loc1_.push(new PropertyStruct("embed_fonts",_field.embedFonts,PropertyStruct.const_61,true));
         _loc1_.push(new PropertyStruct("grid_fit_type",_field.gridFitType,PropertyStruct.STRING,true));
         _loc1_.push(new PropertyStruct("max_chars",_field.maxChars,PropertyStruct.const_70,true));
         _loc1_.push(new PropertyStruct("mouse_wheel_enabled",_field.mouseWheelEnabled,PropertyStruct.const_61,true));
         _loc1_.push(new PropertyStruct("multiline",_field.multiline,PropertyStruct.const_61,true));
         _loc1_.push(new PropertyStruct("restrict",_field.restrict,PropertyStruct.STRING,false));
         _loc1_.push(new PropertyStruct("sharpness",_field.sharpness,PropertyStruct.const_604,true));
         _loc1_.push(new PropertyStruct("style_sheet",_field.styleSheet,PropertyStruct.STRING,false));
         _loc1_.push(new PropertyStruct("thickness",_field.thickness,PropertyStruct.const_604,true));
         _loc1_.push(new PropertyStruct("word_wrap",_field.wordWrap,PropertyStruct.const_61,true));
         _loc1_.push(new PropertyStruct("margin_left",var_69.left,PropertyStruct.const_70,true));
         _loc1_.push(new PropertyStruct("margin_top",var_69.top,PropertyStruct.const_70,true));
         _loc1_.push(new PropertyStruct("margin_right",var_69.right,PropertyStruct.const_70,true));
         _loc1_.push(new PropertyStruct("margin_bottom",var_69.bottom,PropertyStruct.const_70,true));
         _loc1_.push(new PropertyStruct("auto_size",var_550,PropertyStruct.STRING,var_550 != TextFieldAutoSize.NONE));
         _loc1_.push(new PropertyStruct("bold",_field.defaultTextFormat.bold != false,PropertyStruct.const_61,_field.defaultTextFormat.bold != false));
         _loc1_.push(new PropertyStruct("italic",_field.defaultTextFormat.italic != false,PropertyStruct.const_61,_field.defaultTextFormat.italic != false));
         _loc1_.push(new PropertyStruct("underline",_field.defaultTextFormat.underline != false,PropertyStruct.const_61,_field.defaultTextFormat.underline != false));
         _loc1_.push(new PropertyStruct("kerning",_field.defaultTextFormat.kerning != false,PropertyStruct.const_61,_field.defaultTextFormat.kerning != false));
         _loc1_.push(new PropertyStruct("spacing",_field.defaultTextFormat.letterSpacing,PropertyStruct.const_604,_field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
      ...
      override public function clone() : IWindow
      {
         ...
         _loc1_.var_642 = var_642;
         _loc1_.var_379 = var_379;
         _loc1_.var_69 = var_69.clone(_loc1_.setTextMargins);
         _loc1_.var_550 = var_550;
         _loc1_.var_776 = var_776;
         return _loc1_;
      }
      ...
      protected function refreshTextImage() : void
      {
         ...
         if(_loc5_ != _loc3_)
         {
            if(var_550 == TextFieldAutoSize.LEFT)
            {
               setRectangle(var_8.x,var_8.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_550 == TextFieldAutoSize.RIGHT)
            {
               setRectangle(var_8.x,var_8.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_550 != TextFieldAutoSize.CENTER)
            {
         ...
         {
            if(var_550 != TextFieldAutoSize.NONE)
            {
               setRectangle(var_8.x,var_8.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
