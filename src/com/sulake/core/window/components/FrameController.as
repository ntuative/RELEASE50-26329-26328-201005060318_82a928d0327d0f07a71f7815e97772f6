package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1041:String = "_HEADER";
      
      private static const const_749:String = "margin_right";
      
      private static const const_1038:String = "_SCALER";
      
      private static const const_1040:String = "_TITLE";
      
      private static const const_1039:String = "_CONTENT";
      
      private static const const_750:String = "margin_left";
      
      private static const const_748:String = "margin_bottom";
      ...
      private var var_1132:IHeaderWindow;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_750,_loc3_.left,PropertyStruct.const_70,_loc2_));
         _loc1_.push(new PropertyStruct(const_751,_loc3_.top,PropertyStruct.const_70,_loc2_));
         _loc1_.push(new PropertyStruct(const_749,0 - _loc3_.right,PropertyStruct.const_70,_loc2_));
         _loc1_.push(new PropertyStruct(const_748,0 - _loc3_.bottom,PropertyStruct.const_70,_loc2_));
         return _loc1_;
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc3_:Boolean = testParamFlag(WindowParam.const_212);
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1132 == null)
         {
            var_1132 = findChildByTag(const_1041) as IHeaderWindow;
            if(!var_1132)
            {
      ...
      public function get title() : ITextWindow
      {
         if(_title == null)
         {
            _title = findChildByTag(const_1040) as ITextWindow;
            if(!_title)
            {
      ...
      {
         return findChildByTag(const_1038) as IScalerWindow;
      }
      ...
      {
         return content != null && var_1388 ? content.iterator : new Iterator(this);
      }
      ...
      public function get content() : IWindowContainer
      {
         if(var_20 == null)
         {
            var_20 = findChildByTag(const_1039) as IWindowContainer;
            if(!var_20)
            {
