package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow
   {
      ...
      protected static const const_1034:String = "spacing";
      
      protected static const const_1408:Boolean = false;
      
      protected static const DEF_SPACING:int = 0;
      
      protected static const const_1036:String = "scale_to_fit_items";
      
      protected static const DEF_RESIZE_ON_ITEM_UPDATE:Boolean = false;
      
      protected static const const_1409:Boolean = true;
      
      protected static const const_1035:String = "auto_arrange_items";
      ...
      protected var var_2362:Number = 0;
      ...
      protected var var_1116:Boolean = false;
      
      protected var var_547:Number;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         var_88 = 0;
         var_68 = 0;
         _horizontal = param2 == WindowType.const_293;
         super(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11);
         var_166 = var_644 || !testParamFlag(WindowParam.const_35);
         _container = var_16.create("_CONTAINER","",WindowType.const_324,WindowStyle.const_335,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[WindowController.INTERNAL_CHILD_TAG,WindowController.EXCLUDE_CHILD_TAG]) as IWindowContainer;
         ...
         _container.addEventListener(WindowEvent.const_242,containerEventHandler);
         _container.addEventListener(WindowEvent.const_373,containerEventHandler);
         resizeOnItemUpdate = var_1116;
      }
      ...
      {
         return new Rectangle(var_546 * maxScrollH,var_547 * maxScrollV,width,height);
      }
      ...
      override public function dispose() : void
      {
         ...
         _container.removeEventListener(WindowEvent.const_242,containerEventHandler);
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_1034,_spacing,PropertyStruct.const_70,_spacing != DEF_SPACING));
         _loc1_.push(new PropertyStruct(const_1035,var_774,PropertyStruct.const_61,var_774 != const_1409));
         _loc1_.push(new PropertyStruct(const_1036,var_548,PropertyStruct.const_61,var_548 != const_1408));
         _loc1_.push(new PropertyStruct(const_1033,var_1116,PropertyStruct.const_61,var_1116 != DEF_RESIZE_ON_ITEM_UPDATE));
         return _loc1_;
      }
      ...
      public function set scrollV(param1:Number) : void
      {
         ...
         {
            var_547 = param1;
            _container.y = -var_547 * maxScrollV;
            var_16.invalidate(_container,visibleRegion,WindowRedrawFlag.const_76);
         }
      }
