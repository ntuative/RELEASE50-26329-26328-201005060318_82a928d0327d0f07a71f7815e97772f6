package com.sulake.core.window.components
{
   ...
   public class DesktopController extends ActivatorController implements IDesktopWindow, IDisplayObjectWrapper
   {
      ...
      {
         var_645 = param1 != null ? param1 : defaultProcedure;
      }
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_17)
         {
            var_17 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_853,var_8);
            GraphicContext(var_17).mouseEnabled = true;
            GraphicContext(var_17).doubleClickEnabled = true;
         }
         return var_17;
      }
