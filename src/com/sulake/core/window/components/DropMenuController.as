package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow
   {
      ...
      private var var_138:DropMenuController;
      
      private var var_522:int = -1;
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(var_138 == null || false)
         {
            var_138 = context.create(name + "::submenu","",WindowType.const_449,var_80,0 | 0,_loc1_,subMenuEventProc,null,0,null,[WindowController.EXCLUDE_CHILD_TAG]) as DropMenuController;
         }
         else
         {
            var_138.setGlobalRectangle(_loc1_);
         }
         var_138.activate();
         return var_138;
      }
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowEvent.const_889)
         {
            if(param2 == var_138)
            {
               closeMenuView();
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_324,var_80,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         ...
         if(var_522 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(var_522).setStateFlag(WindowState.WINDOW_STATE_SELECTED,true);
         }
      }
      ...
      protected function openMenuView() : void
      {
         if(!var_620)
         {
            if(open())
            {
               if(false)
               {
                  populateMenuItemContainer(var_523,getSubMenu(),subMenuEventProc);
                  var_620 = true;
               }
            }
         }
      ...
      public function set selection(param1:int) : void
      {
         ...
         var _loc2_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_416,this,null,true);
         update(this,_loc2_);
         if(!_loc2_.isWindowOperationPrevented())
         {
            var_522 = param1;
            closeMenuView();
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_337,this,null));
         }
      }
      ...
      public function getMenuItemIndex(param1:IDropMenuItemWindow) : int
      {
         ...
         if(_loc2_ == -1)
         {
            if(var_138 != null)
            {
               _loc2_ = var_138.getMenuItemIndex(param1);
            }
         }
         return _loc2_;
      }
      ...
      protected function closeMenuView() : void
      {
         if(close())
         {
            ...
            var_620 = false;
            getTitleText().text = var_522 < var_523.length && var_522 > -1 ? "null" : caption;
         }
      }
   }
}
