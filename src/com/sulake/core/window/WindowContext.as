package com.sulake.core.window
{
   ...
   public class WindowContext implements IWindowContext, IDisposable, IUpdateReceiver
   {
      ...
      public static var var_945:MouseEventQueue;
      
      public static var var_1614:IMouseCursor;
      
      public static const const_1481:int = 2;
      
      private static var var_1073:Factory;
      ...
      protected var var_2299:IWindowFactory;
      
      private var _disposed:Boolean = false;
      
      private var var_734:WindowController;
      
      private var var_759:Date;
      
      protected var var_2300:IWindowParser;
      
      protected var var_956:Error;
      
      protected var var_2301:IInternalWindowServices;
      
      protected var var_96:WindowController;
      
      protected var var_1396:int = -1;
      ...
      public function WindowContext(param1:String, param2:IWindowRenderer, param3:IWindowFactory, param4:ICoreLocalizationManager, param5:DisplayObjectContainer, param6:Rectangle, param7:IWindowContextStateListener)
      {
         ...
         var_330 = param5;
         var_2301 = new InternalWindowServices(this,param5);
         var_2299 = param3;
         var_2300 = new WindowParser(this);
         var_759 = new Date();
         if(var_1073 == null)
         {
            var_1073 = new Factory();
         }
         if(var_945 == null)
         {
            var_945 = new MouseEventQueue(param5);
         }
         if(var_1385 == null)
         {
      ...
      {
         var _loc12_:Class = var_1073.getWindowClassByType(param3);
         if(_loc12_ == null)
         {
            handleError(WindowContext.const_1360,new Error("Failed to solve implementation for window \"" + param1 + "\"!"));
            return null;
         }
         if(param8 == null)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc7_:MouseEventQueue = WindowContext.var_945;
         _loc7_.begin();
         var_616.x = -1;
         var_616.y = -1;
         while(true)
         {
            ...
            if(_loc2_.stageX != var_616.x || _loc2_.stageY != var_616.y)
            {
               var_616.x = _loc2_.stageX;
               var_616.y = _loc2_.stageY;
               _loc5_ = new Array();
               var_90.groupChildrenUnderPoint(var_616,_loc5_);
            }
      ...
      public function getMouseCursor() : IMouseCursor
      {
         if(var_1614 == null)
         {
            var_1614 = new MouseCursorControl(var_330);
         }
         return var_1614;
      }
