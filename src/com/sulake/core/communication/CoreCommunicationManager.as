package com.sulake.core.communication
{
   ...
   public class CoreCommunicationManager extends Component implements ICoreCommunicationManager, IUpdateReceiver
   {
      ...
      private var var_671:Dictionary;
      
      private var var_395:Dictionary;
      
      private var var_1170:IConnectionStateListener;
      ...
      {
         super(param1,param2);
         var_395 = new Dictionary();
         var_672 = new Dictionary();
         var_671 = new Dictionary();
         var_1171 = new Array();
      ...
      public function getMessageEvents(param1:IConnection, param2:Class) : Array
      {
         ...
         var _loc5_:Array = var_671[_loc3_];
      ...
      {
         var _loc3_:Array = var_671[param1];
         if(_loc3_ == null)
         {
            _loc3_ = new Array();
      ...
      {
         if(param1 == null || var_395 == null)
         {
            return null;
         }
         return var_395[param1] as IConnection;
      }
      ...
      public function getMessageParser(param1:Class) : IMessageParser
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         for each(var _loc6_ in var_1171)
         {
            _loc3_ = _loc6_;
            _loc6_;
            if(_loc3_ is param1)
      ...
      {
         var _loc2_:Class = var_672[param1];
         var _loc3_:* = null;
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:* = null;
         for each(var _loc5_ in var_395)
         {
            _loc2_ = _loc5_;
            _loc5_;
      ...
      public function createConnection(param1:String, param2:uint = 0) : IConnection
      {
         ...
         switch(param2)
         {
            case ConnectionType.const_928:
               _loc3_ = new SocketConnection(param1,this,var_1170);
               break;
            default:
               Logger.log("[CoreCommunicationManager] Unknown connectionType, can not create connection: " + param2);
         }
         var_395[param1] = _loc3_;
         return _loc3_;
      }
