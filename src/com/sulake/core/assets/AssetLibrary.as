package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      private static var var_1051:Array = new Array();
      
      private static var _sharedListOfTypesByMime:Dictionary;
      
      private static var var_598:uint = 0;
      
      public static const const_1015:String = "AssetLibraryReady";
      
      public static const const_1253:String = "AssetLibraryUnloaded";
      
      public static const const_386:String = "AssetLibraryLoaded";
      
      public static const const_1165:String = "AssetLibraryLoadError";
       
      
      private var var_504:XML;
      ...
      private var var_505:Boolean = true;
      
      private var var_357:Class;
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         ++var_598;
         var_425 = new Dictionary(false);
         var_426 = new Dictionary(false);
         var_711 = new Dictionary(false);
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in var_425)
         {
            _loc4_ = AssetTypeDeclaration(var_425[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      public function unload() : void
      {
         ...
         var_310 = false;
         _file = null;
         dispatchEvent(new Event(AssetLibrary.const_1253));
      }
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         var_504 = _loc2_.manifest.copy();
         var_357 = _loc2_.resource;
         if(var_505)
         {
            AssetLibrary.fetchLibraryContents(this,var_504,var_357);
         }
         var_310 = true;
         dispatchEvent(new Event(AssetLibrary.const_386));
         dispatchEvent(new Event(AssetLibrary.const_1015));
         if(var_505)
         {
            var_15.dispose();
            var_15 = null;
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = var_426[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_958,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_993,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_909,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_980,assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         var_426[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(var_425.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_425[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            unload();
            super.dispose();
            var_1051.splice(var_1051.indexOf(this),1);
            --var_598;
            var_426 = null;
            var_711 = null;
            _loadedAssets = null;
      ...
      {
         return param1 < var_356.length ? getAssetByName(var_356[param1]) : null;
      }
      ...
      private function loadErrorHandler(param1:Event) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1165));
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         {
            _loc3_ = AssetTypeDeclaration(var_425[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      {
         var _loc2_:Class = var_711[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadFromFile(param1:URLRequest, param2:Boolean = true, param3:LoaderContext = null) : LibraryLoader
      {
         ...
         else
         {
            if(var_15 == null)
            {
               var_15 = new LibraryLoader(var_1400);
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = var_504.child("library");
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc6_ < _loc2_.length())
            {
               ...
               if(_loc3_.attribute("name") == param1)
               {
                  ...
                  _loc5_.setUnknownContent(var_357[param1]);
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = var_426[loader.url];
         if(struct == null)
         {
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in _loadedAssets)
            {
               if(_loadedAssets[_loc2_] == param1)
               {
                  var_356.splice(var_356.indexOf(_loc2_),1);
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         _loc3_ = AssetTypeDeclaration(var_425[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
      ...
      {
         return var_357 != null ? false : false;
      }
   }
}
