package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_989:uint = 4;
      
      public static const COMPONENT_EVENT_ERROR:String = "COMPONENT_EVENT_ERROR";
      
      public static const const_1603:uint = 1;
      ...
      protected var var_1117:uint;
      
      protected var _isDisposed:Boolean = false;
      
      protected var var_956:String = "";
      
      protected var var_2296:String = "";
      
      protected var _assets:IAssetLibrary;
      
      protected var var_444:uint = 0;
      
      protected var var_2363:String = "";
      
      protected var var_16:IContext = null;
      
      protected var var_2070:Boolean = false;
      
      protected var _events:EventDispatcher;
      
      protected var var_186:InterfaceStructList;
      
      public function Component(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         super();
         var_1117 = param2;
         var_186 = new InterfaceStructList();
      ...
      public function release(param1:IID) : uint
      {
         ...
         var _loc2_:InterfaceStruct = var_186.getStructByInterface(param1);
         if(_loc2_ == null)
         {
            var_956 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(var_956);
         }
         var _loc3_:uint = _loc2_.release();
         if(var_1117 & const_989)
         {
            if(_loc3_ == 0)
            {
               if(var_186.getTotalReferenceCount() == 0)
               {
                  var_16.detachComponent(this);
                  this.dispose();
               }
            }
         }
      ...
      {
         var_16.removeUpdateReceiver(param1);
      }
      ...
      public function toXMLString(param1:uint = 0) : String
      {
         ...
         while(_loc8_ < _loc7_)
         {
            _loc6_ = var_186.getStructByIndex(_loc8_);
      ...
      {
         var_16.registerUpdateReceiver(param1,param2);
      }
      ...
      public function queueInterface(param1:IID, param2:Function = null) : IUnknown
      {
         ...
         if(_loc3_ == null)
         {
            return var_16.queueInterface(param1,param2);
         }
         if(_isDisposed)
         {
      ...
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + var_444 + "]";
      }
