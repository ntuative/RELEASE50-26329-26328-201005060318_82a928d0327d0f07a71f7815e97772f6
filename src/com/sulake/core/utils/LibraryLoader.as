package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1030:int = 5;
      ...
      protected var var_2289:String = "";
      
      protected var var_67:URLRequest;
      
      protected var var_1400:Boolean = false;
      
      protected var _name:String;
      
      protected var var_357:Class;
      ...
      protected function prepareLibrary() : void
      {
         ...
         var_357 = this.getDefinition(_name) as Class;
         if(var_357 == null)
         {
            failure("Failed to find resource class \"" + _name + "\" in library " + var_67.url + "!");
            return;
         }
         try
         {
            xmlClass = var_357.manifest as Class;
            if(xmlClass == null)
            {
               return;
            }
