package
{
   ...
   public class Habbo extends MovieClip
   {
      ...
      public static const const_10:String = "client.init.swf.loaded";
      
      public static const const_21:String = "client.init.volter.retry";
      
      public static const const_4:String = "fileLoadingBar";
      
      public static const const_12:String = "error_desc";
      
      public static const const_2:String = "byteLoadingBar";
      
      public static const const_20:String = "client.init.volter.fail";
      
      private static var _crashURL:String = "";
      
      public static const const_9:String = "byteBarSprite";
      
      public static const const_11:String = "crash_time";
      
      private static const const_5:String = "client.starting";
      
      public static const const_6:String = "background";
      
      public static const const_29:String = "client.init.core.init";
      ...
      public static const const_28:String = "client.init.core.fail";
      
      public static const const_22:String = "error_cat";
      ...
      private static const const_27:String = "HABBO_LOCAL_CONNECTION";
      
      public static const const_16:String = "client.init.start";
      
      public static const const_13:int = 11;
      
      public static const const_23:String = "debug";
      
      private static const const_25:Number = 0.29;
      
      public static const const_17:String = "avg_update";
      
      public static const const_14:String = "client.init.volter.loaded";
      
      private static const const_26:String = "testLocalConnection";
      
      public static const const_19:String = "error_data";
      ...
      private var var_6:Bitmap;
      
      private var var_5:LocalConnection;
      ...
      public static function reportCrash(param1:String, param2:int, param3:Error) : void
      {
         ...
         if(!Habbo._crashed)
         {
            ...
            _loc6_[const_11] = new Date().getTime().toString();
            _loc7_ = "";
            _loc6_[const_18] = _loc7_;
            _loc6_[const_15] = Capabilities.version;
            _loc6_[const_17] = 0;
            _loc6_[const_12] = param1;
            _loc6_[const_22] = String(param2);
            if(param3 != null)
            {
               _loc6_[const_19] = String(param3.getStackTrace());
            }
            _loc6_[const_23] = "Memory usage: " + Math.round(0 / (1024 * 1024)) + " MB";
            _loc5_.data = _loc6_;
      ...
      private static function positionLoadingScreenDisplayElements(param1:DisplayObjectContainer) : void
      {
         ...
         var _loc5_:Sprite = param1.getChildByName(const_4) as Sprite;
         if(_loc5_)
         {
            _loc5_.x = 89;
            _loc5_.y = 149;
      ...
      private function onVolterLoadingFailedAgain(param1:IOErrorEvent) : void
      {
         ...
         Habbo.reportCrash("Failed to download Volter.swf!",const_13,new Error(param1.text));
      }
      ...
      private function updateLoadingBar(param1:DisplayObjectContainer, param2:Number) : void
      {
         var _loc11_:int = 0;
         var _loc12_:int = 0;
         var _loc7_:Sprite = param1.getChildByName(const_4) as Sprite;
         var _loc8_:Sprite = _loc7_.getChildByName(FILE_BAR_SPRITE) as Sprite;
         var _loc9_:Sprite = param1.getChildByName(const_2) as Sprite;
      ...
      {
         trackLoginStep(const_7);
         reportCrash("Failed to finalize main swf preloading: " + param1.text + " / HTTP status: " + var_3,const_8,null);
      }
